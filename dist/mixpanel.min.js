...
$browser:d.info.Ba(H,W.vendor,ta),$referrer:B.referrer,$referring_domain:d.info.Nc(B.referrer),$device:d.info.mc(H)}),{$current_url:d.info.Ea(),$browser_version:d.info.gb(H,W.vendor,ta),$screen_height:sb.height,$screen_width:sb.width,mp_lib:"web",$lib_version:"2.67.0-rc1",$insert_id:za(),time:d.timestamp()/1E3},d.ca(a))},te:function(){return d.extend(d.ca({$os:d.info.Gc(),$browser:d.info.Ba(H,W.vendor,ta)}),{$browser_version:d.info.gb(H,W.vendor,ta)})},pe:function(){return d.ca({current_page_title:B.title,
...
f.length===e,k=[],h={};d.g(f,function(m){var t=m.payload;this.Aa&&!m.re&&(t=this.Aa(t));if(t){t.event&&t.properties&&(t.properties=d.extend({},t.properties,{mp_sent_by_lib_version:"2.67.0-rc1"}));var w=!0,u=m.id;u?5<(this.V[u]||0)&&(this.m("[dupe] item ID sent too many times, not sending",{item:m,S:f.length,Ue:this.V[u]}),w=!1):this.m("[dupe] found item with no ID",{item:m});w&&k.push(t)}h[m.id]=t},this);if(1>k.length)return this.Bb=!1,this.$(),D.resolve();var p=d.bind(function(){return this.ra.ue(d.map(f,
...
(d.g(a,function(g,k){this.M(k)||(isNaN(parseFloat(g))?z.error("Invalid increment value passed to mixpanel.people.increment - must be a number"):f[k]=g)},this),c=b):(d.l(b)&&(b=1),f[a]=b);e.$add=f;return this.u(e,c)});x.prototype.append=V(function(a,b,c){d.j(a)&&(c=b);a=this.yd(a,b);return this.u(a,c)});x.prototype.remove=V(function(a,b,c){d.j(a)&&(c=b);a=this.Pc(a,b);return this.u(a,c)});x.prototype.va=V(function(a,b,c){d.j(a)&&(c=b);a=this.dd(a,b);return this.u(a,c)});x.prototype.Ye=V(function(){z.error("mixpanel.people.track_charge() is deprecated and no longer has any effect.")});
x.prototype.cc=function(a){return this.set("$transactions",[],a)};x.prototype.lc=function(){if(this.$a()){var a={$delete:this.i.U()};return this.u(a)}z.error("mixpanel.people.delete_user() requires you to call identify() first")};x.prototype.toString=function(){return this.i.toString()+".people"};x.prototype.u=function(a,b){a.$token=this.I("token");a.$distinct_id=this.i.U();var c=this.i.D("$device_id"),e=this.i.D("$user_id"),f=this.i.D("$had_persisted_distinct_id");c&&(a.$device_id=c);e&&(a.$user_id=
e);f&&(a.$had_persisted_distinct_id=f);c=d.jb(a);return this.$a()?this.i.bb({type:"people",data:c,endpoint:this.i.Z("people")+"/"+this.I("api_routes").engage,fb:this.i.H.Ab},b):(this.od(a),d.l(b)||(this.I("verbose")?b({status:-1,error:null}):b(-1)),d.truncate(c,255))};x.prototype.I=function(a){return this.i.h(a)};x.prototype.$a=function(){return!0===this.i.ha.wc};x.prototype.od=function(a){"$set"in a?this.i.persistence.G("$set",a):"$set_once"in a?this.i.persistence.G("$set_once",a):"$unset"in a?this.i.persistence.G("$unset",
a):"$add"in a?this.i.persistence.G("$add",a):"$append"in a?this.i.persistence.G("$append",a):"$remove"in a?this.i.persistence.G("$remove",a):"$union"in a?this.i.persistence.G("$union",a):z.error("Invalid call to _enqueue():",a)};x.prototype.ia=function(a,b,c,e){var f=this,g=d.extend({},this.i.persistence.oa(a)),k=g;d.l(g)||!d.j(g)||d.Ka(g)||(f.i.persistence.J(a,g),f.i.persistence.save(),e&&(k=e(g)),b.call(f,k,function(h,p){0===h&&f.i.persistence.G(a,g);d.l(c)||c(h,p)}))};x.prototype.qd=function(a,
b,c,e,f,g,k){var h=this;this.ia("$set",this.set,a);this.ia("$set_once",this.aa,e);this.ia("$unset",this.Pa,g,function(n){return d.keys(n)});this.ia("$add",this.yc,b);this.ia("$union",this.va,f);a=this.i.persistence.oa("$append");if(!d.l(a)&&d.isArray(a)&&a.length)for(b=function(n,m){0===n&&h.i.persistence.G("$append",p);d.l(c)||c(n,m)},e=a.length-1;0<=e;e--){a=this.i.persistence.oa("$append");var p=a.pop();h.i.persistence.save();d.Ka(p)||h.append(p,b)}a=this.i.persistence.oa("$remove");if(!d.l(a)&&
d.isArray(a)&&a.length)for(b=function(n,m){0===n&&h.i.persistence.G("$remove",q);d.l(k)||k(n,m)},e=a.length-1;0<=e;e--){a=this.i.persistence.oa("$remove");var q=a.pop();h.i.persistence.save();d.Ka(q)||h.remove(q,b)}};x.prototype.M=function(a){return"$distinct_id"===a||"$token"===a||"$device_id"===a||"$user_id"===a||"$had_persisted_distinct_id"===a};x.prototype.set=x.prototype.set;x.prototype.set_once=x.prototype.aa;x.prototype.unset=x.prototype.Pa;x.prototype.increment=x.prototype.yc;x.prototype.append=
x.prototype.append;x.prototype.remove=x.prototype.remove;x.prototype.union=x.prototype.va;x.prototype.track_charge=x.prototype.Ye;x.prototype.clear_charges=x.prototype.cc;x.prototype.delete_user=x.prototype.lc;x.prototype.toString=x.prototype.toString;var cc="__mps __mpso __mpus __mpa __mpap __mpr __mpu $people_distinct_id __alias __timers".split(" ");y.prototype.qa=function(){var a={};this.load();d.g(this.props,function(b,c){d.ub(cc,c)||(a[c]=b)});return a};y.prototype.load=function(){if(!this.disabled){var a=
this.storage.parse(this.name);a&&(this.props=d.extend({},a))}};y.prototype.upgrade=function(){if(this.storage===d.localStorage){var a=d.cookie.parse(this.name);d.cookie.remove(this.name);d.cookie.remove(this.name,!0);a&&this.L(a)}else this.storage===d.cookie&&(a=d.localStorage.parse(this.name),d.localStorage.remove(this.name),a&&this.L(a))};y.prototype.save=function(){this.disabled||this.storage.set(this.name,da(this.props),this.mb,this.ib,this.Tc,this.jc,this.Ca)};y.prototype.Ma=function(a){this.load();
return this.props[a]};y.prototype.remove=function(){this.storage.remove(this.name,!1,this.Ca);this.storage.remove(this.name,!0,this.Ca)};y.prototype.clear=function(){this.remove();this.props={}};y.prototype.L=function(a,b,c){return d.j(a)?("undefined"===typeof b&&(b="None"),this.mb="undefined"===typeof c?this.kc:c,this.load(),d.g(a,function(e,f){this.props.hasOwnProperty(f)&&this.props[f]!==b||(this.props[f]=e)},this),this.save(),!0):!1};y.prototype.register=function(a,b){return d.j(a)?(this.mb="undefined"===
typeof b?this.kc:b,this.load(),d.extend(this.props,a),this.save(),!0):!1};y.prototype.unregister=function(a){this.load();a in this.props&&(delete this.props[a],this.save())};y.prototype.hd=function(a){this.register(d.info.ze(a))};y.prototype.Lb=function(a){this.L({$initial_referrer:a||"$direct",$initial_referring_domain:d.info.Nc(a)||"$direct"},"")};y.prototype.Vd=function(){return d.ca({$initial_referrer:this.props.$initial_referrer,$initial_referring_domain:this.props.$initial_referring_domain})};
y.prototype.gd=function(a){this.kc=this.mb=a.cookie_expiration;this.Wc(a.disable_persistence);this.Fe(a.cookie_domain);this.Ge(a.cross_site_cookie);this.He(a.cross_subdomain_cookie);this.Ke(a.secure_cookie)};y.prototype.Wc=function(a){(this.disabled=a)?this.remove():this.save()};y.prototype.Fe=function(a){a!==this.Ca&&(this.remove(),this.Ca=a,this.save())};y.prototype.Ge=function(a){a!==this.jc&&(this.jc=a,this.remove(),this.save())};y.prototype.He=function(a){a!==this.ib&&(this.ib=a,this.remove(),
this.save())};y.prototype.Td=function(){return this.ib};y.prototype.Ke=function(a){a!==this.Tc&&(this.Tc=a?!0:!1,this.remove(),this.save())};y.prototype.G=function(a,b){var c=this.xa(a);a=b[a];var e=this.R("$set"),f=this.R("$set_once"),g=this.R("$unset"),k=this.R("$add"),h=this.R("$union"),p=this.R("$remove",[]),q=this.R("$append",[]);"__mps"===c?(d.extend(e,a),this.J("$add",a),this.J("$union",a),this.J("$unset",a)):"__mpso"===c?(d.g(a,function(n,m){m in f||(f[m]=n)}),this.J("$unset",a)):"__mpus"===
c?d.g(a,function(n){d.g([e,f,k,h],function(m){n in m&&delete m[n]});d.g(q,function(m){n in m&&delete m[n]});g[n]=!0}):"__mpa"===c?(d.g(a,function(n,m){m in e?e[m]+=n:(m in k||(k[m]=0),k[m]+=n)},this),this.J("$unset",a)):"__mpu"===c?(d.g(a,function(n,m){d.isArray(n)&&(m in h||(h[m]=[]),d.g(n,function(t){d.ub(h[m],t)||h[m].push(t)}))}),this.J("$unset",a)):"__mpr"===c?(p.push(a),this.J("$append",a)):"__mpap"===c&&(q.push(a),this.J("$unset",a));z.log("MIXPANEL PEOPLE REQUEST (QUEUED, PENDING IDENTIFY):");
z.log(b);this.save()};y.prototype.J=function(a,b){var c=this.props[this.xa(a)];d.l(c)||d.g(b,function(e,f){"$append"===a||"$remove"===a?d.g(c,function(g){g[f]===e&&delete g[f]}):delete c[f]},this)};y.prototype.oa=function(a){return this.Ma(this.xa(a))};y.prototype.xa=function(a){if("$set"===a)return"__mps";if("$set_once"===a)return"__mpso";if("$unset"===a)return"__mpus";if("$add"===a)return"__mpa";if("$append"===a)return"__mpap";if("$remove"===a)return"__mpr";if("$union"===a)return"__mpu";z.error("Invalid queue:",
a)};y.prototype.R=function(a,b){a=this.xa(a);b=d.l(b)?{}:b;return this.props[a]||(this.props[a]=b)};y.prototype.Ie=function(a){var b=(new Date).getTime(),c=this.Ma("__timers")||{};c[a]=b;this.props.__timers=c;this.save()};y.prototype.ve=function(a){var b=(this.Ma("__timers")||{})[a];d.l(b)||(delete this.props.__timers[a],this.save());return b};var dc=["mixpanelRecordingEvents","mixpanelRecordingRegistry"];T.prototype.Wb=function(){return new D(function(a,b){var c=r.indexedDB.open("mixpanelBrowserDb",
1);c.onerror=function(){b(c.error)};c.onsuccess=function(){a(c.result)};c.onupgradeneeded=function(e){var f=e.target.result;dc.forEach(function(g){f.createObjectStore(g)})}})};T.prototype.B=function(){if(!r.indexedDB)return D.reject("indexedDB is not supported in this browser");this.W||(this.W=this.Wb());return this.W.then(function(a){return a instanceof r.IDBDatabase?D.resolve():D.reject(a)})};T.prototype.Na=function(a,b){function c(f){return new D(function(g,k){var h=f.transaction(e,a);h.oncomplete=
function(){g(h)};h.onabort=h.onerror=function(){k(h.error)};b(h.objectStore(e))})}var e=this.Pe;return this.W.then(c).catch(function(f){return f&&"InvalidStateError"===f.name?(this.W=this.Wb(),this.W.then(c)):D.reject(f)}.bind(this))};T.prototype.setItem=function(a,b){return this.Na("readwrite",function(c){c.put(b,a)})};T.prototype.getItem=function(a){var b;return this.Na("readonly",function(c){b=c.get(a)}).then(function(){return b.result})};T.prototype.removeItem=function(a){return this.Na("readwrite",
function(b){b.delete(a)})};T.prototype.getAll=function(){var a;return this.Na("readonly",function(b){a=b.getAll()}).then(function(){return a.result})};var xa,E,ea=r.XMLHttpRequest&&"withCredentials"in new XMLHttpRequest,Ra=!ea&&-1===H.indexOf("MSIE")&&-1===H.indexOf("Mozilla"),wa=null;W.sendBeacon&&(wa=function(){return W.sendBeacon.apply(W,arguments)});var Ab={track:"track/",engage:"engage/",groups:"groups/",record:"record/",flags:"flags/"},Bb={api_host:"https://api-js.mixpanel.com",api_hosts:{},
api_routes:Ab,api_extra_query_params:{},api_method:"POST",api_transport:"XHR",api_payload_format:"base64",app_host:"https://mixpanel.com",autocapture:!1,cdn:"https://cdn.mxpnl.com",cross_site_cookie:!1,cross_subdomain_cookie:!0,error_reporter:ha,flags:!1,persistence:"cookie",persistence_name:"",cookie_domain:"",cookie_name:"",loaded:ha,mp_loader:null,track_marketing:!0,track_pageview:!1,skip_first_touch_marketing:!1,store_google:!0,stop_utm_persistence:!1,save_referrer:!0,test:!1,verbose:!1,img:!1,
debug:!1,track_links_timeout:300,cookie_expiration:365,upgrade:!1,disable_persistence:!1,disable_cookie:!1,secure_cookie:!1,ip:!0,opt_out_tracking_by_default:!1,opt_out_persistence_by_default:!1,opt_out_tracking_persistence_type:"localStorage",opt_out_tracking_cookie_prefix:null,property_blacklist:[],xhr_headers:{},ignore_dnt:!1,batch_requests:!0,batch_size:50,batch_flush_interval_ms:5E3,batch_request_timeout_ms:9E4,batch_autostart:!0,hooks:{},record_block_class:/^(mp-block|fs-exclude|amp-block|rr-block|ph-no-capture)$/,
record_block_selector:"img, video",record_canvas:!1,record_collect_fonts:!1,record_heatmap_data:!1,record_idle_timeout_ms:18E5,record_mask_text_class:/^(mp-mask|fs-mask|amp-mask|rr-mask|ph-mask)$/,record_mask_text_selector:"*",record_max_ms:864E5,record_min_ms:0,record_sessions_percent:0,recorder_src:"https://cdn.mxpnl.com/libs/mixpanel-recorder.min.js"},Qa=!1;l.prototype.B=function(a,b,c){if(d.l(c))this.v("You must name your new library: init(token, config, name)");else if("mixpanel"===c)this.v("You must initialize the main mixpanel object right after you include the Mixpanel js snippet");
else return a=ma(a,b,c),E[c]=a,a.ya(),a};l.prototype.ka=function(a,b,c){b=b||{};this.__loaded=!0;this.config={};var e={};"api_payload_format"in b||(b.api_host||Bb.api_host).match(/\.mixpanel\.com/)&&(e.api_payload_format="json");this.Vc(d.extend({},Bb,e,b,{name:c,token:a,callback_fn:("mixpanel"===c?c:"mixpanel."+c)+"._jsc"}));this._jsc=ha;this.Sa=[];this.Ta=[];this.Ra=[];this.ha={disable_all_events:!1,identify_called:!1};this.H={};if(this.ga=this.h("batch_requests"))if(d.localStorage.na(!0)&&ea){if(this.ce(),
wa&&r.addEventListener){var f=d.bind(function(){this.H.Y.stopped||this.H.Y.flush({ed:!0})},this);r.addEventListener("pagehide",function(g){g.persisted&&f()});r.addEventListener("visibilitychange",function(){"hidden"===B.visibilityState&&f()})}}else this.ga=!1,z.log("Turning off Mixpanel request-queueing; needs XHR and localStorage support"),d.g(this.tc(),function(g){z.log("Clearing batch queue "+g.sa);d.localStorage.remove(g.sa)});this.persistence=this.cookie=new y(this.config);this.ea={};this.rd();
a=d.Qa();this.U()||this.L({distinct_id:"$device:"+a,$device_id:a},"");this.flags=new A({nb:d.bind(function(){return this.Z("flags")+"/"+this.h("api_routes").flags},this),Qd:d.bind(this.h,this),Sd:d.bind(this.D,this),bf:d.bind(this.track,this)});this.flags.B();this.flags=this.flags;this.eb=new K(this);this.eb.B();this.sd();this.Ua()};l.prototype.sd=function(){if(d.sessionStorage.na())try{var a=this.h("name")+"_"+this.h("token"),b="mp_tab_id_"+a,c="mp_gen_new_tab_id_"+a;!d.sessionStorage.get(c)&&d.sessionStorage.get(b)||
d.sessionStorage.set(b,"$tab-"+d.Qa());d.sessionStorage.set(c,"1");this.Se=d.sessionStorage.get(b);r.addEventListener("beforeunload",function(){d.sessionStorage.remove(c)})}catch(e){this.v("Error initializing tab id",e)}else this.v("Session storage is not supported, cannot keep track of unique tab ID.")};l.prototype.vc=function(){return this.Se||null};l.prototype.td=function(){var a=new T("mixpanelRecordingRegistry"),b=this.vc();return a.B().then(function(){return a.getAll()}).then(function(c){for(var e=
0;e<c.length;e++){var f=c[e],g=Date.now();if(!f||g>f.maxExpires||g>f.idleExpires||c[e].tabId===b)return!0}return!1}).catch(d.bind(function(c){this.v("Error checking recording registry",c)},this))};l.prototype.Ua=Y(function(a){if(r.MutationObserver){var b=d.bind(function(e){var f=d.bind(function(){this.C=this.C||new r.__mp_recorder(this);this.C.resumeRecording(e)},this);d.l(r.__mp_recorder)?Sa(this.h("recorder_src"),f):f()},this),c=0<this.h("record_sessions_percent")&&100*Math.random()<=this.h("record_sessions_percent");
a||c?b(!0):this.td().then(function(e){e&&b(!1)})}else z.s("Browser does not support MutationObserver; skipping session recording")});l.prototype.Me=function(){this.Ua(!0)};l.prototype.Fb=function(){return this.C?this.C.stopRecording():Promise.resolve()};l.prototype.se=function(){return this.C?this.C.pauseRecording():Promise.resolve()};l.prototype.xe=function(){return this.C?this.C.resumeRecording():Promise.resolve()};l.prototype.Dc=function(){return this.Xa()&&this.h("record_heatmap_data")};l.prototype.uc=
function(){var a={},b=this.Xa();b&&(a.$mp_replay_id=b);return a};l.prototype.Wd=function(){var a=null,b=this.Xa();b&&(a="https://mixpanel.com/projects/replay-redirect?"+d.Nb({replay_id:b,distinct_id:this.U(),token:this.h("token")}));return a};l.prototype.Xa=function(){var a=null;this.C&&(a=this.C.replayId);return a||null};l.prototype.kd=function(){return this.C};l.prototype.ya=function(){this.h("loaded")(this);this.$b();this.people.aa(this.persistence.Vd());if(this.h("store_google")&&this.h("stop_utm_persistence")){var a=
d.info.la(null);d.g(a,function(b,c){this.unregister(c)}.bind(this))}};l.prototype.$b=function(){this.persistence.hd(B.referrer);this.h("store_google")&&!this.h("stop_utm_persistence")&&this.register(d.info.la());this.h("save_referrer")&&this.persistence.Lb(B.referrer)};l.prototype.nd=function(){d.g(this.Sa,function(a){this.ab.apply(this,a)},this);this.ma()||d.g(this.Ta,function(a){this.u.apply(this,a)},this);delete this.Sa;delete this.Ta};l.prototype.ab=function(a,b){if(this.h("img"))return this.v("You can't use DOM tracking functions with img = true."),
!1;if(!Qa)return this.Sa.push([a,b]),!1;a=(new a).B(this);return a.track.apply(a,b)};l.prototype.Xb=function(a,b){if(d.l(a))return null;if(ea)return function(g){a(g,b)};var c=this._jsc,e=""+Math.floor(1E8*Math.random()),f=this.h("callback_fn")+"["+e+"]";c[e]=function(g){delete c[e];a(g,b)};return f};l.prototype.u=function(a,b,c,e){var f=!0;if(Ra)return this.Ta.push(arguments),f;var g={method:this.h("api_method"),Kb:this.h("api_transport"),jd:this.h("verbose")},k=null;e||!d.wb(c)&&"string"!==typeof c||
(e=c,c=null);c=d.extend(g,c||{});ea||(c.method="GET");g="POST"===c.method;var h=wa&&g&&"sendbeacon"===c.Kb.toLowerCase(),p=c.jd;b.verbose&&(p=!0);this.h("test")&&(b.test=1);p&&(b.verbose=1);this.h("img")&&(b.img=1);if(!ea)if(e)b.callback=e;else if(p||this.h("test"))b.callback="(function(){})";b.ip=this.h("ip")?1:0;b._=(new Date).getTime().toString();g&&(k="data="+encodeURIComponent(b.data),delete b.data);d.extend(b,this.h("api_extra_query_params"));a+="?"+d.Nb(b);var q=this;if("img"in b)k=B.createElement("img"),
k.src=a,B.body.appendChild(k);else if(h){try{f=wa(a,k)}catch(w){q.v(w),f=!1}try{e&&e(f?1:0)}catch(w){q.v(w)}}else if(ea)try{var n=new XMLHttpRequest;n.open(c.method,a,!0);var m=this.h("xhr_headers");g&&(m["Content-Type"]="application/x-www-form-urlencoded");d.g(m,function(w,u){n.setRequestHeader(u,w)});if(c.ad&&"undefined"!==typeof n.timeout){n.timeout=c.ad;var t=(new Date).getTime()}n.withCredentials=!0;n.onreadystatechange=function(){if(4===n.readyState)if(200===n.status){if(e)if(p){try{var w=d.fa(n.responseText)}catch(u){if(q.v(u),
c.Xd)w=n.responseText;else return}e(w)}else e(Number(n.responseText))}else w=n.timeout&&!n.status&&(new Date).getTime()-t>=n.timeout?"timeout":"Bad HTTP status: "+n.status+" "+n.statusText,q.v(w),e&&(p?e({status:0,Ja:n.status,error:w,Rc:(n.responseHeaders||{})["Retry-After"]}):e(0))};n.send(k)}catch(w){q.v(w),f=!1}else k=B.createElement("script"),k.type="text/javascript",k.async=!0,k.defer=!0,k.src=a,m=B.getElementsByTagName("script")[0],m.parentNode.insertBefore(k,m);return f};l.prototype.Va=function(a){function b(k,
h){d.g(k,function(p){if(d.isArray(p[0])){var q=h;d.g(p,function(n){q=q[n[0]].apply(q,n.slice(1))})}else this[p[0]].apply(this,p.slice(1))},h)}var c,e=[],f=[],g=[];d.g(a,function(k){k&&(c=k[0],d.isArray(c)?g.push(k):"function"===typeof k?k.call(this):d.isArray(k)&&"alias"===c?e.push(k):d.isArray(k)&&-1!==c.indexOf("track")&&"function"===typeof this[c]?g.push(k):f.push(k))},this);b(e,this);b(f,this);b(g,this)};l.prototype.bc=function(){return!!this.H.Y};l.prototype.tc=function(){var a="__mpq_"+this.h("token");
return this.Pb=this.Pb||{Y:{type:"events",za:"track",sa:a+"_ev"},Ab:{type:"people",za:"engage",sa:a+"_pp"},groups:{type:"groups",za:"groups",sa:a+"_gr"}}};l.prototype.ce=function(){if(!this.bc()){var a=d.bind(function(c){return new M(c.sa,{O:this.config,X:this.h("error_reporter"),Ce:d.bind(function(e,f,g){this.u(this.Z(c.za)+"/"+this.h("api_routes")[c.za],this.Rb(e),f,this.Xb(g,e))},this),Aa:d.bind(function(e){return this.Zb("before_send_"+c.type,e)},this),Oe:d.bind(this.Eb,this),F:!0})},this),b=
this.tc();this.H={Y:a(b.Y),Ab:a(b.Ab),groups:a(b.groups)}}this.h("batch_autostart")&&this.Db()};l.prototype.Db=function(){this.ld=!0;this.bc()&&(this.ga=!0,d.g(this.H,function(a){a.start()}))};l.prototype.Eb=function(){this.ga=!1;d.g(this.H,function(a){a.stop();a.clear()})};l.prototype.push=function(a){this.Va([a])};l.prototype.disable=function(a){"undefined"===typeof a?this.ha.Id=!0:this.Ra=this.Ra.concat(a)};l.prototype.Rb=function(a){a=da(a);"base64"===this.h("api_payload_format")&&(a=d.zd(a));
return{data:a}};l.prototype.bb=function(a,b){var c=d.truncate(a.data,255),e=a.endpoint,f=a.fb,g=a.Le,k=a.Ee||{};b=b||ha;var h=!0,p=d.bind(function(){k.$c||(c=this.Zb("before_send_"+a.type,c));return c?(z.log("MIXPANEL REQUEST:"),z.log(c),this.u(e,this.Rb(c),k,this.Xb(b,c))):null},this);this.ga&&!g?f.enqueue(c).then(function(q){q?b(1,c):p()}):h=p();return h&&c};l.prototype.track=Y(function(a,b,c,e){e||"function"!==typeof c||(e=c,c=null);c=c||{};var f=c.transport;f&&(c.Kb=f);f=c.send_immediately;"function"!==
typeof e&&(e=ha);if(d.l(a))this.v("No event name provided to mixpanel.track");else if(this.Tb(a))e(0);else{b=d.extend({},b);b.token=this.h("token");var g=this.persistence.ve(a);d.l(g)||(b.$duration=parseFloat((((new Date).getTime()-g)/1E3).toFixed(3)));this.$b();g=this.h("track_marketing")?d.info.oe():{};b=d.extend({},d.info.qa({mp_loader:this.h("mp_loader")}),g,this.persistence.qa(),this.ea,this.uc(),b);g=this.h("property_blacklist");d.isArray(g)?d.g(g,function(k){delete b[k]}):this.v("Invalid value for property_blacklist config: "+
g);return this.bb({type:"events",data:{event:a,properties:b},endpoint:this.Z("events")+"/"+this.h("api_routes").track,fb:this.H.Y,Le:f,Ee:c},e)}});l.prototype.Je=Y(function(a,b,c){d.isArray(b)||(b=[b]);var e={};e[a]=b;this.register(e);return this.people.set(a,b,c)});l.prototype.ud=Y(function(a,b,c){var e=this.D(a),f={};void 0===e?(f[a]=[b],this.register(f)):-1===e.indexOf(b)&&(e.push(b),f[a]=e,this.register(f));return this.people.va(a,b,c)});l.prototype.we=Y(function(a,b,c){var e=this.D(a);if(void 0!==
e){var f=e.indexOf(b);-1<f&&(e.splice(f,1),this.register({hf:e}));0===e.length&&this.unregister(a)}return this.people.remove(a,b,c)});l.prototype.af=Y(function(a,b,c,e){var f=d.extend({},b||{});d.g(c,function(g,k){null!==g&&void 0!==g&&(f[k]=g)});return this.track(a,f,e)});l.prototype.md=function(a,b){return a+"_"+JSON.stringify(b)};l.prototype.Ud=function(a,b){var c=this.md(a,b),e=this.Qb[c];if(void 0===e||e.Za!==a||e.Ya!==b)e=new C,e.ka(this,a,b),this.Qb[c]=e;return e};l.prototype.Jb=Y(function(a,
b){"object"!==typeof a&&(a={});b=b||{};b=b.event_name||"$mp_web_page_view";var c=d.extend(d.info.pe(),d.info.la(),d.info.ec());a=d.extend({},c,a);return this.track(b,a)});l.prototype.$e=function(){return this.ab.call(this,ba,arguments)};l.prototype.Ze=function(){return this.ab.call(this,na,arguments)};l.prototype.Te=function(a){d.l(a)?this.v("No event name provided to mixpanel.time_event"):this.Tb(a)||this.persistence.Ie(a)};var Fb={persistent:!0};l.prototype.register=function(a,b){b=ya(b);b.persistent?
this.persistence.register(a,b.days):d.extend(this.ea,a)};l.prototype.L=function(a,b,c){c=ya(c);c.persistent?this.persistence.L(a,b,c.days):("undefined"===typeof b&&(b="None"),d.g(a,function(e,f){this.ea.hasOwnProperty(f)&&this.ea[f]!==b||(this.ea[f]=e)},this))};l.prototype.unregister=function(a,b){b=ya(b);b.persistent?this.persistence.unregister(a):delete this.ea[a]};l.prototype.Yb=function(a,b){var c={};c[a]=b;this.register(c)};l.prototype.tb=function(a,b,c,e,f,g,k,h){var p=this.U();if(a&&p!==a){if("string"===
typeof a&&0===a.indexOf("$device:"))return this.v("distinct_id cannot have $device: prefix"),-1;this.register({$user_id:a})}this.D("$device_id")||this.L({$had_persisted_distinct_id:!0,$device_id:p},"");a!==p&&a!==this.D("__alias")&&(this.unregister("__alias"),this.register({distinct_id:a}));this.ha.wc=!0;this.people.qd(b,c,e,f,g,k,h);a!==p&&this.track("$identify",{distinct_id:a,$anon_distinct_id:p},{$c:!0});a!==p&&this.flags.nc()};l.prototype.reset=function(){this.Fb();this.persistence.clear();this.ha.wc=
!1;var a=d.Qa();this.L({distinct_id:"$device:"+a,$device_id:a},"");this.Ua()};l.prototype.U=function(){return this.D("distinct_id")};l.prototype.vd=function(a,b){if(a===this.D("$people_distinct_id"))return this.v("Attempting to create alias for existing People user - aborting."),-2;var c=this;d.l(b)&&(b=this.U());if(a!==b)return this.Yb("__alias",a),this.track("$create_alias",{alias:a,distinct_id:b},{$c:!0},function(){c.tb(a)});this.v("alias matches current distinct_id - skipping api call.");this.tb(a);
return-1};l.prototype.qe=function(a){this.Yb("mp_name_tag",a)};l.prototype.Vc=function(a){d.j(a)&&(d.extend(this.config,a),a.batch_size&&d.g(this.H,function(b){b.Qc()}),this.h("persistence_name")||(this.config.persistence_name=this.config.cookie_name),this.h("disable_persistence")||(this.config.disable_persistence=this.config.disable_cookie),this.persistence&&this.persistence.gd(this.config),S=S||this.h("debug"),("autocapture"in a||"record_heatmap_data"in a)&&this.eb&&this.eb.B())};l.prototype.h=
function(a){return this.config[a]};l.prototype.Zb=function(a){var b=(this.config.hooks[a]||Gb).apply(this,aa.call(arguments,1));"undefined"===typeof b&&(this.v(a+" hook did not return a value"),b=null);return b};l.prototype.D=function(a){return this.persistence.Ma([a])};l.prototype.Z=function(a){return this.h("api_hosts")[a]||this.h("api_host")};l.prototype.toString=function(){var a=this.h("name");"mixpanel"!==a&&(a="mixpanel."+a);return a};l.prototype.Tb=function(a){return d.Ac(H)||this.ha.Id||d.ub(this.Ra,
a)};l.prototype.rd=function(){"localStorage"===this.h("opt_out_tracking_persistence_type")&&d.localStorage.na()&&(!this.Ia()&&this.Ia({persistence_type:"cookie"})&&this.Fc({enable_persistence:!1}),!this.ma()&&this.ma({persistence_type:"cookie"})&&this.zb({clear_persistence:!1}),this.dc({persistence_type:"cookie",enable_persistence:!1}));this.ma()?this.wa({clear_persistence:!0}):this.Ia()||!this.h("opt_out_tracking_by_default")&&!d.cookie.get("mp_optout")||(d.cookie.remove("mp_optout"),this.zb({clear_persistence:this.h("opt_out_persistence_by_default")}))};
l.prototype.wa=function(a){if(a&&a.clear_persistence)a=!0;else if(a&&a.enable_persistence)a=!1;else return;this.h("disable_persistence")||this.persistence.disabled===a||this.persistence.Wc(a);a?(this.Eb(),this.Fb()):this.ld&&this.Db()};l.prototype.ja=function(a,b){b=d.extend({track:d.bind(this.track,this),persistence_type:this.h("opt_out_tracking_persistence_type"),cookie_prefix:this.h("opt_out_tracking_cookie_prefix"),cookie_expiration:this.h("cookie_expiration"),cross_site_cookie:this.h("cross_site_cookie"),
cross_subdomain_cookie:this.h("cross_subdomain_cookie"),cookie_domain:this.h("cookie_domain"),secure_cookie:this.h("secure_cookie"),ignore_dnt:this.h("ignore_dnt")},b);d.localStorage.na()||(b.persistence_type="cookie");return a(this.h("token"),{track:b.track,Ve:b.track_event_name,Xe:b.track_properties,Kc:b.persistence_type,Jc:b.cookie_prefix,fc:b.cookie_domain,hc:b.cookie_expiration,Hd:b.cross_site_cookie,ic:b.cross_subdomain_cookie,Ae:b.secure_cookie,xc:b.ignore_dnt})};l.prototype.Fc=function(a){a=
d.extend({enable_persistence:!0},a);this.ja(Sb,a);this.wa(a)};l.prototype.zb=function(a){a=d.extend({clear_persistence:!0,delete_user:!0},a);a.delete_user&&this.people&&this.people.$a()&&(this.people.lc(),this.people.cc());this.ja(Tb,a);this.wa(a)};l.prototype.Ia=function(a){return this.ja(Ub,a)};l.prototype.ma=function(a){return this.ja(mb,a)};l.prototype.dc=function(a){a=d.extend({enable_persistence:!0},a);this.ja(Wb,a);this.wa(a)};l.prototype.v=function(a,b){z.error.apply(z.error,arguments);try{b||
a instanceof Error||(a=Error(a)),this.h("error_reporter")(a,b)}catch(c){z.error(c)}};l.prototype.init=l.prototype.B;l.prototype.reset=l.prototype.reset;l.prototype.disable=l.prototype.disable;l.prototype.time_event=l.prototype.Te;l.prototype.track=l.prototype.track;l.prototype.track_links=l.prototype.$e;l.prototype.track_forms=l.prototype.Ze;l.prototype.track_pageview=l.prototype.Jb;l.prototype.register=l.prototype.register;l.prototype.register_once=l.prototype.L;l.prototype.unregister=l.prototype.unregister;
l.prototype.identify=l.prototype.tb;l.prototype.alias=l.prototype.vd;l.prototype.name_tag=l.prototype.qe;l.prototype.set_config=l.prototype.Vc;l.prototype.get_config=l.prototype.h;l.prototype.get_api_host=l.prototype.Z;l.prototype.get_property=l.prototype.D;l.prototype.get_distinct_id=l.prototype.U;l.prototype.toString=l.prototype.toString;l.prototype.opt_out_tracking=l.prototype.zb;l.prototype.opt_in_tracking=l.prototype.Fc;l.prototype.has_opted_out_tracking=l.prototype.ma;l.prototype.has_opted_in_tracking=
l.prototype.Ia;l.prototype.clear_opt_in_out_tracking=l.prototype.dc;l.prototype.get_group=l.prototype.Ud;l.prototype.set_group=l.prototype.Je;l.prototype.add_group=l.prototype.ud;l.prototype.remove_group=l.prototype.we;l.prototype.track_with_groups=l.prototype.af;l.prototype.start_batch_senders=l.prototype.Db;l.prototype.stop_batch_senders=l.prototype.Eb;l.prototype.start_session_recording=l.prototype.Me;l.prototype.stop_session_recording=l.prototype.Fb;l.prototype.pause_session_recording=l.prototype.se;
l.prototype.resume_session_recording=l.prototype.xe;l.prototype.get_session_recording_properties=l.prototype.uc;l.prototype.get_session_replay_url=l.prototype.Wd;l.prototype.get_tab_id=l.prototype.vc;l.prototype.DEFAULT_API_ROUTES=Ab;l.prototype.__get_recorder=l.prototype.kd;y.prototype.properties=y.prototype.qa;y.prototype.update_search_keyword=y.prototype.hd;y.prototype.update_referrer_info=y.prototype.Lb;y.prototype.get_cross_subdomain=y.prototype.Td;y.prototype.clear=y.prototype.clear;var R={};
...
(d.g(E._i,function(b){b&&d.isArray(b)&&(R[b[b.length-1]]=ma.apply(this,b))}),Db(),E.init(),d.g(R,function(b){b.ya()}),Cb())})(function(a,b){var c=document.createElement("script");c.type="text/javascript";c.async=!0;c.onload=b;c.src=a;document.head.appendChild(c)})})()
