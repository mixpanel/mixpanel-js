...
ba:function(a){"object"!==typeof a&&(a={});return c.extend(c.ga({$os:c.info.Rb(),$browser:c.info.na(z,I.vendor,Y),$referrer:u.referrer,$referring_domain:c.info.Wb(u.referrer),$device:c.info.Eb(z)}),{$current_url:c.info.Ma(),$browser_version:c.info.Ja(z,I.vendor,Y),$screen_height:Z.height,$screen_width:Z.width,mp_lib:"web",$lib_version:"2.55.2-rc2",$insert_id:ea(),time:c.timestamp()/1E3},c.ga(a))},Xc:function(){return c.extend(c.ga({$os:c.info.Rb(),$browser:c.info.na(z,I.vendor,Y)}),{$browser_version:c.info.Ja(z,
