...
ba:function(a){"object"!==typeof a&&(a={});return c.extend(c.fa({$os:c.info.Pb(),$browser:c.info.ma(z,I.vendor,Y),$referrer:v.referrer,$referring_domain:c.info.Ub(v.referrer),$device:c.info.Cb(z)}),{$current_url:c.info.La(),$browser_version:c.info.Ia(z,I.vendor,Y),$screen_height:Z.height,$screen_width:Z.width,mp_lib:"web",$lib_version:"2.54.0",$insert_id:ea(),time:c.timestamp()/1E3},c.fa(a))},Vc:function(){return c.extend(c.fa({$os:c.info.Pb(),$browser:c.info.ma(z,I.vendor,Y)}),{$browser_version:c.info.Ia(z,
