...
this.qa.innerHTML=('<div id="overlay" class="'+this.pa+'"><div id="campaignid-'+this.I+'"><div id="bgwrapper"><div id="bg"></div>'+b+"</div></div></div>").replace(/class=\"/g,'class="'+g.A+"-").replace(/id=\"/g,'id="'+g.A+"-")};g.prototype.bd=function(){this.j="dark"===this.style?{gb:"#1d1f25",ka:"#282b32",Da:"#3a4147",Qb:"#4a5157",rd:"#32353c",Ub:"0.4",sb:"#2a3137",Na:"#fff",wb:"#9498a3",yc:"#464851",Ma:"#ddd"}:{gb:"#fff",ka:"#e7eaee",Da:"#eceff3",Qb:"#f5f5f5",rd:"#e4ecf2",Ub:"1.0",sb:"#fafafa",
Na:"#5c6578",wb:"#8b949b",yc:"#ced9e6",Ma:"#7c8598"};var a="0px 0px 35px 0px rgba(45, 49, 56, 0.7)",b=a,d=a,e=g.P+2*g.Ra,h=g.U/1E3+"s";this.u&&(a="none");var f={};f["@media only screen and (max-width: "+(g.Qa+20-1)+"px)"]={"#overlay":{display:"none"}};a={".flipped":{transform:"rotateY(180deg)"},"#overlay":{position:"fixed",top:"0",left:"0",width:"100%",height:"100%",overflow:"auto","text-align":"center","z-index":"10000","font-family":'"Helvetica", "Arial", sans-serif',"-webkit-font-smoothing":"antialiased",
