...
else if(this.Ac(),ba&&x.addEventListener){var h=c.bind(function(){this.p.ka.qa||this.p.ka.flush({$b:m})},this);x.addEventListener("pagehide",function(a){a.persisted&&h()});x.addEventListener("visibilitychange",function(){"hidden"===u.visibilityState&&h()})}this.persistence=this.cookie=new n(this.config);this.M={};this.jc();a=b.device_id||c.Za();this.J()||this.w({distinct_id:"$device:"+a,$device_id:a},"");this.c("track_pageview")&&this.Yb()};e.prototype.ea=function(){this.c("loaded")(this);this.gb()};
