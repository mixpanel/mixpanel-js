...
$browser:d.info.cb(K,X.vendor,ya),$referrer:y.referrer,$referring_domain:d.info.Hd(y.referrer),$device:d.info.Yc(K)}),{$current_url:d.info.Z(),$browser_version:d.info.Kb(K,X.vendor,ya),$screen_height:Db.height,$screen_width:Db.width,mp_lib:"web",$lib_version:"2.75.0-rc3",$insert_id:Da(),time:d.timestamp()/1E3},d.wa(a))},zf:function(){return d.extend(d.wa({$os:d.info.Ad(),$browser:d.info.cb(K,X.vendor,ya)}),{$browser_version:d.info.Kb(K,X.vendor,ya)})},sf:function(){return d.wa({current_page_title:y.title,
...
var a=this.Ub("distinct_id"),b=this.Ub("$device_id"),c=bb();F.log("Fetching flags for distinct ID: "+a);a=d.extend({distinct_id:a,device_id:b},this.o("context"));b=new URLSearchParams;b.set("context",JSON.stringify(a));b.set("token",this.ma("token"));b.set("mp_lib","web");b.set("$lib_version","2.75.0-rc3");a=this.ib()+"?"+b.toString();this.zb=Date.now();return this.Sb=this.fetch.call(p,a,{method:"GET",headers:{Authorization:"Basic "+btoa(this.ma("token")+":"),traceparent:c}}).then(function(e){this.ic();
...
this)};x.prototype.Se=function(a){return this.ib()+"/"+a+"/first-time-events"};x.prototype.Af=function(a,b,c){var e=this.Ub("distinct_id"),f=bb(),g=new URLSearchParams;g.set("mp_lib","web");g.set("$lib_version","2.75.0-rc3");g=this.Se(a)+"?"+g.toString();b={distinct_id:e,project_id:b,first_time_event_hash:c};F.log("Recording first-time event for flag: "+a);this.fetch.call(p,g,{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Basic "+btoa(this.ma("token")+":"),traceparent:f},
body:JSON.stringify(b)}).catch(function(k){F.error("Failed to record first-time event for flag "+a+": "+k)})};x.prototype.bd=function(a,b){return this.Sb?this.Sb.then(function(){return this.Wb(a,b)}.bind(this)).catch(function(c){F.error(c);return b}):new Promise(function(c){F.j("Feature Flags not initialized");c(b)})};x.prototype.Wb=function(a,b){if(!this.Mc())return F.log("Flags not loaded yet"),b;var c=this.flags.get(a);if(!c)return F.log('No flag found: "'+a+'"'),b;this.jg(a,c);return c};x.prototype.Xb=
function(a,b){return this.bd(a,{value:b}).then(function(c){return c.value}).catch(function(c){F.error(c);return b})};x.prototype.Re=function(a,b){F.j("mixpanel.flags.get_feature_data() is deprecated and will be removed in a future release. Use mixpanel.flags.get_variant_value() instead.");return this.Xb(a,b)};x.prototype.cd=function(a,b){return this.Wb(a,{value:b}).value};x.prototype.isEnabled=function(a,b){return this.Xb(a).then(function(){return this.md(a,b)}.bind(this)).catch(function(c){F.error(c);
return b})};x.prototype.md=function(a,b){b=b||!1;var c=this.cd(a,b);!0!==c&&!1!==c&&(F.error('Feature flag "'+a+'" value: '+c+" is not a boolean; returning fallback value: "+b),c=b);return c};x.prototype.jg=function(a,b){this.Vd.has(a)||(this.Vd.add(a),a={"Experiment name":a,"Variant name":b.key,$experiment_type:"feature_flag","Variant fetch start time":(new Date(this.Fc)).toISOString(),"Variant fetch complete time":(new Date(this.Ec)).toISOString(),"Variant fetch latency (ms)":this.ge,"Variant fetch traceparent":this.oe},
"undefined"!==b.experiment_id&&(a.$experiment_id=b.experiment_id),"undefined"!==b.is_experiment_active&&(a.$is_experiment_active=b.is_experiment_active),"undefined"!==b.is_qa_tester&&(a.$is_qa_tester=b.is_qa_tester),this.track("$experiment_started",a))};x.prototype.rf=function(){return!!this.fetch&&"undefined"!==typeof Promise&&"undefined"!==typeof Map&&"undefined"!==typeof Set};db(x);x.prototype.are_flags_ready=x.prototype.Mc;x.prototype.get_variant=x.prototype.bd;x.prototype.get_variant_sync=x.prototype.Wb;
x.prototype.get_variant_value=x.prototype.Xb;x.prototype.get_variant_value_sync=x.prototype.cd;x.prototype.is_enabled=x.prototype.isEnabled;x.prototype.is_enabled_sync=x.prototype.md;x.prototype.update_context=x.prototype.rg;x.prototype.get_feature_data=x.prototype.Re;x.prototype.getTargeting=x.prototype.ad;R.prototype.fb=function(){};R.prototype.Pb=function(){};R.prototype.Hb=function(){};R.prototype.B=function(a){this.u=a;return this};R.prototype.track=function(a,b,c,e){var f=this,g=d.He(a);if(0===
g.length)z.error("The DOM query ("+a+") returned 0 elements");else return d.h(g,function(k){d.Id(k,this.Bd,function(h){var n={},r=f.fb(c,this),q=f.u.g("track_links_timeout");f.Pb(h,this,n);window.setTimeout(f.Ud(e,r,n,!0),q);f.u.track(b,r,f.Ud(e,r,n))})},this),!0};R.prototype.Ud=function(a,b,c,e){e=e||!1;var f=this;return function(){c.Ae||(c.Ae=!0,a&&!1===a(e,b)||f.Hb(c))}};R.prototype.fb=function(a,b){return"function"===typeof a?a(b):d.extend({},a)};d.kd(ca,R);ca.prototype.fb=function(a,b){var c=
ca.dg.fb.apply(this,arguments);b.href&&(c.url=b.href);return c};ca.prototype.Pb=function(a,b,c){c.xd=2===a.which||a.metaKey||a.ctrlKey||"_blank"===b.target;c.href=b.href;c.xd||a.preventDefault()};ca.prototype.Hb=function(a){a.xd||setTimeout(function(){window.location=a.href},0)};d.kd(sa,R);sa.prototype.Pb=function(a,b,c){c.element=b;a.preventDefault()};sa.prototype.Hb=function(a){setTimeout(function(){a.element.submit()},0)};var tc=la("lock");Za.prototype.xc=function(a,b){return new this.Gd(d.bind(function(c,
e){function f(){function L(){v.removeItem(N);v.getItem(w)===r&&v.removeItem(w);v.getItem(J)===r&&v.removeItem(J)}v.setItem(N,"1");a().then(function(Y){L();c(Y)}).catch(function(Y){L();e(Y)})}function g(){v.setItem(J,r);h(k,function(){v.getItem(J)===r?f():n(function(){v.getItem(w)!==r?g():h(function(){return!v.getItem(N)},f)})})}function k(){var L=v.getItem(w);if(L&&L!==r)return!1;v.setItem(w,r);if(v.getItem(w)===r)return!0;ta(v,!0)||e(Error("localStorage support dropped while acquiring lock"));return!1}
function h(L,Y){L()?Y():n(function(){h(L,Y)})}function n(L){(new Date).getTime()-q>u?(tc.error("Timeout waiting for mutex on "+m+"; clearing lock. ["+r+"]"),v.removeItem(N),v.removeItem(w),g()):setTimeout(function(){try{L()}catch(Y){e(Y)}},t*(Math.random()+.1))}var r=b||(new Date).getTime()+"|"+Math.random(),q=(new Date).getTime(),m=this.va,t=this.Ed,u=this.uc,v=this.storage,J=m+":X",w=m+":Y",N=m+":Z";try{if(ta(v,!0))g();else throw Error("localStorage support check failed");}catch(L){e(L)}},this))};
ia.prototype.B=function(){return E.resolve()};ia.prototype.setItem=function(a,b){return new E(d.bind(function(c,e){try{this.storage.setItem(a,fa(b))}catch(f){e(f)}c()},this))};ia.prototype.getItem=function(a){return new E(d.bind(function(b,c){try{var e=za(this.storage.getItem(a))}catch(f){c(f)}b(e)},this))};ia.prototype.removeItem=function(a){return new E(d.bind(function(b,c){try{this.storage.removeItem(a)}catch(e){c(e)}b()},this))};var $a=la("batch");O.prototype.$=function(){return this.ac||!this.C?
E.resolve():this.V.B().then(d.bind(function(){this.ac=!0},this)).catch(d.bind(function(a){this.s("Error initializing queue persistence. Disabling persistence",a);this.ac=!0;this.C=!1},this))};O.prototype.enqueue=function(a,b){a={id:Da(),flushAfter:(new Date).getTime()+2*b,payload:a};if(this.C)return this.Je(a);this.M.push(a);return E.resolve(!0)};O.prototype.Cc=function(a){var b=d.bind(function(){return this.$().then(d.bind(function(){return this.Sa()},this)).then(d.bind(function(c){return this.nc(c.concat(a))},
this)).then(d.bind(function(c){c&&(this.M=this.M.concat(a));return c},this)).catch(d.bind(function(c){this.s("Error enqueueing items",c,a);return!1},this))},this);return this.lock.xc(b,this.pb).catch(d.bind(function(c){this.s("Error acquiring storage lock",c);return!1},this))};O.prototype.Le=function(a){var b=this.M.slice(0,a);return this.C&&b.length<a?this.$().then(d.bind(function(){return this.Sa()},this)).then(d.bind(function(c){if(c.length){var e={};d.h(b,function(k){e[k.id]=!0});for(var f=0;f<
c.length;f++){var g=c[f];if((new Date).getTime()>g.flushAfter&&!e[g.id]&&(g.xf=!0,b.push(g),b.length>=a))break}}return b},this)):E.resolve(b)};O.prototype.Bf=function(a){var b={};d.h(a,function(e){b[e]=!0});this.M=Ya(this.M,b);if(this.C){var c=d.bind(function(){return this.$().then(d.bind(function(){return this.Sa()},this)).then(d.bind(function(e){e=Ya(e,b);return this.nc(e)},this)).then(d.bind(function(){return this.Sa()},this)).then(d.bind(function(e){for(var f=0;f<e.length;f++){var g=e[f];if(g.id&&
b[g.id])throw Error("Item not removed from storage");}return!0},this)).catch(d.bind(function(e){this.s("Error removing items",e,a);return!1},this))},this);return this.lock.xc(c,this.pb).catch(d.bind(function(e){this.s("Error acquiring storage lock",e);return ta(this.lock.storage,!0)?!1:c().then(d.bind(function(f){return f?f:this.V.removeItem(this.va).then(function(){return f})},this)).catch(d.bind(function(f){this.s("Error clearing queue",f);return!1},this))},this))}return E.resolve(!0)};O.prototype.sg=
function(a){this.M=Xa(this.M,a);return this.C?this.lock.xc(d.bind(function(){return this.$().then(d.bind(function(){return this.Sa()},this)).then(d.bind(function(b){b=Xa(b,a);return this.nc(b)},this)).catch(d.bind(function(b){this.s("Error updating items",a,b);return!1},this))},this),this.pb).catch(d.bind(function(b){this.s("Error acquiring storage lock",b);return!1},this)):E.resolve(!0)};O.prototype.Sa=function(){return this.$().then(d.bind(function(){return this.V.getItem(this.va)},this)).then(d.bind(function(a){a&&
!d.isArray(a)&&(this.s("Invalid storage entry:",a),a=null);return a||[]},this)).catch(d.bind(function(a){this.s("Error retrieving queue",a);return[]},this))};O.prototype.nc=function(a){return this.$().then(d.bind(function(){return this.V.setItem(this.va,a)},this)).then(function(){return!0}).catch(d.bind(function(b){this.s("Error saving queue",b);return!1},this))};O.prototype.clear=function(){this.M=[];return this.C?this.$().then(d.bind(function(){return this.V.removeItem(this.va)},this)):E.resolve()};
var pa=la("batch");M.prototype.enqueue=function(a){return this.Qa.enqueue(a,this.hb)};M.prototype.start=function(){this.stopped=!1;this.Lb=0;return this.flush()};M.prototype.stop=function(){this.stopped=!0;this.tc&&(clearTimeout(this.tc),this.tc=null)};M.prototype.clear=function(){return this.Qa.clear()};M.prototype.Kd=function(){this.Y=this.U.batch_size};M.prototype.ta=function(){this.Md(this.U.batch_flush_interval_ms)};M.prototype.Md=function(a){this.hb=a;this.stopped||(this.tc=setTimeout(d.bind(function(){this.stopped||
this.flush()},this),this.hb))};M.prototype.Lf=function(a,b){return new E(d.bind(function(c){this.Jf(a,b,c)},this))};M.prototype.flush=function(a){if(this.mc)return pa.log("Flush: Request already in progress"),E.resolve();this.mc=!0;a=a||{};var b=this.U.batch_request_timeout_ms,c=(new Date).getTime(),e=this.Y;return this.Qa.Le(e).then(d.bind(function(f){var g=f.length===e,k=[],h={};d.h(f,function(m){var t=m.payload;this.bb&&!m.xf&&(t=this.bb(t));if(t){t.event&&t.properties&&(t.properties=d.extend({},
t.properties,{mp_sent_by_lib_version:"2.75.0-rc3"}));var u=!0,v=m.id;v?5<(this.da[v]||0)&&(this.s("[dupe] item ID sent too many times, not sending",{item:m,Y:f.length,gg:this.da[v]}),u=!1):this.s("[dupe] found item with no ID",{item:m});u&&k.push(t)}h[m.id]=t},this);if(1>k.length)return this.mc=!1,this.ta(),E.resolve();var n=d.bind(function(){return this.Qa.Bf(d.map(f,function(m){return m.id})).then(d.bind(function(m){d.h(f,d.bind(function(t){var u=t.id;u?(this.da[u]=this.da[u]||0,this.da[u]++,5<
this.da[u]&&this.s("[dupe] item ID sent too many times",{item:t,Y:f.length,gg:this.da[u]})):this.s("[dupe] found item with no ID while removing",{item:t})},this));if(m)return this.Lb=0,this.$c&&!g?(this.ta(),E.resolve()):this.flush();5<++this.Lb?(this.s("Too many queue failures; disabling batching system."),this.Yf()):this.ta();return E.resolve()},this))},this),r=d.bind(function(m){this.mc=!1;try{if(a.Xd)return this.Qa.sg(h);if(d.l(m)&&"timeout"===m.error&&(new Date).getTime()-c>=b)return this.s("Network timeout; retrying"),
this.flush();var t;if(t=d.l(m)){var u;if(!(u=500<=m.lb||429===m.lb)){var v;if(v=0>=m.lb){var J=p.navigator.onLine;v=!(d.m(J)||J)}u=v}t=u||"timeout"===m.error}if(t){var w=2*this.hb;m.Ld&&(w=1E3*parseInt(m.Ld,10)||w);w=Math.min(6E5,w);this.s("Error; retry in "+w+" ms");this.Md(w);return E.resolve()}if(d.l(m)&&413===m.lb){if(1<f.length)return this.Y=Math.min(this.Y,Math.max(1,Math.floor(e/2)),f.length-1),this.s("413 response; reducing batch size to "+this.Y),this.ta(),E.resolve();this.s("Single-event request too large; dropping",
f);this.Kd()}return n()}catch(N){this.s("Error handling API response",N),this.ta()}},this),q={method:"POST",ae:!0,Ze:!0,Td:b};a.Xd&&(q.sb="sendBeacon");pa.log("MIXPANEL REQUEST:",k);return this.Lf(k,q).then(r)},this)).catch(d.bind(function(f){this.s("Error flushing request queue",f);this.ta()},this))};M.prototype.s=function(a,b){pa.error.apply(pa.error,arguments);if(this.ka)try{b instanceof Error||(b=Error(a)),this.ka(a,b)}catch(c){pa.error(c)}};var Nb={Od:function(a,b){var c={},e={};d.l(a)?d.h(a,
function(f,g){this.P(g)||(e[g]=f)},this):e[a]=b;c.$set=e;return c},Yd:function(a){var b={},c=[];d.isArray(a)||(a=[a]);d.h(a,function(e){this.P(e)||c.push(e)},this);b.$unset=c;return b},Qd:function(a,b){var c={},e={};d.l(a)?d.h(a,function(f,g){this.P(g)||(e[g]=f)},this):e[a]=b;c.$set_once=e;return c},Wd:function(a,b){var c={},e={};d.l(a)?d.h(a,function(f,g){this.P(g)||(e[g]=d.isArray(f)?f:[f])},this):e[a]=d.isArray(b)?b:[b];c.$union=e;return c},ve:function(a,b){var c={},e={};d.l(a)?d.h(a,function(f,
g){this.P(g)||(e[g]=f)},this):e[a]=b;c.$append=e;return c},Jd:function(a,b){var c={},e={};d.l(a)?d.h(a,function(f,g){this.P(g)||(e[g]=f)},this):e[a]=b;c.$remove=e;return c},wg:function(){return{$delete:""}}};d.extend(D.prototype,Nb);D.prototype.Fa=function(a,b,c){this.i=a;this.Cb=b;this.Bb=c};D.prototype.set=ea(function(a,b,c){var e=this.Od(a,b);d.l(a)&&(c=b);return this.v(e,c)});D.prototype.ua=ea(function(a,b,c){var e=this.Qd(a,b);d.l(a)&&(c=b);return this.v(e,c)});D.prototype.tb=ea(function(a,b){a=
this.Yd(a);return this.v(a,b)});D.prototype.Wa=ea(function(a,b,c){d.l(a)&&(c=b);a=this.Wd(a,b);return this.v(a,c)});D.prototype["delete"]=ea(function(a){return this.v({$delete:""},a)});D.prototype.remove=ea(function(a,b,c){a=this.Jd(a,b);return this.v(a,c)});D.prototype.v=function(a,b){a.$group_key=this.Cb;a.$group_id=this.Bb;a.$token=this.K("token");a=d.Nb(a);return this.i.Gb({type:"groups",data:a,endpoint:this.i.ba("groups")+"/"+this.K("api_routes").groups,Jb:this.i.I.groups},b)};D.prototype.P=
function(a){return"$group_key"===a||"$group_id"===a};D.prototype.K=function(a){return this.i.g(a)};D.prototype.toString=function(){return this.i.toString()+".group."+this.Cb+"."+this.Bb};D.prototype.remove=D.prototype.remove;D.prototype.set=D.prototype.set;D.prototype.set_once=D.prototype.ua;D.prototype.union=D.prototype.Wa;D.prototype.unset=D.prototype.tb;D.prototype.toString=D.prototype.toString;d.extend(A.prototype,Nb);A.prototype.Fa=function(a){this.i=a};A.prototype.set=W(function(a,b,c){var e=
this.Od(a,b);d.l(a)&&(c=b);this.K("save_referrer")&&this.i.persistence.wc(document.referrer);e.$set=d.extend({},d.info.zf(),e.$set);return this.v(e,c)});A.prototype.ua=W(function(a,b,c){var e=this.Qd(a,b);d.l(a)&&(c=b);return this.v(e,c)});A.prototype.tb=W(function(a,b){a=this.Yd(a);return this.v(a,b)});A.prototype.jd=W(function(a,b,c){var e={},f={};d.l(a)?(d.h(a,function(g,k){this.P(k)||(isNaN(parseFloat(g))?z.error("Invalid increment value passed to mixpanel.people.increment - must be a number"):
f[k]=g)},this),c=b):(d.m(b)&&(b=1),f[a]=b);e.$add=f;return this.v(e,c)});A.prototype.append=W(function(a,b,c){d.l(a)&&(c=b);a=this.ve(a,b);return this.v(a,c)});A.prototype.remove=W(function(a,b,c){d.l(a)&&(c=b);a=this.Jd(a,b);return this.v(a,c)});A.prototype.Wa=W(function(a,b,c){d.l(a)&&(c=b);a=this.Wd(a,b);return this.v(a,c)});A.prototype.lg=W(function(){z.error("mixpanel.people.track_charge() is deprecated and no longer has any effect.")});A.prototype.Pc=function(a){return this.set("$transactions",
[],a)};A.prototype.Xc=function(){if(this.Db()){var a={$delete:this.i.ca()};return this.v(a)}z.error("mixpanel.people.delete_user() requires you to call identify() first")};A.prototype.toString=function(){return this.i.toString()+".people"};A.prototype.v=function(a,b){a.$token=this.K("token");a.$distinct_id=this.i.ca();var c=this.i.F("$device_id"),e=this.i.F("$user_id"),f=this.i.F("$had_persisted_distinct_id");c&&(a.$device_id=c);e&&(a.$user_id=e);f&&(a.$had_persisted_distinct_id=f);c=d.Nb(a);return this.Db()?
this.i.Gb({type:"people",data:c,endpoint:this.i.ba("people")+"/"+this.K("api_routes").engage,Jb:this.i.I.lc},b):(this.fe(a),d.m(b)||(this.K("verbose")?b({status:-1,error:null}):b(-1)),d.truncate(c,255))};A.prototype.K=function(a){return this.i.g(a)};A.prototype.Db=function(){return!0===this.i.Ca.gd};A.prototype.fe=function(a){"$set"in a?this.i.persistence.H("$set",a):"$set_once"in a?this.i.persistence.H("$set_once",a):"$unset"in a?this.i.persistence.H("$unset",a):"$add"in a?this.i.persistence.H("$add",
a):"$append"in a?this.i.persistence.H("$append",a):"$remove"in a?this.i.persistence.H("$remove",a):"$union"in a?this.i.persistence.H("$union",a):z.error("Invalid call to _enqueue():",a)};A.prototype.Da=function(a,b,c,e){var f=this,g=d.extend({},this.i.persistence.Ka(a)),k=g;d.m(g)||!d.l(g)||d.T(g)||(f.i.persistence.L(a,g),f.i.persistence.save(),e&&(k=e(g)),b.call(f,k,function(h,n){0===h&&f.i.persistence.H(a,g);d.m(c)||c(h,n)}))};A.prototype.ie=function(a,b,c,e,f,g,k){var h=this;this.Da("$set",this.set,
a);this.Da("$set_once",this.ua,e);this.Da("$unset",this.tb,g,function(q){return d.keys(q)});this.Da("$add",this.jd,b);this.Da("$union",this.Wa,f);a=this.i.persistence.Ka("$append");if(!d.m(a)&&d.isArray(a)&&a.length)for(b=function(q,m){0===q&&h.i.persistence.H("$append",n);d.m(c)||c(q,m)},e=a.length-1;0<=e;e--){a=this.i.persistence.Ka("$append");var n=a.pop();h.i.persistence.save();d.T(n)||h.append(n,b)}a=this.i.persistence.Ka("$remove");if(!d.m(a)&&d.isArray(a)&&a.length)for(b=function(q,m){0===
q&&h.i.persistence.H("$remove",r);d.m(k)||k(q,m)},e=a.length-1;0<=e;e--){a=this.i.persistence.Ka("$remove");var r=a.pop();h.i.persistence.save();d.T(r)||h.remove(r,b)}};A.prototype.P=function(a){return"$distinct_id"===a||"$token"===a||"$device_id"===a||"$user_id"===a||"$had_persisted_distinct_id"===a};A.prototype.set=A.prototype.set;A.prototype.set_once=A.prototype.ua;A.prototype.unset=A.prototype.tb;A.prototype.increment=A.prototype.jd;A.prototype.append=A.prototype.append;A.prototype.remove=A.prototype.remove;
A.prototype.union=A.prototype.Wa;A.prototype.track_charge=A.prototype.lg;A.prototype.clear_charges=A.prototype.Pc;A.prototype.delete_user=A.prototype.Xc;A.prototype.toString=A.prototype.toString;var uc="__mps __mpso __mpus __mpa __mpap __mpr __mpu $people_distinct_id __alias __timers".split(" ");B.prototype.Pa=function(){var a={};this.load();d.h(this.props,function(b,c){d.$b(uc,c)||(a[c]=b)});return a};B.prototype.load=function(){if(!this.disabled){var a=this.storage.parse(this.name);a&&(this.props=
d.extend({},a))}};B.prototype.upgrade=function(){if(this.storage===d.localStorage){var a=d.cookie.parse(this.name);d.cookie.remove(this.name);d.cookie.remove(this.name,!0);a&&this.O(a)}else this.storage===d.cookie&&(a=d.localStorage.parse(this.name),d.localStorage.remove(this.name),a&&this.O(a))};B.prototype.save=function(){this.disabled||this.storage.set(this.name,fa(this.props),this.Qb,this.Mb,this.Nd,this.Vc,this.eb)};B.prototype.nb=function(a){this.load();return this.props[a]};B.prototype.remove=
function(){this.storage.remove(this.name,!1,this.eb);this.storage.remove(this.name,!0,this.eb)};B.prototype.clear=function(){this.remove();this.props={}};B.prototype.O=function(a,b,c){return d.l(a)?("undefined"===typeof b&&(b="None"),this.Qb="undefined"===typeof c?this.Wc:c,this.load(),d.h(a,function(e,f){this.props.hasOwnProperty(f)&&this.props[f]!==b||(this.props[f]=e)},this),this.save(),!0):!1};B.prototype.register=function(a,b){return d.l(a)?(this.Qb="undefined"===typeof b?this.Wc:b,this.load(),
d.extend(this.props,a),this.save(),!0):!1};B.prototype.unregister=function(a){this.load();a in this.props&&(delete this.props[a],this.save())};B.prototype.$d=function(a){this.register(d.info.Hf(a))};B.prototype.wc=function(a){this.O({$initial_referrer:a||"$direct",$initial_referring_domain:d.info.Hd(a)||"$direct"},"")};B.prototype.We=function(){return d.wa({$initial_referrer:this.props.$initial_referrer,$initial_referring_domain:this.props.$initial_referring_domain})};B.prototype.Zd=function(a){this.Wc=
this.Qb=a.cookie_expiration;this.Pd(a.disable_persistence);this.Pf(a.cookie_domain);this.Qf(a.cross_site_cookie);this.Rf(a.cross_subdomain_cookie);this.Uf(a.secure_cookie)};B.prototype.Pd=function(a){(this.disabled=a)?this.remove():this.save()};B.prototype.Pf=function(a){a!==this.eb&&(this.remove(),this.eb=a,this.save())};B.prototype.Qf=function(a){a!==this.Vc&&(this.Vc=a,this.remove(),this.save())};B.prototype.Rf=function(a){a!==this.Mb&&(this.Mb=a,this.remove(),this.save())};B.prototype.Ue=function(){return this.Mb};
B.prototype.Uf=function(a){a!==this.Nd&&(this.Nd=a?!0:!1,this.remove(),this.save())};B.prototype.H=function(a,b){var c=this.Za(a);a=b[a];var e=this.W("$set"),f=this.W("$set_once"),g=this.W("$unset"),k=this.W("$add"),h=this.W("$union"),n=this.W("$remove",[]),r=this.W("$append",[]);"__mps"===c?(d.extend(e,a),this.L("$add",a),this.L("$union",a),this.L("$unset",a)):"__mpso"===c?(d.h(a,function(q,m){m in f||(f[m]=q)}),this.L("$unset",a)):"__mpus"===c?d.h(a,function(q){d.h([e,f,k,h],function(m){q in m&&
delete m[q]});d.h(r,function(m){q in m&&delete m[q]});g[q]=!0}):"__mpa"===c?(d.h(a,function(q,m){m in e?e[m]+=q:(m in k||(k[m]=0),k[m]+=q)},this),this.L("$unset",a)):"__mpu"===c?(d.h(a,function(q,m){d.isArray(q)&&(m in h||(h[m]=[]),d.h(q,function(t){d.$b(h[m],t)||h[m].push(t)}))}),this.L("$unset",a)):"__mpr"===c?(n.push(a),this.L("$append",a)):"__mpap"===c&&(r.push(a),this.L("$unset",a));z.log("MIXPANEL PEOPLE REQUEST (QUEUED, PENDING IDENTIFY):");z.log(b);this.save()};B.prototype.L=function(a,b){var c=
this.props[this.Za(a)];d.m(c)||d.h(b,function(e,f){"$append"===a||"$remove"===a?d.h(c,function(g){g[f]===e&&delete g[f]}):delete c[f]},this)};B.prototype.Ka=function(a){return this.nb(this.Za(a))};B.prototype.Za=function(a){if("$set"===a)return"__mps";if("$set_once"===a)return"__mpso";if("$unset"===a)return"__mpus";if("$add"===a)return"__mpa";if("$append"===a)return"__mpap";if("$remove"===a)return"__mpr";if("$union"===a)return"__mpu";z.error("Invalid queue:",a)};B.prototype.W=function(a,b){a=this.Za(a);
b=d.m(b)?{}:b;return this.props[a]||(this.props[a]=b)};B.prototype.Sf=function(a){var b=(new Date).getTime(),c=this.nb("__timers")||{};c[a]=b;this.props.__timers=c;this.save()};B.prototype.Cf=function(a){var b=(this.nb("__timers")||{})[a];d.m(b)||(delete this.props.__timers[a],this.save());return b};var vc=["mixpanelRecordingEvents","mixpanelRecordingRegistry"];U.prototype.Gc=function(){return new E(function(a,b){var c=p.indexedDB.open("mixpanelBrowserDb",1);c.onerror=function(){b(c.error)};c.onsuccess=
function(){a(c.result)};c.onupgradeneeded=function(e){var f=e.target.result;vc.forEach(function(g){f.createObjectStore(g)})}})};U.prototype.B=function(){if(!p.indexedDB)return E.reject("indexedDB is not supported in this browser");this.ja||(this.ja=this.Gc());return this.ja.then(function(a){return a instanceof p.IDBDatabase?E.resolve():E.reject(a)})};U.prototype.ob=function(a,b){function c(f){return new E(function(g,k){var h=f.transaction(e,a);h.oncomplete=function(){g(h)};h.onabort=h.onerror=function(){k(h.error)};
b(h.objectStore(e))})}var e=this.bg;return this.ja.then(c).catch(function(f){return f&&"InvalidStateError"===f.name?(this.ja=this.Gc(),this.ja.then(c)):E.reject(f)}.bind(this))};U.prototype.setItem=function(a,b){return this.ob("readwrite",function(c){c.put(b,a)})};U.prototype.getItem=function(a){var b;return this.ob("readonly",function(c){b=c.get(a)}).then(function(){return b.result})};U.prototype.removeItem=function(a){return this.ob("readwrite",function(b){b.delete(a)})};U.prototype.getAll=function(){var a;
return this.ob("readonly",function(b){a=b.getAll()}).then(function(){return a.result})};var ra,G,ha=p.XMLHttpRequest&&"withCredentials"in new XMLHttpRequest,Wa=!ha&&-1===K.indexOf("MSIE")&&-1===K.indexOf("Mozilla"),Aa=null;X.sendBeacon&&(Aa=function(){return X.sendBeacon.apply(X,arguments)});var Ob={track:"track/",engage:"engage/",groups:"groups/",record:"record/",flags:"flags/",settings:"settings/"},Ua={api_host:"https://api-js.mixpanel.com",api_hosts:{},api_routes:Ob,api_extra_query_params:{},api_method:"POST",
api_transport:"XHR",api_payload_format:"base64",app_host:"https://mixpanel.com",autocapture:!1,cdn:"https://cdn.mxpnl.com",cross_site_cookie:!1,cross_subdomain_cookie:!0,error_reporter:ja,flags:!1,persistence:"cookie",persistence_name:"",cookie_domain:"",cookie_name:"",loaded:ja,mp_loader:null,track_marketing:!0,track_pageview:!1,skip_first_touch_marketing:!1,store_google:!0,stop_utm_persistence:!1,save_referrer:!0,test:!1,verbose:!1,img:!1,debug:!1,track_links_timeout:300,cookie_expiration:365,upgrade:!1,
...
else return a=qa(a,b,c),G[c]=a,a.$a(),a};l.prototype.Fa=function(a,b,c){b=b||{};this.__loaded=!0;this.config={};var e={};"api_payload_format"in b||(b.api_host||Ua.api_host).match(/\.mixpanel\.com/)&&(e.api_payload_format="json");this.G={};this.Ta(d.extend({},Ua,e,b,{name:c,token:a,callback_fn:("mixpanel"===c?c:"mixpanel."+c)+"._jsc"}));this._jsc=ja;this.wb=[];this.xb=[];this.vb=[];this.Ca={disable_all_events:!1,identify_called:!1};this.I={};if(this.Ba=this.g("batch_requests"))if(d.localStorage.Ia(!0)&&
ha){if(this.jf(),Aa&&p.addEventListener){var f=d.bind(function(){this.I.la.stopped||this.I.la.flush({Xd:!0})},this);p.addEventListener("pagehide",function(g){g.persisted&&f()});p.addEventListener("visibilitychange",function(){"hidden"===y.visibilityState&&f()})}}else this.Ba=!1,z.log("Turning off Mixpanel request-queueing; needs XHR and localStorage support"),d.h(this.dd(),function(g){z.log("Clearing batch queue "+g.Ra);d.localStorage.remove(g.Ra)});this.persistence=this.cookie=new B(this.config);
this.ya={};this.je();a=d.Aa();this.ca()||this.O({distinct_id:"$device:"+a,$device_id:a},"");this.flags=new x({ib:d.bind(function(){return this.ba("flags")+"/"+this.g("api_routes").flags},this),Oe:d.bind(this.g,this),Nf:d.bind(this.Ta,this),Te:d.bind(this.F,this),pg:d.bind(this.track,this),hc:Ca,sc:this.g("targeting_src")});this.flags.B();this.flags=this.flags;this.Ib=new H(this);this.Ib.B();this.le();a=this.g("remote_settings_mode");"strict"===a||"fallback"===a?this.he(a).then(d.bind(function(){this.Xa()},
this)):this.Xa()};l.prototype.le=function(){if(this.g("disable_persistence"))z.log("Tab ID initialization skipped due to disable_persistence config");else if(d.sessionStorage.Ia())try{var a=this.g("name")+"_"+this.g("token"),b="mp_tab_id_"+a,c="mp_gen_new_tab_id_"+a;!d.sessionStorage.get(c)&&d.sessionStorage.get(b)||d.sessionStorage.set(b,"$tab-"+d.Aa());d.sessionStorage.set(c,"1");this.eg=d.sessionStorage.get(b);p.addEventListener("beforeunload",function(){d.sessionStorage.remove(c)})}catch(e){this.A("Error initializing tab id",
e)}else this.A("Session storage is not supported, cannot keep track of unique tab ID.")};l.prototype.fd=function(){return this.eg||null};l.prototype.ne=function(){if(this.g("disable_persistence"))return z.log("Load recorder check skipped due to disable_persistence config"),Promise.resolve(!1);var a=new U("mixpanelRecordingRegistry"),b=this.fd();return a.B().then(function(){return a.getAll()}).then(function(c){for(var e=0;e<c.length;e++){var f=c[e],g=Date.now();if(!f||g>f.maxExpires||g>f.idleExpires||
c[e].tabId===b)return!0}return!1}).catch(d.bind(function(c){this.A("Error checking recording registry",c)},this))};l.prototype.Xa=Z(function(a){if(p.MutationObserver){var b=d.bind(function(e){var f=d.bind(function(){this.D=this.D||new p.__mp_recorder(this);this.D.resumeRecording(e)},this);d.m(p.__mp_recorder)?Ca(this.g("recorder_src"),f):f()},this),c=0<this.g("record_sessions_percent")&&100*Math.random()<=this.g("record_sessions_percent");a||c?b(!0):this.ne().then(function(e){e&&b(!1)})}else z.j("Browser does not support MutationObserver; skipping session recording")});
l.prototype.Xf=function(){this.Xa(!0)};l.prototype.rc=function(){return this.D?this.D.stopRecording():Promise.resolve()};l.prototype.yf=function(){return this.D?this.D.pauseRecording():Promise.resolve()};l.prototype.Ff=function(){return this.D?this.D.resumeRecording():Promise.resolve()};l.prototype.pa=function(){return this.Ab()&&this.g("record_heatmap_data")};l.prototype.ed=function(){var a={},b=this.Ab();b&&(a.$mp_replay_id=b);return a};l.prototype.Xe=function(){var a=null,b=this.Ab();b&&(a="https://mixpanel.com/projects/replay-redirect?"+
d.ub({replay_id:b,distinct_id:this.ca(),token:this.g("token")}));return a};l.prototype.Ab=function(){var a=null;this.D&&(a=this.D.replayId);return a||null};l.prototype.be=function(){return this.D};l.prototype.$a=function(){this.g("loaded")(this);this.Kc();this.people.ua(this.persistence.We());if(this.g("store_google")&&this.g("stop_utm_persistence")){var a=d.info.Ga(null);d.h(a,function(b,c){this.unregister(c)}.bind(this))}};l.prototype.Kc=function(){this.persistence.$d(y.referrer);this.g("store_google")&&
!this.g("stop_utm_persistence")&&this.register(d.info.Ga());this.g("save_referrer")&&this.persistence.wc(y.referrer)};l.prototype.ee=function(){d.h(this.wb,function(a){this.Fb.apply(this,a)},this);this.Ha()||d.h(this.xb,function(a){this.v.apply(this,a)},this);delete this.wb;delete this.xb};l.prototype.Fb=function(a,b){if(this.g("img"))return this.A("You can't use DOM tracking functions with img = true."),!1;if(!Va)return this.wb.push([a,b]),!1;a=(new a).B(this);return a.track.apply(a,b)};l.prototype.Hc=
function(a,b){if(d.m(a))return null;if(ha)return function(g){a(g,b)};var c=this._jsc,e=""+Math.floor(1E8*Math.random()),f=this.g("callback_fn")+"["+e+"]";c[e]=function(g){delete c[e];a(g,b)};return f};l.prototype.v=function(a,b,c,e){var f=!0;if(Wa)return this.xb.push(arguments),f;var g={method:this.g("api_method"),sb:this.g("api_transport"),ae:this.g("verbose")},k=null;e||!d.na(c)&&"string"!==typeof c||(e=c,c=null);c=d.extend(g,c||{});ha||(c.method="GET");g="POST"===c.method;var h=Aa&&g&&"sendbeacon"===
c.sb.toLowerCase(),n=c.ae;b.verbose&&(n=!0);this.g("test")&&(b.test=1);n&&(b.verbose=1);this.g("img")&&(b.img=1);if(!ha)if(e)b.callback=e;else if(n||this.g("test"))b.callback="(function(){})";b.ip=this.g("ip")?1:0;b._=(new Date).getTime().toString();g&&(k="data="+encodeURIComponent(b.data),delete b.data);d.extend(b,this.g("api_extra_query_params"));a+="?"+d.ub(b);var r=this;if("img"in b)k=y.createElement("img"),k.src=a,y.body.appendChild(k);else if(h){try{f=Aa(a,k)}catch(u){r.A(u),f=!1}try{e&&e(f?
1:0)}catch(u){r.A(u)}}else if(ha)try{var q=new XMLHttpRequest;q.open(c.method,a,!0);var m=this.g("xhr_headers");g&&(m["Content-Type"]="application/x-www-form-urlencoded");d.h(m,function(u,v){q.setRequestHeader(v,u)});if(c.Td&&"undefined"!==typeof q.timeout){q.timeout=c.Td;var t=(new Date).getTime()}q.withCredentials=!0;q.onreadystatechange=function(){if(4===q.readyState)if(200===q.status){if(e)if(n){try{var u=d.za(q.responseText)}catch(v){if(r.A(v),c.Ze)u=q.responseText;else return}e(u)}else e(Number(q.responseText))}else u=
q.timeout&&!q.status&&(new Date).getTime()-t>=q.timeout?"timeout":"Bad HTTP status: "+q.status+" "+q.statusText,r.A(u),e&&(n?e({status:0,lb:q.status,error:u,Ld:(q.responseHeaders||{})["Retry-After"]}):e(0))};q.send(k)}catch(u){r.A(u),f=!1}else k=y.createElement("script"),k.type="text/javascript",k.async=!0,k.defer=!0,k.src=a,m=y.getElementsByTagName("script")[0],m.parentNode.insertBefore(k,m);return f};l.prototype.he=function(a){function b(){"strict"===a&&f.Ta({record_sessions_percent:0})}if(!p.AbortController)return z.j("Remote settings unavailable: missing minimum required APIs"),
b(),Promise.resolve();var c=this.ba("settings")+"/"+this.g("api_routes").settings,e=d.ub({$lib_version:"2.75.0-rc3",mp_lib:"web",sdk_config:"1"});c=c+"?"+e;var f=this,g=new AbortController,k=setTimeout(function(){g.abort()},500);return p.fetch(c,{method:"GET",headers:{Authorization:"Basic "+btoa(f.g("token")+":")},signal:g.signal}).then(function(h){clearTimeout(k);if(h.ok)return h.json();z.j("Network response was not ok");b()}).then(function(h){if(h&&h.sdk_config&&h.sdk_config.config){var n={};d.h(h.sdk_config.config,
function(r,q){Ua.hasOwnProperty(q)&&(n[q]=r)});d.T(n)?(z.j("No valid config keys found in remote settings."),b()):f.Ta(n)}else b()}).catch(function(h){clearTimeout(k);z.j("Failed to fetch remote settings",h);b()})};l.prototype.yb=function(a){function b(k,h){d.h(k,function(n){if(d.isArray(n[0])){var r=h;d.h(n,function(q){r=r[q[0]].apply(r,q.slice(1))})}else this[n[0]].apply(this,n.slice(1))},h)}var c,e=[],f=[],g=[];d.h(a,function(k){k&&(c=k[0],d.isArray(c)?g.push(k):"function"===typeof k?k.call(this):
d.isArray(k)&&"alias"===c?e.push(k):d.isArray(k)&&-1!==c.indexOf("track")&&"function"===typeof this[c]?g.push(k):f.push(k))},this);b(e,this);b(f,this);b(g,this)};l.prototype.Nc=function(){return!!this.I.la};l.prototype.dd=function(){var a="__mpq_"+this.g("token");return this.zc=this.zc||{la:{type:"events",ab:"track",Ra:a+"_ev"},lc:{type:"people",ab:"engage",Ra:a+"_pp"},groups:{type:"groups",ab:"groups",Ra:a+"_gr"}}};l.prototype.jf=function(){if(!this.Nc()){var a=d.bind(function(c){return new M(c.Ra,
{U:this.config,ka:this.g("error_reporter"),Kf:d.bind(function(e,f,g){this.v(this.ba(c.ab)+"/"+this.g("api_routes")[c.ab],this.Bc(e),f,this.Hc(g,e))},this),bb:d.bind(function(e){return(e=this.X("before_send_"+c.type,e))?e[0]:null},this),Zf:d.bind(this.qc,this),C:!0})},this),b=this.dd();this.I={la:a(b.la),lc:a(b.lc),groups:a(b.groups)}}this.g("batch_autostart")&&this.pc()};l.prototype.pc=function(){this.ce=!0;this.Nc()&&(this.Ba=!0,d.h(this.I,function(a){a.start()}))};l.prototype.qc=function(){this.Ba=
!1;d.h(this.I,function(a){a.stop();a.clear()})};l.prototype.push=function(a){this.yb([a])};l.prototype.disable=function(a){"undefined"===typeof a?this.Ca.Ge=!0:this.vb=this.vb.concat(a)};l.prototype.Bc=function(a){a=fa(a);"base64"===this.g("api_payload_format")&&(a=d.we(a));return{data:a}};l.prototype.Gb=function(a,b){var c=d.truncate(a.data,255),e=a.endpoint,f=a.Jb,g=a.Vf,k=a.Mf||{};b=b||ja;var h=!0,n=d.bind(function(){k.oc||(c=this.X("before_send_"+a.type,c))&&(c=c[0]);return c?(z.log("MIXPANEL REQUEST:"),
z.log(c),this.v(e,this.Bc(c),k,this.Hc(b,c))):null},this);this.Ba&&!g?f.enqueue(c).then(function(r){r?b(1,c):n()}):h=n();return h&&c};l.prototype.track=Z(function(a,b,c,e){if(!c||!c.oc){var f=this.X("before_track",a,b);if(null===f)return;a=f[0];b=f[1]}e||"function"!==typeof c||(e=c,c=null);c=c||{};if(f=c.transport)c.sb=f;f=c.send_immediately;"function"!==typeof e&&(e=ja);if(d.m(a))this.A("No event name provided to mixpanel.track");else if(this.Dc(a))e(0);else{b=d.extend({},b);b.token=this.g("token");
var g=this.persistence.Cf(a);d.m(g)||(b.$duration=parseFloat((((new Date).getTime()-g)/1E3).toFixed(3)));this.Kc();g=this.g("track_marketing")?d.info.qf():{};b=d.extend({},d.info.Pa({mp_loader:this.g("mp_loader")}),g,this.persistence.Pa(),this.ya,this.ed(),b);g=this.g("property_blacklist");d.isArray(g)?d.h(g,function(k){delete b[k]}):this.A("Invalid value for property_blacklist config: "+g);f=this.Gb({type:"events",data:{event:a,properties:b},endpoint:this.ba("events")+"/"+this.g("api_routes").track,
Jb:this.I.la,Vf:f,Mf:c},e);this.flags&&this.flags.Oc&&this.flags.Oc(a,b);return f}});l.prototype.Tf=Z(function(a,b,c){d.isArray(b)||(b=[b]);var e={};e[a]=b;this.register(e);return this.people.set(a,b,c)});l.prototype.qe=Z(function(a,b,c){var e=this.F(a),f={};void 0===e?(f[a]=[b],this.register(f)):-1===e.indexOf(b)&&(e.push(b),f[a]=e,this.register(f));return this.people.Wa(a,b,c)});l.prototype.Df=Z(function(a,b,c){var e=this.F(a);if(void 0!==e){var f=e.indexOf(b);-1<f&&(e.splice(f,1),this.register({xg:e}));
0===e.length&&this.unregister(a)}return this.people.remove(a,b,c)});l.prototype.og=Z(function(a,b,c,e){var f=d.extend({},b||{});d.h(c,function(g,k){null!==g&&void 0!==g&&(f[k]=g)});return this.track(a,f,e)});l.prototype.de=function(a,b){return a+"_"+JSON.stringify(b)};l.prototype.Ve=function(a,b){var c=this.de(a,b),e=this.Ac[c];if(void 0===e||e.Cb!==a||e.Bb!==b)e=new D,e.Fa(this,a,b),this.Ac[c]=e;return e};l.prototype.vc=Z(function(a,b){"object"!==typeof a&&(a={});b=b||{};b=b.event_name||"$mp_web_page_view";
var c=d.extend(d.info.sf(),d.info.Ga(),d.info.Rc());a=d.extend({},c,a);return this.track(b,a)});l.prototype.ng=function(){return this.Fb.call(this,ca,arguments)};l.prototype.mg=function(){return this.Fb.call(this,sa,arguments)};l.prototype.fg=function(a){d.m(a)?this.A("No event name provided to mixpanel.time_event"):this.Dc(a)||this.persistence.Sf(a)};var Sb={persistent:!0};l.prototype.register=function(a,b){b=this.X("before_register",a,b);null!==b&&(a=b[0],b=b[1],b=Ba(b),b.persistent?this.persistence.register(a,
b.days):d.extend(this.ya,a))};l.prototype.O=function(a,b,c){c=this.X("before_register_once",a,b,c);null!==c&&(a=c[0],b=c[1],c=c[2],c=Ba(c),c.persistent?this.persistence.O(a,b,c.days):("undefined"===typeof b&&(b="None"),d.h(a,function(e,f){this.ya.hasOwnProperty(f)&&this.ya[f]!==b||(this.ya[f]=e)},this)))};l.prototype.unregister=function(a,b){b=this.X("before_unregister",a,b);null!==b&&(a=b[0],b=b[1],b=Ba(b),b.persistent?this.persistence.unregister(a):delete this.ya[a])};l.prototype.Jc=function(a,
b){var c={};c[a]=b;this.register(c)};l.prototype.Zb=function(a,b,c,e,f,g,k,h){a=this.X("before_identify",a);if(null===a)return-1;a=a[0];var n=this.ca();if(a&&n!==a){if("string"===typeof a&&0===a.indexOf("$device:"))return this.A("distinct_id cannot have $device: prefix"),-1;this.register({$user_id:a})}this.F("$device_id")||this.O({$had_persisted_distinct_id:!0,$device_id:n},"");a!==n&&a!==this.F("__alias")&&(this.unregister("__alias"),this.register({distinct_id:a}));this.Ca.gd=!0;this.people.ie(b,
c,e,f,g,k,h);a!==n&&this.track("$identify",{distinct_id:a,$anon_distinct_id:n},{oc:!0});a!==n&&this.flags.Rb()};l.prototype.reset=function(){this.rc();this.persistence.clear();this.Ca.gd=!1;var a=d.Aa();this.O({distinct_id:"$device:"+a,$device_id:a},"");this.Xa()};l.prototype.ca=function(){return this.F("distinct_id")};l.prototype.se=function(a,b){if(a===this.F("$people_distinct_id"))return this.A("Attempting to create alias for existing People user - aborting."),-2;var c=this;d.m(b)&&(b=this.ca());
if(a!==b)return this.Jc("__alias",a),this.track("$create_alias",{alias:a,distinct_id:b},{oc:!0},function(){c.Zb(a)});this.A("alias matches current distinct_id - skipping api call.");this.Zb(a);return-1};l.prototype.tf=function(a){this.Jc("mp_name_tag",a)};l.prototype.Ta=function(a){d.l(a)&&(d.extend(this.config,a),a.batch_size&&d.h(this.I,function(b){b.Kd()}),this.g("persistence_name")||(this.config.persistence_name=this.config.cookie_name),this.g("disable_persistence")||(this.config.disable_persistence=
this.config.disable_cookie),this.persistence&&this.persistence.Zd(this.config),T=T||this.g("debug"),("autocapture"in a||"record_heatmap_data"in a)&&this.Ib&&this.Ib.B(),d.l(a.hooks)&&(this.G={},d.h(a.hooks,function(b,c){if(d.na(b))this.G[c]=[b];else if(d.isArray(b)){this.G[c]=[];for(var e=0;e<b.length;e++)d.na(b[e])||z.j("Invalid hook added. Hook is not a function"),this.G[c].push(b[e])}else z.j("Invalid hooks added. Ensure that the hook values passed into config.hooks are functions or arrays of functions.")},
this)))};l.prototype.g=function(a){return this.config[a]};l.prototype.X=function(a){var b=ba.call(arguments,1);d.h(this.G[a],function(c){if(null===b)return null;c=c.apply(this,b);"undefined"===typeof c?(this.A(a+" hook did not return a valid value"),b=null):(d.isArray(c)||(c=[c]),b.splice.apply(b,[0,c.length].concat(c)))},this);return b};l.prototype.F=function(a){return this.persistence.nb([a])};l.prototype.ba=function(a){return this.g("api_hosts")[a]||this.g("api_host")};l.prototype.toString=function(){var a=
this.g("name");"mixpanel"!==a&&(a="mixpanel."+a);return a};l.prototype.Dc=function(a){return d.ld(K)||this.Ca.Ge||d.$b(this.vb,a)};l.prototype.je=function(){"localStorage"===this.g("opt_out_tracking_persistence_type")&&d.localStorage.Ia()&&(!this.kb()&&this.kb({persistence_type:"cookie"})&&this.zd({enable_persistence:!1}),!this.Ha()&&this.Ha({persistence_type:"cookie"})&&this.jc({clear_persistence:!1}),this.Qc({persistence_type:"cookie",enable_persistence:!1}));this.Ha()?this.Ya({clear_persistence:!0}):
this.kb()||!this.g("opt_out_tracking_by_default")&&!d.cookie.get("mp_optout")||(d.cookie.remove("mp_optout"),this.jc({clear_persistence:this.g("opt_out_persistence_by_default")}))};l.prototype.Ya=function(a){if(a&&a.clear_persistence)a=!0;else if(a&&a.enable_persistence)a=!1;else return;this.g("disable_persistence")||this.persistence.disabled===a||this.persistence.Pd(a);a?(this.qc(),this.rc()):this.ce&&this.pc()};l.prototype.Ea=function(a,b){b=d.extend({track:d.bind(this.track,this),persistence_type:this.g("opt_out_tracking_persistence_type"),
cookie_prefix:this.g("opt_out_tracking_cookie_prefix"),cookie_expiration:this.g("cookie_expiration"),cross_site_cookie:this.g("cross_site_cookie"),cross_subdomain_cookie:this.g("cross_subdomain_cookie"),cookie_domain:this.g("cookie_domain"),secure_cookie:this.g("secure_cookie"),ignore_dnt:this.g("ignore_dnt")},b);d.localStorage.Ia()||(b.persistence_type="cookie");return a(this.g("token"),{track:b.track,ig:b.track_event_name,kg:b.track_properties,Dd:b.persistence_type,Cd:b.cookie_prefix,Sc:b.cookie_domain,
Tc:b.cookie_expiration,Fe:b.cross_site_cookie,Uc:b.cross_subdomain_cookie,If:b.secure_cookie,hd:b.ignore_dnt})};l.prototype.zd=function(a){a=d.extend({enable_persistence:!0},a);this.Ea(hc,a);this.Ya(a)};l.prototype.jc=function(a){a=d.extend({clear_persistence:!0,delete_user:!0},a);a.delete_user&&this.people&&this.people.Db()&&(this.people.Xc(),this.people.Pc());this.Ea(ic,a);this.Ya(a)};l.prototype.kb=function(a){return this.Ea(jc,a)};l.prototype.Ha=function(a){return this.Ea(xb,a)};l.prototype.Qc=
function(a){a=d.extend({enable_persistence:!0},a);this.Ea(lc,a);this.Ya(a)};l.prototype.A=function(a,b){z.error.apply(z.error,arguments);try{b||a instanceof Error||(a=Error(a)),this.g("error_reporter")(a,b)}catch(c){z.error(c)}};l.prototype.re=function(a,b){this.G[a]||(this.G[a]=[]);this.G[a].push(b)};l.prototype.Ef=function(a,b){this.G[a]&&(b=this.G[a].indexOf(b),-1!==b?this.G[a].splice(b,1):z.log("remove_hook failed. Matching hook was not found"))};l.prototype.init=l.prototype.B;l.prototype.reset=
l.prototype.reset;l.prototype.disable=l.prototype.disable;l.prototype.time_event=l.prototype.fg;l.prototype.track=l.prototype.track;l.prototype.track_links=l.prototype.ng;l.prototype.track_forms=l.prototype.mg;l.prototype.track_pageview=l.prototype.vc;l.prototype.register=l.prototype.register;l.prototype.register_once=l.prototype.O;l.prototype.unregister=l.prototype.unregister;l.prototype.identify=l.prototype.Zb;l.prototype.alias=l.prototype.se;l.prototype.name_tag=l.prototype.tf;l.prototype.set_config=
l.prototype.Ta;l.prototype.get_config=l.prototype.g;l.prototype.get_api_host=l.prototype.ba;l.prototype.get_property=l.prototype.F;l.prototype.get_distinct_id=l.prototype.ca;l.prototype.toString=l.prototype.toString;l.prototype.opt_out_tracking=l.prototype.jc;l.prototype.opt_in_tracking=l.prototype.zd;l.prototype.has_opted_out_tracking=l.prototype.Ha;l.prototype.has_opted_in_tracking=l.prototype.kb;l.prototype.clear_opt_in_out_tracking=l.prototype.Qc;l.prototype.get_group=l.prototype.Ve;l.prototype.set_group=
l.prototype.Tf;l.prototype.add_group=l.prototype.qe;l.prototype.remove_group=l.prototype.Df;l.prototype.add_hook=l.prototype.re;l.prototype.remove_hook=l.prototype.Ef;l.prototype.track_with_groups=l.prototype.og;l.prototype.start_batch_senders=l.prototype.pc;l.prototype.stop_batch_senders=l.prototype.qc;l.prototype.start_session_recording=l.prototype.Xf;l.prototype.stop_session_recording=l.prototype.rc;l.prototype.pause_session_recording=l.prototype.yf;l.prototype.resume_session_recording=l.prototype.Ff;
l.prototype.get_session_recording_properties=l.prototype.ed;l.prototype.get_session_replay_url=l.prototype.Xe;l.prototype.get_tab_id=l.prototype.fd;l.prototype.DEFAULT_API_ROUTES=Ob;l.prototype.__get_recorder=l.prototype.be;B.prototype.properties=B.prototype.Pa;B.prototype.update_search_keyword=B.prototype.$d;B.prototype.update_referrer_info=B.prototype.wc;B.prototype.get_cross_subdomain=B.prototype.Ue;B.prototype.clear=B.prototype.clear;var S={};(function(a){Ca=a;ra=1;G=p.mixpanel;d.m(G)?z.j('"mixpanel" object not initialized. Ensure you are using the latest version of the Mixpanel JS Library along with the snippet we provide.'):
G.__loaded||G.config&&G.persistence?z.j("The Mixpanel library has already been downloaded at least once. Ensure that the Mixpanel code snippet only appears once on the page (and is not double-loaded by a tag manager) in order to avoid errors."):1.1>(G.__SV||0)?z.j("Version mismatch; please ensure you're using the latest version of the Mixpanel code snippet."):(d.h(G._i,function(b){b&&d.isArray(b)&&(S[b[b.length-1]]=qa.apply(this,b))}),Qb(),G.init(),d.h(S,function(b){b.$a()}),Pb())})(function(a,b){var c=
