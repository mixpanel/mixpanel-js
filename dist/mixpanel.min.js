...
o.performance.now)b=o.performance.now();else for(b=0;a==1*new Date;)b++;return a.toString(16)+Math.floor(b).toString(16)}return function(){var c=(Z.height*Z.width).toString(16);return b()+"-"+Math.random().toString(16).replace(".","")+"-"+a()+"-"+c+"-"+b()}}();var ya="ahrefsbot,baiduspider,bingbot,bingpreview,chrome-lighthouse,facebookexternal,petalbot,pinterest,screaming frog,yahoo! slurp,yandexbot,adsbot-google,apis-google,duplexweb-google,feedfetcher-google,google favicon,google web preview,google-read-aloud,googlebot,googleweblight,mediapartners-google,storebot-google".split(",");
...
a&&(e=d.split("?")[0]!==b.split("?")[0]);e&&this.cb()&&(b=d)}.bind(this))}};e.prototype.mb=function(a,b){if(c.g(a))return q;if(O)return function(c){a(c,b)};var d=this._jsc,e=""+Math.floor(1E8*Math.random()),h=this.c("callback_fn")+"["+e+"]";d[e]=function(c){delete d[e];a(c,b)};return h};e.prototype.k=function(a,b,d,e){var h=m;if(ma)return this.ya.push(arguments),h;var g={method:this.c("api_method"),eb:this.c("api_transport"),jc:this.c("verbose")},j=q;if(!e&&(c.Ua(d)||"string"===typeof d))e=d,d=q;
d=c.extend(g,d||{});if(!O)d.method="GET";var g="POST"===d.method,i=ba&&g&&"sendbeacon"===d.eb.toLowerCase(),k=d.jc;b.verbose&&(k=m);this.c("test")&&(b.test=1);k&&(b.verbose=1);this.c("img")&&(b.img=1);if(!O)if(e)b.callback=e;else if(k||this.c("test"))b.callback="(function(){})";b.ip=this.c("ip")?1:0;b._=(new Date).getTime().toString();g&&(j="data="+encodeURIComponent(b.data),delete b.data);var a=a+("?"+c.kc(b)),n=this;if("img"in b)j=w.createElement("img"),j.src=a,w.body.appendChild(j);else if(i){try{h=
ba(a,j)}catch(o){n.l(o),h=D}try{e&&e(h?1:0)}catch(s){n.l(s)}}else if(O)try{var u=new XMLHttpRequest;u.open(d.method,a,m);var v=this.c("xhr_headers");g&&(v["Content-Type"]="application/x-www-form-urlencoded");c.a(v,function(a,b){u.setRequestHeader(b,a)});if(d.cc&&"undefined"!==typeof u.timeout){u.timeout=d.cc;var y=(new Date).getTime()}u.withCredentials=m;u.onreadystatechange=function(){if(4===u.readyState)if(200===u.status){if(e)if(k){var a;try{a=c.R(u.responseText)}catch(b){if(n.l(b),d.Gc)a=u.responseText;
else return}e(a)}else e(Number(u.responseText))}else a=u.timeout&&!u.status&&(new Date).getTime()-y>=u.timeout?"timeout":"Bad HTTP status: "+u.status+" "+u.statusText,n.l(a),e&&(k?e({status:0,error:a,Q:u}):e(0))};u.send(j)}catch(z){n.l(z),h=D}else j=w.createElement("script"),j.type="text/javascript",j.async=m,j.defer=m,j.src=a,v=w.getElementsByTagName("script")[0],v.parentNode.insertBefore(j,v);return h};e.prototype.za=function(a){function b(a,b){c.a(a,function(a){if(c.isArray(a[0])){var d=b;c.a(a,
function(a){d=d[a[0]].apply(d,a.slice(1))})}else this[a[0]].apply(this,a.slice(1))},b)}var d,e=[],h=[],g=[];c.a(a,function(a){a&&(d=a[0],c.isArray(d)?g.push(a):"function"===typeof a?a.call(this):c.isArray(a)&&"alias"===d?e.push(a):c.isArray(a)&&-1!==d.indexOf("track")&&"function"===typeof this[d]?g.push(a):h.push(a))},this);b(e,this);b(h,this);b(g,this)};e.prototype.qb=function(){return!!this.u.J};e.prototype.Bb=function(){var a="__mpq_"+this.c("token"),b=this.c("api_routes");return this.ib=this.ib||
{J:{type:"events",D:"/"+b.track,ba:a+"_ev"},Ya:{type:"people",D:"/"+b.engage,ba:a+"_pp"},Qa:{type:"groups",D:"/"+b.groups,ba:a+"_gr"}}};e.prototype.Hc=function(){if(!this.qb()){var a=c.bind(function(a){return new C(a.ba,{A:this.config,Xc:c.bind(function(b,c,e){this.k(this.c("api_host")+a.D,this.kb(b),c,this.mb(e,b))},this),ka:c.bind(function(b){return this.ob("before_send_"+a.type,b)},this),I:this.c("error_reporter"),gd:c.bind(this.ab,this)})},this),b=this.Bb();this.u={J:a(b.J),Ya:a(b.Ya),Qa:a(b.Qa)}}this.c("batch_autostart")&&
this.$a()};e.prototype.$a=function(){this.lc=m;if(this.qb())this.S=m,c.a(this.u,function(a){a.start()})};e.prototype.ab=function(){this.S=D;c.a(this.u,function(a){a.stop();a.clear()})};e.prototype.push=function(a){this.za([a])};e.prototype.disable=function(a){"undefined"===typeof a?this.T.yc=m:this.wa=this.wa.concat(a)};e.prototype.kb=function(a){a=c.ga(a);"base64"===this.c("api_payload_format")&&(a=c.vc(a));return{data:a}};e.prototype.Ea=function(a,b){var d=c.truncate(a.data,255),e=a.D,h=a.Ga,g=
a.ed,j=a.Yc||{},b=b||P,i=m,k=c.bind(function(){j.ac||(d=this.ob("before_send_"+a.type,d));return d?(s.log("MIXPANEL REQUEST:"),s.log(d),this.k(e,this.kb(d),j,this.mb(b,d))):q},this);this.S&&!g?h.Ma(d,function(a){a?b(1,d):k()}):i=k();return i&&d};e.prototype.o=M(function(a,b,d,e){!e&&"function"===typeof d&&(e=d,d=q);var d=d||{},h=d.transport;if(h)d.eb=h;h=d.send_immediately;"function"!==typeof e&&(e=P);if(c.g(a))this.l("No event name provided to mixpanel.track");else if(this.lb(a))e(0);else{b=c.extend({},
b);b.token=this.c("token");var g=this.persistence.Rc(a);c.g(g)||(b.$duration=parseFloat((((new Date).getTime()-g)/1E3).toFixed(3)));this.pb();g=this.c("track_marketing")?c.info.Lc():{};b=c.extend({},c.info.$({mp_loader:this.c("mp_loader")}),g,this.persistence.$(),this.O,b);g=this.c("property_blacklist");c.isArray(g)?c.a(g,function(a){delete b[a]}):this.l("Invalid value for property_blacklist config: "+g);return this.Ea({type:"events",data:{event:a,properties:b},D:this.c("api_host")+"/"+this.c("api_routes").track,
Ga:this.u.J,ed:h,Yc:d},e)}});e.prototype.cd=M(function(a,b,d){c.isArray(b)||(b=[b]);var e={};e[a]=b;this.m(e);return this.people.set(a,b,d)});e.prototype.sc=M(function(a,b,c){var e=this.s(a),h={};e===l?(h[a]=[b],this.m(h)):-1===e.indexOf(b)&&(e.push(b),h[a]=e,this.m(h));return this.people.fa(a,b,c)});e.prototype.Sc=M(function(a,b,c){var e=this.s(a);if(e!==l){var h=e.indexOf(b);-1<h&&(e.splice(h,1),this.m({yd:e}));0===e.length&&this.P(a)}return this.people.remove(a,b,c)});e.prototype.qd=M(function(a,
b,d,e){var h=c.extend({},b||{});c.a(d,function(a,b){a!==q&&a!==l&&(h[b]=a)});return this.o(a,h,e)});e.prototype.mc=function(a,b){return a+"_"+JSON.stringify(b)};e.prototype.Ec=function(a,b){var c=this.mc(a,b),e=this.jb[c];if(e===l||e.Ba!==a||e.Aa!==b)e=new v,e.W(this,a,b),this.jb[c]=e;return e};e.prototype.cb=M(function(a,b){"object"!==typeof a&&(a={});var b=b||{},d=b.event_name||"$mp_web_page_view",e=c.extend(c.info.Mc(),c.info.X(),c.info.tb()),e=c.extend({},e,a);return this.o(d,e)});e.prototype.pd=
function(){return this.Da.call(this,L,arguments)};e.prototype.od=function(){return this.Da.call(this,T,arguments)};e.prototype.jd=function(a){c.g(a)?this.l("No event name provided to mixpanel.time_event"):this.lb(a)||this.persistence.bd(a)};var Da={persistent:m};e.prototype.m=function(a,b){var d=da(b);d.persistent?this.persistence.m(a,d.days):c.extend(this.O,a)};e.prototype.w=function(a,b,d){d=da(d);d.persistent?this.persistence.w(a,b,d.days):("undefined"===typeof b&&(b="None"),c.a(a,function(a,c){if(!this.O.hasOwnProperty(c)||
this.O[c]===b)this.O[c]=a},this))};e.prototype.P=function(a,b){b=da(b);b.persistent?this.persistence.P(a):delete this.O[a]};e.prototype.nb=function(a,b){var c={};c[a]=b;this.m(c)};e.prototype.Ra=function(a,b,c,e,h,g,j,i){var k=this.K();if(a&&k!==a){if("string"===typeof a&&0===a.indexOf("$device:"))return this.l("distinct_id cannot have $device: prefix"),-1;this.m({$user_id:a})}this.s("$device_id")||this.w({$had_persisted_distinct_id:m,$device_id:k},"");a!==k&&a!==this.s("__alias")&&(this.P("__alias"),
...
if(a!==b)return this.nb("__alias",a),this.o("$create_alias",{alias:a,distinct_id:b},{ac:m},function(){d.Ra(a)});this.l("alias matches current distinct_id - skipping api call.");this.Ra(a);return-1};e.prototype.Nc=function(a){this.nb("mp_name_tag",a)};e.prototype.Yb=function(a){if(c.e(a))c.extend(this.config,a),a.batch_size&&c.a(this.u,function(a){a.Ub()}),this.c("persistence_name")||(this.config.persistence_name=this.config.cookie_name),this.c("disable_persistence")||(this.config.disable_persistence=
this.config.disable_cookie),this.persistence&&this.persistence.hc(this.config),J=J||this.c("debug")};e.prototype.c=function(a){return this.config[a]};e.prototype.ob=function(a){var b=(this.config.hooks[a]||Ea).apply(this,K.call(arguments,1));"undefined"===typeof b&&(this.l(a+" hook did not return a value"),b=q);return b};e.prototype.s=function(a){return this.persistence.sa([a])};e.prototype.toString=function(){var a=this.c("name");"mixpanel"!==a&&(a="mixpanel."+a);return a};e.prototype.lb=function(a){return c.Gb(A)||
this.T.yc||c.Sa(this.wa,a)};e.prototype.qc=function(){"localStorage"===this.c("opt_out_tracking_persistence_type")&&c.localStorage.ra()&&(!this.pa()&&this.pa({persistence_type:"cookie"})&&this.Kb({enable_persistence:D}),!this.Y()&&this.Y({persistence_type:"cookie"})&&this.Xa({clear_persistence:D}),this.sb({persistence_type:"cookie",enable_persistence:D}));if(this.Y())this.ha({clear_persistence:m});else if(!this.pa()&&(this.c("opt_out_tracking_by_default")||c.cookie.get("mp_optout")))c.cookie.remove("mp_optout"),
this.Xa({clear_persistence:this.c("opt_out_persistence_by_default")})};e.prototype.ha=function(a){if(a&&a.clear_persistence)a=m;else if(a&&a.enable_persistence)a=D;else return;!this.c("disable_persistence")&&this.persistence.disabled!==a&&this.persistence.Zb(a);a?this.ab():this.lc&&this.$a()};e.prototype.V=function(a,b){b=c.extend({track:c.bind(this.o,this),persistence_type:this.c("opt_out_tracking_persistence_type"),cookie_prefix:this.c("opt_out_tracking_cookie_prefix"),cookie_expiration:this.c("cookie_expiration"),
cross_site_cookie:this.c("cross_site_cookie"),cross_subdomain_cookie:this.c("cross_subdomain_cookie"),cookie_domain:this.c("cookie_domain"),secure_cookie:this.c("secure_cookie"),ignore_dnt:this.c("ignore_dnt")},b);c.localStorage.ra()||(b.persistence_type="cookie");return a(this.c("token"),{o:b.track,ld:b.track_event_name,md:b.track_properties,Ob:b.persistence_type,Nb:b.cookie_prefix,ub:b.cookie_domain,vb:b.cookie_expiration,xc:b.cross_site_cookie,wb:b.cross_subdomain_cookie,Vc:b.secure_cookie,Db:b.ignore_dnt})};
e.prototype.Kb=function(a){a=c.extend({enable_persistence:m},a);this.V(Ha,a);this.ha(a)};e.prototype.Xa=function(a){a=c.extend({clear_persistence:m,delete_user:m},a);a.delete_user&&this.people&&this.people.Ca()&&(this.people.zb(),this.people.rb());this.V(Ia,a);this.ha(a)};e.prototype.pa=function(a){return this.V(Ja,a)};e.prototype.Y=function(a){return this.V(ta,a)};e.prototype.sb=function(a){a=c.extend({enable_persistence:m},a);this.V(La,a);this.ha(a)};e.prototype.l=function(a,b){s.error.apply(s.error,
arguments);try{!b&&!(a instanceof Error)&&(a=Error(a)),this.c("error_reporter")(a,b)}catch(c){s.error(c)}};e.prototype.init=e.prototype.Ta;e.prototype.reset=e.prototype.reset;e.prototype.disable=e.prototype.disable;e.prototype.time_event=e.prototype.jd;e.prototype.track=e.prototype.o;e.prototype.track_links=e.prototype.pd;e.prototype.track_forms=e.prototype.od;e.prototype.track_pageview=e.prototype.cb;e.prototype.register=e.prototype.m;e.prototype.register_once=e.prototype.w;e.prototype.unregister=
e.prototype.P;e.prototype.identify=e.prototype.Ra;e.prototype.alias=e.prototype.tc;e.prototype.name_tag=e.prototype.Nc;e.prototype.set_config=e.prototype.Yb;e.prototype.get_config=e.prototype.c;e.prototype.get_property=e.prototype.s;e.prototype.get_distinct_id=e.prototype.K;e.prototype.toString=e.prototype.toString;e.prototype.opt_out_tracking=e.prototype.Xa;e.prototype.opt_in_tracking=e.prototype.Kb;e.prototype.has_opted_out_tracking=e.prototype.Y;e.prototype.has_opted_in_tracking=e.prototype.pa;
e.prototype.clear_opt_in_out_tracking=e.prototype.sb;e.prototype.get_group=e.prototype.Ec;e.prototype.set_group=e.prototype.cd;e.prototype.add_group=e.prototype.sc;e.prototype.remove_group=e.prototype.Sc;e.prototype.track_with_groups=e.prototype.qd;e.prototype.start_batch_senders=e.prototype.$a;e.prototype.stop_batch_senders=e.prototype.ab;e.prototype.DEFAULT_API_ROUTES=B;n.prototype.properties=n.prototype.$;n.prototype.update_search_keyword=n.prototype.ic;n.prototype.update_referrer_info=n.prototype.fb;
n.prototype.get_cross_subdomain=n.prototype.Dc;n.prototype.clear=n.prototype.clear;var F={};(function(){ca=1;y=o.mixpanel;c.g(y)?s.H('"mixpanel" object not initialized. Ensure you are using the latest version of the Mixpanel JS Library along with the snippet we provide.'):y.__loaded||y.config&&y.persistence?s.H("The Mixpanel library has already been downloaded at least once. Ensure that the Mixpanel code snippet only appears once on the page (and is not double-loaded by a tag manager) in order to avoid errors."):
