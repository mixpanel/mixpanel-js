...
$browser:d.info.cb(K,X.vendor,ya),$referrer:y.referrer,$referring_domain:d.info.Hd(y.referrer),$device:d.info.Yc(K)}),{$current_url:d.info.Z(),$browser_version:d.info.Kb(K,X.vendor,ya),$screen_height:Db.height,$screen_width:Db.width,mp_lib:"web",$lib_version:"2.75.0-rc2",$insert_id:Da(),time:d.timestamp()/1E3},d.wa(a))},zf:function(){return d.extend(d.wa({$os:d.info.Ad(),$browser:d.info.cb(K,X.vendor,ya)}),{$browser_version:d.info.Kb(K,X.vendor,ya)})},sf:function(){return d.wa({current_page_title:y.title,
...
var a=this.Ub("distinct_id"),b=this.Ub("$device_id"),c=bb();F.log("Fetching flags for distinct ID: "+a);a=d.extend({distinct_id:a,device_id:b},this.o("context"));b=new URLSearchParams;b.set("context",JSON.stringify(a));b.set("token",this.ma("token"));b.set("mp_lib","web");b.set("$lib_version","2.75.0-rc2");a=this.ib()+"?"+b.toString();this.zb=Date.now();return this.Sb=this.fetch.call(p,a,{method:"GET",headers:{Authorization:"Basic "+btoa(this.ma("token")+":"),traceparent:c}}).then(function(e){this.ic();
