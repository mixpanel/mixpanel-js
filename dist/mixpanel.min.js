...
else if("mixpanel"===c)m.error("You must initialize the main mixpanel object right after you include the Mixpanel js snippet");else return a=$(a,b,c),y[c]=a,a.Ka(),a};e.prototype.ma=function(a,b,c){this.__loaded=p;this.config={};this._triggered_notifs=[];var f={};if(!("batch_requests"in(b||{}))&&!("api_host"in(b||{}))&&ab(a,"batch",10))f.batch_requests=p;this.ad(d.extend({},db,f,b,{name:c,token:a,callback_fn:("mixpanel"===c?c:"mixpanel."+c)+"._jsc"}));this._jsc=N();this.jb=[];this.kb=[];this.ib=[];
this.$={disable_all_events:G,identify_called:G};this.H={};if(this.Ha=this.c("batch_requests"))!d.localStorage.Va(p)||!V?(this.Ha=G,m.log("Turning off Mixpanel request-queueing; needs XHR and localStorage support")):(this.Ve(),ka&&A.addEventListener&&A.addEventListener("unload",d.bind(function(){this.H.Db.flush({Ie:p})},this)));this.persistence=this.cookie=new q(this.config);this.Ed();a=d.Ub();this.U()||this.G({distinct_id:a,$device_id:a},"")};e.prototype.Ka=function(){this.c("loaded")(this);this.kc()};
e.prototype.kc=function(){this.persistence.md(t.referrer);this.c("store_google")&&this.persistence.ff();this.c("save_referrer")&&this.persistence.Tb(t.referrer)};e.prototype.zd=function(){d.a(this.jb,function(a){this.rb.apply(this,a)},this);this.ra()||d.a(this.kb,function(a){this.l.apply(this,a)},this);delete this.jb;delete this.kb};e.prototype.rb=function(a,b){if(this.c("img"))return m.error("You can't use DOM tracking functions with img = true."),G;if(!wa)return this.jb.push([a,b]),G;var c=(new a).da(this);
return c.p.apply(c,b)};e.prototype.La=function(a,b){if(d.g(a))return x;if(V)return function(c){a(c,b)};var c=this._jsc,f=""+Math.floor(1E8*Math.random()),e=this.c("callback_fn")+"["+f+"]";c[f]=function(d){delete c[f];a(d,b)};return e};e.prototype.l=function(a,b,c,f){var e=p;if(xa)return this.kb.push(arguments),e;var g={method:this.c("api_method"),za:this.c("api_transport"),od:this.c("verbose")},o=x;if(!f&&(d.Ua(c)||"string"===typeof c))f=c,c=x;c=d.extend(g,c||{});if(!V)c.method="GET";var g="POST"===
c.method,i=ka&&g&&"sendbeacon"===c.za.toLowerCase(),n=c.od;b.verbose&&(n=p);this.c("test")&&(b.test=1);n&&(b.verbose=1);this.c("img")&&(b.img=1);if(!V)if(f)b.callback=f;else if(n||this.c("test"))b.callback="(function(){})";b.ip=this.c("ip")?1:0;b._=(new Date).getTime().toString();g&&(o="data="+b.data,delete b.data);a+="?"+d.td(b);if("img"in b)o=t.createElement("img"),o.src=a,t.body.appendChild(o);else if(i)try{e=ka(a,o)}catch(q){m.error(q),e=G}else if(V)try{var r=new XMLHttpRequest;r.open(c.method,
a,p);var v=this.c("xhr_headers");g&&(v["Content-Type"]="application/x-www-form-urlencoded");d.a(v,function(a,b){r.setRequestHeader(b,a)});if(c.gd&&"undefined"!==typeof r.timeout){r.timeout=c.gd;var u=(new Date).getTime()}r.withCredentials=p;r.onreadystatechange=function(){if(4===r.readyState)if(200===r.status){if(f)if(n){var a;try{a=d.ia(r.responseText)}catch(b){if(m.error(b),c.re)a=r.responseText;else return}f(a)}else f(Number(r.responseText))}else a=r.timeout&&!r.status&&(new Date).getTime()-u>=
r.timeout?"timeout":"Bad HTTP status: "+r.status+" "+r.statusText,m.error(a),f&&(n?f({status:0,error:a,ha:r}):f(0))};r.send(o)}catch(w){m.error(w),e=G}else o=t.createElement("script"),o.type="text/javascript",o.async=p,o.defer=p,o.src=a,v=t.getElementsByTagName("script")[0],v.parentNode.insertBefore(o,v);return e};e.prototype.lb=function(a){function b(a,b){d.a(a,function(a){if(d.isArray(a[0])){var c=b;d.a(a,function(a){c=c[a[0]].apply(c,a.slice(1))})}else this[a[0]].apply(this,a.slice(1))},b)}var c,
f=[],e=[],g=[];d.a(a,function(a){a&&(c=a[0],d.isArray(c)?g.push(a):"function"===typeof a?a.call(this):d.isArray(a)&&"alias"===c?f.push(a):d.isArray(a)&&-1!==c.indexOf("track")&&"function"===typeof this[c]?g.push(a):e.push(a))},this);b(f,this);b(e,this);b(g,this)};e.prototype.Ve=function(){var a=this.c("token");if(!this.H.Db){var b={W:this.config,Ke:d.bind(function(a,b,d,e){this.l(this.c("api_host")+a,ya(b),d,this.La(e,b))},this)};this.H={Db:new F("__mpq_"+a+"_ev","/track/",b),ye:new F("__mpq_"+a+
"_pp","/engage/",b),qe:new F("__mpq_"+a+"_gr","/groups/",b)}}d.a(this.H,function(a){a.start()})};e.prototype.We=function(){this.Ha=G;d.a(this.H,function(a){a.stop();a.clear()})};e.prototype.push=function(a){this.lb([a])};e.prototype.disable=function(a){"undefined"===typeof a?this.$.ee=p:this.ib=this.ib.concat(a)};e.prototype.tb=function(a,b){var c=a.Sb,f=a.ca,e=a.vb,g=a.Se,o=a.Le||{},b=b||N(),i=p,n=d.bind(function(){m.log("MIXPANEL REQUEST:");m.log(c);return this.l(f,ya(c),o,this.La(b,c))},this);
this.Ha&&!g?e.Bb(c,function(a){a?b(1,c):n()}):i=n();return i&&c};e.prototype.p=P(function(a,b,c,f){!f&&"function"===typeof c&&(f=c,c=x);var c=c||{},e=c.transport;if(e)c.za=e;e=c.send_immediately;"function"!==typeof f&&(f=N());if(d.g(a))m.error("No event name provided to mixpanel.track");else if(this.$b(a))f(0);else{b=b||{};b.token=this.c("token");var g=this.persistence.Be(a);d.g(g)||(b.$duration=parseFloat((((new Date).getTime()-g)/1E3).toFixed(3)));this.kc();b=d.extend({},d.info.wa(),this.persistence.wa(),
b);g=this.c("property_blacklist");d.isArray(g)?d.a(g,function(a){delete b[a]}):m.error("Invalid value for property_blacklist config: "+g);a={event:a,properties:b};c=this.tb({Sb:d.truncate(a,255),ca:this.c("api_host")+"/track/",vb:this.H.Db,Se:e,Le:c},f);this.Xb(a);return c}});e.prototype.Qe=P(function(a,b,c){d.isArray(b)||(b=[b]);var f={};f[a]=b;this.w(f);return this.people.set(a,b,c)});e.prototype.Wd=P(function(a,b,c){var d=this.F(a);if(d===l){var e={};e[a]=[b];this.w(e)}else-1===d.indexOf(b)&&(d.push(b),
this.w(e));return this.people.Aa(a,b,c)});e.prototype.Ce=P(function(a,b,c){var d=this.F(a);if(d!==l){var e=d.indexOf(b);-1<e&&(d.splice(e,1),this.w({qf:d}));0===d.length&&this.Ba(a)}return this.people.remove(a,b,c)});e.prototype.ef=P(function(a,b,c,f){var e=d.extend({},b||{});d.a(c,function(a,b){a!==x&&a!==l&&(e[b]=a)});return this.p(a,e,f)});e.prototype.yd=function(a,b){return a+"_"+JSON.stringify(b)};e.prototype.oe=function(a,b){var c=this.yd(a,b),d=this.Vb[c];if(d===l||d.ob!==a||d.nb!==b)d=new u,
...
function(a){this.persistence.Ba(a)};e.prototype.hc=function(a,b){var c={};c[a]=b;this.w(c)};e.prototype.Gb=function(a,b,c,d,e,g,m,i){var n=this.U();this.w({$user_id:a});this.F("$device_id")||this.G({$had_persisted_distinct_id:p,$device_id:n},"");a!==n&&a!==this.F("__alias")&&(this.Ba("__alias"),this.w({distinct_id:a}));this.Wb(this.U());this.$.Hb=p;this.people.Dd(b,c,d,e,g,m,i);a!==n&&this.p("$identify",{distinct_id:a,$anon_distinct_id:n})};e.prototype.reset=function(){this.persistence.clear();this.$.Hb=
G;var a=d.Ub();this.G({distinct_id:a,$device_id:a},"")};e.prototype.U=function(){return this.F("distinct_id")};e.prototype.Xd=function(a,b){if(a===this.F("$people_distinct_id"))return m.P("Attempting to create alias for existing People user - aborting."),-2;var c=this;d.g(b)&&(b=this.U());if(a!==b)return this.hc("__alias",a),this.p("$create_alias",{alias:a,distinct_id:b},function(){c.Gb(a)});m.error("alias matches current distinct_id - skipping api call.");this.Gb(a);return-1};e.prototype.ve=function(a){this.hc("mp_name_tag",
a)};e.prototype.ad=function(a){if(d.e(a))d.extend(this.config,a),a.batch_size&&d.a(this.H,function(a){a.Wc()}),this.c("persistence_name")||(this.config.persistence_name=this.config.cookie_name),this.c("disable_persistence")||(this.config.disable_persistence=this.config.disable_cookie),this.persistence&&this.persistence.ld(this.config),K=K||this.c("debug")};e.prototype.c=function(a){return this.config[a]};e.prototype.F=function(a){return this.persistence.props[a]};e.prototype.toString=function(){var a=
this.c("name");"mixpanel"!==a&&(a="mixpanel."+a);return a};e.prototype.$b=function(a){return d.Hc(z)||this.$.ee||d.Ec(this.ib,a)};e.prototype.Xb=P(function(a){if(this.lc)for(var b=this._triggered_notifs,c=0;c<b.length;c++){if((new g(b[c],this)).Od(a)){this.qb(b[c]);break}}else this.ac.push(a)});e.prototype.Wb=P(function(a){a&&!this.$.Hb&&!this.c("disable_notifications")&&(m.log("MIXPANEL NOTIFICATION CHECK"),this.l(this.c("api_host")+"/decide/",{verbose:p,version:"3",lib:"web",token:this.c("token"),
distinct_id:a},{method:"GET",za:"XHR"},this.La(d.bind(function(a){if(a.notifications&&0<a.notifications.length){this._triggered_notifs=[];var c=[];d.a(a.notifications,function(a){(a.display_triggers&&0<a.display_triggers.length?this._triggered_notifs:c).push(a)},this);0<c.length&&this.qb.call(this,c[0])}this.dc()},this))))});e.prototype.dc=function(){this.lc=p;for(var a=this.ac;0<a.length;)this.Xb(a.shift())};e.prototype.qb=function(a){(new g(a,this)).show()};e.prototype.Ed=function(){"localStorage"===
this.c("opt_out_tracking_persistence_type")&&d.localStorage.Va()&&(!this.Sa()&&this.Sa({persistence_type:"cookie"})&&this.Oc({enable_persistence:G}),!this.ra()&&this.ra({persistence_type:"cookie"})&&this.Kb({clear_persistence:G}),this.sc({persistence_type:"cookie",enable_persistence:G}));if(this.ra())this.Ia({clear_persistence:p});else if(!this.Sa()&&(this.c("opt_out_tracking_by_default")||d.cookie.get("mp_optout")))d.cookie.remove("mp_optout"),this.Kb({clear_persistence:this.c("opt_out_persistence_by_default")})};
e.prototype.Ia=function(a){if(a&&a.clear_persistence)a=p;else if(a&&a.enable_persistence)a=G;else return;!this.c("disable_persistence")&&this.persistence.disabled!==a&&this.persistence.bd(a);a&&d.a(this.H,function(a){a.clear()})};e.prototype.la=function(a,b){b=d.extend({track:d.bind(this.p,this),persistence_type:this.c("opt_out_tracking_persistence_type"),cookie_prefix:this.c("opt_out_tracking_cookie_prefix"),cookie_expiration:this.c("cookie_expiration"),cross_site_cookie:this.c("cross_site_cookie"),
cross_subdomain_cookie:this.c("cross_subdomain_cookie"),cookie_domain:this.c("cookie_domain"),secure_cookie:this.c("secure_cookie"),ignore_dnt:this.c("ignore_dnt")},b);d.localStorage.Va()||(b.persistence_type="cookie");return a(this.c("token"),{p:b.track,Ze:b.track_event_name,$e:b.track_properties,Rc:b.persistence_type,Qc:b.cookie_prefix,tc:b.cookie_domain,uc:b.cookie_expiration,ce:b.cross_site_cookie,vc:b.cross_subdomain_cookie,He:b.secure_cookie,Cc:b.ignore_dnt})};e.prototype.Oc=function(a){a=d.extend({enable_persistence:p},
a);this.la(Oa,a);this.Ia(a)};e.prototype.Kb=function(a){a=d.extend({clear_persistence:p,delete_user:p},a);a.delete_user&&this.people&&this.people.pb()&&(this.people.yc(),this.people.rc());this.la(Pa,a);this.Ia(a)};e.prototype.Sa=function(a){return this.la(Qa,a)};e.prototype.ra=function(a){return this.la(Da,a)};e.prototype.sc=function(a){a=d.extend({enable_persistence:p},a);this.la(Sa,a);this.Ia(a)};e.prototype.init=e.prototype.da;e.prototype.reset=e.prototype.reset;e.prototype.disable=e.prototype.disable;
