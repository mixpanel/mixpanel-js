...
if(b){b.event&&b.properties&&(b.properties=c.extend({},b.properties,{mp_sent_by_lib_version:"2.60.0-rc1"}));var d=i,e=a.id;if(e){if(5<(this.P[e]||0))this.h("[dupe] item ID sent too many times, not sending",{item:a,L:f.length,ge:this.P[e]}),d=C}else this.h("[dupe] found item with no ID",{item:a});d&&j.push(b)}p[a.id]=b},this);if(1>j.length)return this.ob=C,this.T(),y.resolve();var l=c.bind(function(){return this.ka.Kd(c.map(f,function(a){return a.id})).then(c.bind(function(a){c.a(f,c.bind(function(a){var b=
