...
c.info.Y(r),g={},v=D;c.a(a,function(a,b){(g["initial_"+b]=a)&&(v=m)});v&&f.people.M(g)}J=J||f.c("debug");!c.g(h)&&c.isArray(h)&&(f.Aa.call(f.people,h.people),f.Aa(h));return f}function e(){}function P(){}function Ea(a){return a}function q(a){this.props={};this.Ad=D;this.name=a.persistence_name?"mp_"+a.persistence_name:"mp_"+a.token+"_mixpanel";var b=a.persistence;if("cookie"!==b&&"localStorage"!==b)o.A("Unknown persistence type "+b+"; falling back to cookie"),b=a.persistence="cookie";this.i="localStorage"===
b&&c.localStorage.sa()?c.localStorage:c.cookie;this.load();this.kc(a);this.wd(a);this.save()}function j(){}function u(){}function C(a,b){this.J=b.J;this.ba=new G(a,{J:c.bind(this.h,this),i:b.i});this.B=b.B;this.Zc=b.$c;this.la=b.la;this.jd=b.kd;this.F=this.B.batch_size;this.pa=this.B.batch_flush_interval_ms;this.va=!this.B.batch_autostart;this.Ja=0;this.H={}}function na(a,b){var d=[];c.a(a,function(a){var c=a.id;if(c in b){if(c=b[c],c!==r)a.payload=c,d.push(a)}else d.push(a)});return d}function oa(a,
b){var d=[];c.a(a,function(a){a.id&&!b[a.id]&&d.push(a)});return d}function G(a,b){b=b||{};this.N=a;this.i=b.i||window.localStorage;this.h=b.J||c.bind(pa.error,pa);this.Xa=new qa(a,{i:this.i});this.ua=b.ua||r;this.I=[]}function qa(a,b){b=b||{};this.N=a;this.i=b.i||window.localStorage;this.Rb=b.Rb||100;this.ec=b.ec||2E3}function T(){this.Ob="submit"}function M(){this.Ob="click"}function E(){}function ra(a){var b=Fa,d=a.split("."),d=d[d.length-1];if(4<d.length||"com"===d||"org"===d)b=Ga;return(a=a.match(b))?
...
function K(a){return ia(a,function(a){return this.c(a)})}function H(a){return ia(a,function(a){return this.p(a)})}function N(a){return ia(a,function(a){return this.p(a)})}function La(a,b){b=b||{};V(b).remove(W(a,b),!!b.xb,b.vb)}function V(a){a=a||{};return"localStorage"===a.Qb?c.localStorage:c.cookie}function W(a,b){b=b||{};return(b.Pb||Ma)+a}function Ka(a){if(a&&a.Fb)return D;var a=a&&a.window||n,b=a.navigator||{},d=D;c.a([b.doNotTrack,b.msDoNotTrack,a.doNotTrack],function(a){c.j([m,1,"1","yes"],
...
aa:function(a){"object"!==typeof a&&(a={});return c.extend(c.fa({$os:c.info.Nb(),$browser:c.info.ma(z,I.vendor,Y),$referrer:t.referrer,$referring_domain:c.info.Sb(t.referrer),$device:c.info.Bb(z)}),{$current_url:c.info.La(),$browser_version:c.info.Ia(z,I.vendor,Y),$screen_height:Z.height,$screen_width:Z.width,mp_lib:"web",$lib_version:"2.50.0",$insert_id:ea(),time:c.timestamp()/1E3},c.fa(a))},Sc:function(){return c.extend(c.fa({$os:c.info.Nb(),$browser:c.info.ma(z,I.vendor,Y)}),{$browser_version:c.info.Ia(z,
...
this.i.parse(this.name);a&&(this.props=c.extend({},a))}};q.prototype.wd=function(a){var b=a.upgrade,d;if(b)d="mp_super_properties","string"===typeof b&&(d=b),b=this.i.parse(d),this.i.remove(d),this.i.remove(d,m),b&&(this.props=c.extend(this.props,b.all,b.events));if(!a.cookie_name&&"mixpanel"!==a.name&&(d="mp_"+a.token+"_"+a.name,b=this.i.parse(d)))this.i.remove(d),this.i.remove(d,m),this.w(b);this.i===c.localStorage&&(b=c.cookie.parse(this.name),c.cookie.remove(this.name),c.cookie.remove(this.name,
m),b&&this.w(b))};q.prototype.save=function(){this.disabled||this.i.set(this.name,c.ha(this.props),this.Pa,this.Ka,this.Yb,this.yb,this.na)};q.prototype.ta=function(a){this.load();return this.props[a]};q.prototype.remove=function(){this.i.remove(this.name,D,this.na);this.i.remove(this.name,m,this.na)};q.prototype.clear=function(){this.remove();this.props={}};q.prototype.w=function(a,b,d){return c.e(a)?("undefined"===typeof b&&(b="None"),this.Pa="undefined"===typeof d?this.zb:d,this.load(),c.a(a,function(a,
c){if(!this.props.hasOwnProperty(c)||this.props[c]===b)this.props[c]=a},this),this.save(),m):D};q.prototype.m=function(a,b){return c.e(a)?(this.Pa="undefined"===typeof b?this.zb:b,this.load(),c.extend(this.props,a),this.save(),m):D};q.prototype.Q=function(a){this.load();a in this.props&&(delete this.props[a],this.save())};q.prototype.lc=function(a){this.m(c.info.Xc(a))};q.prototype.gb=function(a){this.w({$initial_referrer:a||"$direct",$initial_referring_domain:c.info.Sb(a)||"$direct"},"")};q.prototype.Ic=
function(){return c.fa({$initial_referrer:this.props.$initial_referrer,$initial_referring_domain:this.props.$initial_referring_domain})};q.prototype.kc=function(a){this.zb=this.Pa=a.cookie_expiration;this.ac(a.disable_persistence);this.bd(a.cookie_domain);this.cd(a.cross_site_cookie);this.dd(a.cross_subdomain_cookie);this.gd(a.secure_cookie)};q.prototype.ac=function(a){(this.disabled=a)?this.remove():this.save()};q.prototype.bd=function(a){if(a!==this.na)this.remove(),this.na=a,this.save()};q.prototype.cd=
function(a){if(a!==this.yb)this.yb=a,this.remove(),this.save()};q.prototype.dd=function(a){if(a!==this.Ka)this.Ka=a,this.remove(),this.save()};q.prototype.Gc=function(){return this.Ka};q.prototype.gd=function(a){if(a!==this.Yb)this.Yb=a?m:D,this.remove(),this.save()};q.prototype.q=function(a,b){var d=this.ja(a),f=b[a],e=this.C("$set"),g=this.C("$set_once"),j=this.C("$unset"),i=this.C("$add"),k=this.C("$union"),p=this.C("$remove",[]),n=this.C("$append",[]);"__mps"===d?(c.extend(e,f),this.v("$add",
...
else return a=S(a,b,d),x[d]=a,a.ka(),a};e.prototype.X=function(a,b,d){b=b||{};this.__loaded=m;this.config={};var e={};"api_payload_format"in b||(b.api_host||za.api_host).match(/\.mixpanel\.com/)&&(e.api_payload_format="json");this.$b(c.extend({},za,e,b,{name:d,token:a,callback_fn:("mixpanel"===d?d:"mixpanel."+d)+"._jsc"}));this._jsc=P;this.ya=[];this.za=[];this.xa=[];this.U={disable_all_events:D,identify_called:D};this.u={};if(this.T=this.c("batch_requests"))if(!c.localStorage.sa(m)||!O)this.T=D,
o.log("Turning off Mixpanel request-queueing; needs XHR and localStorage support"),c.a(this.Cb(),function(a){o.log("Clearing batch queue "+a.ca);c.localStorage.remove(a.ca)});else if(this.Kc(),ba&&n.addEventListener){var h=c.bind(function(){this.u.K.va||this.u.K.flush({ic:m})},this);n.addEventListener("pagehide",function(a){a.persisted&&h()});n.addEventListener("visibilitychange",function(){"hidden"===t.visibilityState&&h()})}this.persistence=this.cookie=new q(this.config);this.P={};this.tc();a=c.ib();
this.L()||this.w({distinct_id:"$device:"+a,$device_id:a},"");(a=this.c("track_pageview"))&&this.uc(a);0<this.c("record_sessions_percent")&&100*Math.random()<=this.c("record_sessions_percent")&&this.dc()};e.prototype.dc=K(function(){if(n.MutationObserver){var a=c.bind(function(){this.D=this.D||new n.__mp_recorder(this);this.D.startRecording()},this);if(c.g(n.__mp_recorder)){var b=t.createElement("script");b.type="text/javascript";b.async=m;b.onload=a;b.src=this.c("recorder_src");t.head.appendChild(b)}else a()}else o.A("Browser does not support MutationObserver; skipping session recording")});
e.prototype.ld=function(){this.D?this.D.stopRecording():o.A("Session recorder module not loaded")};e.prototype.Db=function(){var a={};this.D&&this.D.replayId&&(a.$mp_replay_id=this.D.replayId);return a};e.prototype.ka=function(){this.c("loaded")(this);this.qb();this.people.M(this.persistence.Ic());if(this.c("store_google")&&this.c("stop_utm_persistence")){var a=c.info.Y(r);c.a(a,function(a,c){this.Q(c)}.bind(this))}};e.prototype.qb=function(){this.persistence.lc(t.referrer);this.c("store_google")&&
!this.c("stop_utm_persistence")&&this.m(c.info.Y());this.c("save_referrer")&&this.persistence.gb(t.referrer)};e.prototype.qc=function(){c.a(this.ya,function(a){this.Ea.apply(this,a)},this);this.Z()||c.a(this.za,function(a){this.k.apply(this,a)},this);delete this.ya;delete this.za};e.prototype.Ea=function(a,b){if(this.c("img"))return this.l("You can't use DOM tracking functions with img = true."),D;if(!la)return this.ya.push([a,b]),D;var c=(new a).Ua(this);return c.o.apply(c,b)};e.prototype.uc=function(a){var b=
"";this.eb()&&(b=c.info.La());if(c.Ta(["full-url","url-with-path-and-query-string","url-with-path"],a)){n.addEventListener("popstate",function(){n.dispatchEvent(new Event("mp_locationchange"))});n.addEventListener("hashchange",function(){n.dispatchEvent(new Event("mp_locationchange"))});var d=n.history.pushState;if("function"===typeof d)n.history.pushState=function(a,b,c){d.call(n.history,a,b,c);n.dispatchEvent(new Event("mp_locationchange"))};var e=n.history.replaceState;if("function"===typeof e)n.history.replaceState=
function(a,b,c){e.call(n.history,a,b,c);n.dispatchEvent(new Event("mp_locationchange"))};n.addEventListener("mp_locationchange",function(){var d=c.info.La(),e=D;"full-url"===a?e=d!==b:"url-with-path-and-query-string"===a?e=d.split("#")[0]!==b.split("#")[0]:"url-with-path"===a&&(e=d.split("#")[0].split("?")[0]!==b.split("#")[0].split("?")[0]);e&&this.eb()&&(b=d)}.bind(this))}};e.prototype.nb=function(a,b){if(c.g(a))return r;if(O)return function(c){a(c,b)};var d=this._jsc,e=""+Math.floor(1E8*Math.random()),
h=this.c("callback_fn")+"["+e+"]";d[e]=function(c){delete d[e];a(c,b)};return h};e.prototype.k=function(a,b,d,e){var h=m;if(ma)return this.za.push(arguments),h;var g={method:this.c("api_method"),fb:this.c("api_transport"),mc:this.c("verbose")},j=r;if(!e&&(c.Va(d)||"string"===typeof d))e=d,d=r;d=c.extend(g,d||{});if(!O)d.method="GET";var g="POST"===d.method,i=ba&&g&&"sendbeacon"===d.fb.toLowerCase(),k=d.mc;b.verbose&&(k=m);this.c("test")&&(b.test=1);k&&(b.verbose=1);this.c("img")&&(b.img=1);if(!O)if(e)b.callback=
e;else if(k||this.c("test"))b.callback="(function(){})";b.ip=this.c("ip")?1:0;b._=(new Date).getTime().toString();g&&(j="data="+encodeURIComponent(b.data),delete b.data);var a=a+("?"+c.nc(b)),p=this;if("img"in b)j=t.createElement("img"),j.src=a,t.body.appendChild(j);else if(i){try{h=ba(a,j)}catch(n){p.l(n),h=D}try{e&&e(h?1:0)}catch(q){p.l(q)}}else if(O)try{var o=new XMLHttpRequest;o.open(d.method,a,m);var u=this.c("xhr_headers");g&&(u["Content-Type"]="application/x-www-form-urlencoded");c.a(u,function(a,
b){o.setRequestHeader(b,a)});if(d.fc&&"undefined"!==typeof o.timeout){o.timeout=d.fc;var x=(new Date).getTime()}o.withCredentials=m;o.onreadystatechange=function(){if(4===o.readyState)if(200===o.status){if(e)if(k){var a;try{a=c.S(o.responseText)}catch(b){if(p.l(b),d.Jc)a=o.responseText;else return}e(a)}else e(Number(o.responseText))}else a=o.timeout&&!o.status&&(new Date).getTime()-x>=o.timeout?"timeout":"Bad HTTP status: "+o.status+" "+o.statusText,p.l(a),e&&(k?e({status:0,error:a,R:o}):e(0))};o.send(j)}catch(y){p.l(y),
h=D}else j=t.createElement("script"),j.type="text/javascript",j.async=m,j.defer=m,j.src=a,u=t.getElementsByTagName("script")[0],u.parentNode.insertBefore(j,u);return h};e.prototype.Aa=function(a){function b(a,b){c.a(a,function(a){if(c.isArray(a[0])){var d=b;c.a(a,function(a){d=d[a[0]].apply(d,a.slice(1))})}else this[a[0]].apply(this,a.slice(1))},b)}var d,e=[],h=[],g=[];c.a(a,function(a){a&&(d=a[0],c.isArray(d)?g.push(a):"function"===typeof a?a.call(this):c.isArray(a)&&"alias"===d?e.push(a):c.isArray(a)&&
-1!==d.indexOf("track")&&"function"===typeof this[d]?g.push(a):h.push(a))},this);b(e,this);b(h,this);b(g,this)};e.prototype.rb=function(){return!!this.u.K};e.prototype.Cb=function(){var a="__mpq_"+this.c("token"),b=this.c("api_routes");return this.jb=this.jb||{K:{type:"events",G:"/"+b.track,ca:a+"_ev"},Za:{type:"people",G:"/"+b.engage,ca:a+"_pp"},Ra:{type:"groups",G:"/"+b.groups,ca:a+"_gr"}}};e.prototype.Kc=function(){if(!this.rb()){var a=c.bind(function(a){return new C(a.ca,{B:this.config,$c:c.bind(function(b,
c,e){this.k(this.c("api_host")+a.G,this.lb(b),c,this.nb(e,b))},this),la:c.bind(function(b){return this.pb("before_send_"+a.type,b)},this),J:this.c("error_reporter"),kd:c.bind(this.bb,this)})},this),b=this.Cb();this.u={K:a(b.K),Za:a(b.Za),Ra:a(b.Ra)}}this.c("batch_autostart")&&this.ab()};e.prototype.ab=function(){this.oc=m;if(this.rb())this.T=m,c.a(this.u,function(a){a.start()})};e.prototype.bb=function(){this.T=D;c.a(this.u,function(a){a.stop();a.clear()})};e.prototype.push=function(a){this.Aa([a])};
e.prototype.disable=function(a){"undefined"===typeof a?this.U.Bc=m:this.xa=this.xa.concat(a)};e.prototype.lb=function(a){a=c.ha(a);"base64"===this.c("api_payload_format")&&(a=c.yc(a));return{data:a}};e.prototype.Fa=function(a,b){var d=c.truncate(a.data,255),e=a.G,h=a.Ha,g=a.hd,j=a.ad||{},b=b||P,i=m,k=c.bind(function(){j.cc||(d=this.pb("before_send_"+a.type,d));return d?(o.log("MIXPANEL REQUEST:"),o.log(d),this.k(e,this.lb(d),j,this.nb(b,d))):r},this);this.T&&!g?h.Na(d,function(a){a?b(1,d):k()}):i=
k();return i&&d};e.prototype.o=K(function(a,b,d,e){!e&&"function"===typeof d&&(e=d,d=r);var d=d||{},h=d.transport;if(h)d.fb=h;h=d.send_immediately;"function"!==typeof e&&(e=P);if(c.g(a))this.l("No event name provided to mixpanel.track");else if(this.mb(a))e(0);else{b=c.extend({},b);b.token=this.c("token");var g=this.persistence.Uc(a);c.g(g)||(b.$duration=parseFloat((((new Date).getTime()-g)/1E3).toFixed(3)));this.qb();g=this.c("track_marketing")?c.info.Oc():{};b=c.extend({},c.info.aa({mp_loader:this.c("mp_loader")}),
g,this.persistence.aa(),this.P,this.Db(),b);g=this.c("property_blacklist");c.isArray(g)?c.a(g,function(a){delete b[a]}):this.l("Invalid value for property_blacklist config: "+g);return this.Fa({type:"events",data:{event:a,properties:b},G:this.c("api_host")+"/"+this.c("api_routes").track,Ha:this.u.K,hd:h,ad:d},e)}});e.prototype.fd=K(function(a,b,d){c.isArray(b)||(b=[b]);var e={};e[a]=b;this.m(e);return this.people.set(a,b,d)});e.prototype.vc=K(function(a,b,c){var e=this.s(a),h={};e===l?(h[a]=[b],this.m(h)):
-1===e.indexOf(b)&&(e.push(b),h[a]=e,this.m(h));return this.people.ga(a,b,c)});e.prototype.Vc=K(function(a,b,c){var e=this.s(a);if(e!==l){var h=e.indexOf(b);-1<h&&(e.splice(h,1),this.m({Cd:e}));0===e.length&&this.Q(a)}return this.people.remove(a,b,c)});e.prototype.ud=K(function(a,b,d,e){var h=c.extend({},b||{});c.a(d,function(a,b){a!==r&&a!==l&&(h[b]=a)});return this.o(a,h,e)});e.prototype.pc=function(a,b){return a+"_"+JSON.stringify(b)};e.prototype.Hc=function(a,b){var c=this.pc(a,b),e=this.kb[c];
...
L.call(arguments,1));"undefined"===typeof b&&(this.l(a+" hook did not return a value"),b=r);return b};e.prototype.s=function(a){return this.persistence.ta([a])};e.prototype.toString=function(){var a=this.c("name");"mixpanel"!==a&&(a="mixpanel."+a);return a};e.prototype.mb=function(a){return c.Ib(z)||this.U.Bc||c.Ta(this.xa,a)};e.prototype.tc=function(){"localStorage"===this.c("opt_out_tracking_persistence_type")&&c.localStorage.sa()&&(!this.qa()&&this.qa({persistence_type:"cookie"})&&this.Mb({enable_persistence:D}),
...
this.persistence.disabled!==a&&this.persistence.ac(a);a?this.bb():this.oc&&this.ab()};e.prototype.W=function(a,b){b=c.extend({track:c.bind(this.o,this),persistence_type:this.c("opt_out_tracking_persistence_type"),cookie_prefix:this.c("opt_out_tracking_cookie_prefix"),cookie_expiration:this.c("cookie_expiration"),cross_site_cookie:this.c("cross_site_cookie"),cross_subdomain_cookie:this.c("cross_subdomain_cookie"),cookie_domain:this.c("cookie_domain"),secure_cookie:this.c("secure_cookie"),ignore_dnt:this.c("ignore_dnt")},
b);c.localStorage.sa()||(b.persistence_type="cookie");return a(this.c("token"),{o:b.track,pd:b.track_event_name,qd:b.track_properties,Qb:b.persistence_type,Pb:b.cookie_prefix,vb:b.cookie_domain,wb:b.cookie_expiration,Ac:b.cross_site_cookie,xb:b.cross_subdomain_cookie,Yc:b.secure_cookie,Fb:b.ignore_dnt})};e.prototype.Mb=function(a){a=c.extend({enable_persistence:m},a);this.W(Ha,a);this.ia(a)};e.prototype.Ya=function(a){a=c.extend({clear_persistence:m,delete_user:m},a);a.delete_user&&this.people&&this.people.Da()&&
