...
b=a.persistence="cookie";this.j="localStorage"===b&&c.localStorage.sa()?c.localStorage:c.cookie;this.load();this.nc(a);this.zd();this.save()}function j(){}function u(){}function C(a,b){this.K=b.K;this.ca=new G(a,{K:c.bind(this.h,this),j:b.j,z:b.z});this.C=b.C;this.bd=b.cd;this.la=b.la;this.md=b.nd;this.G=this.C.batch_size;this.pa=this.C.batch_flush_interval_ms;this.va=!this.C.batch_autostart;this.Ja=0;this.I={};this.Db=b.Db||D}function oa(a,b){var d=[];c.a(a,function(a){var c=a.id;if(c in b){if(c=
b[c],c!==r)a.payload=c,d.push(a)}else d.push(a)});return d}function pa(a,b){var d=[];c.a(a,function(a){a.id&&!b[a.id]&&d.push(a)});return d}function G(a,b){b=b||{};this.P=a;this.j=b.j||window.localStorage;this.h=b.K||c.bind(qa.error,qa);this.Ya=new ra(a,{j:this.j});this.z=b.z;this.ua=b.ua||r;this.D=[]}function ra(a,b){b=b||{};this.P=a;this.j=b.j||window.localStorage;this.Tb=b.Tb||100;this.hc=b.hc||2E3}function T(){this.Qb="submit"}function M(){this.Qb="click"}function E(){}function sa(a){var b=Ga,
...
ba:function(a){"object"!==typeof a&&(a={});return c.extend(c.fa({$os:c.info.Pb(),$browser:c.info.ma(z,I.vendor,Y),$referrer:v.referrer,$referring_domain:c.info.Ub(v.referrer),$device:c.info.Cb(z)}),{$current_url:c.info.La(),$browser_version:c.info.Ia(z,I.vendor,Y),$screen_height:Z.height,$screen_width:Z.width,mp_lib:"web",$lib_version:"2.54.0-rc1",$insert_id:ea(),time:c.timestamp()/1E3},c.fa(a))},Vc:function(){return c.extend(c.fa({$os:c.info.Pb(),$browser:c.info.ma(z,I.vendor,Y)}),{$browser_version:c.info.Ia(z,
I.vendor,Y)})},Sc:function(){return c.fa({current_page_title:v.title,current_domain:o.location.hostname,current_url_path:o.location.pathname,current_url_protocol:o.location.protocol,current_url_search:o.location.search})}};var Ha=/[a-z0-9][a-z0-9-]*\.[a-z]+$/i,Ga=/[a-z0-9][a-z0-9-]+\.[a-z.]{2,6}$/i,$=r,aa=r;if("undefined"!==typeof JSON)$=JSON.stringify,aa=JSON.parse;$=$||c.ha;aa=aa||c.T;c.toArray=c.Q;c.isObject=c.e;c.JSONEncode=c.ha;c.JSONDecode=c.T;c.isBlockedUA=c.Kb;c.isEmptyObject=c.ra;c.info=
...
g,c,m),e);h.Mb.o(b,g,h.jc(f,g,c))})},this),m};E.prototype.jc=function(a,b,c,f){var f=f||D,h=this;return function(){if(!c.Cc)c.Cc=m,a&&a(f,b)===D||h.Ga(b,c,f)}};E.prototype.oa=function(a,b){return"function"===typeof a?a(b):c.extend({},a)};c.Jb(M,E);M.prototype.oa=function(a,b){var c=M.pd.oa.apply(this,arguments);if(b.href)c.url=b.href;return c};M.prototype.Oa=function(a,b,c){c.Nb=2===a.which||a.metaKey||a.ctrlKey||"_blank"===b.target;c.href=b.href;c.Nb||a.preventDefault()};M.prototype.Ga=function(a,
...
d);f&&(a.$user_id=f);e&&(a.$had_persisted_distinct_id=e);d=c.Ma(a);return!this.Da()?(this.uc(a),c.g(b)||(this.p("verbose")?b({status:-1,error:r}):b(-1)),c.truncate(d,255)):this.d.Fa({type:"people",data:d,H:this.p("api_host")+"/"+this.p("api_routes").engage,Ha:this.d.u.$a},b)};j.prototype.p=function(a){return this.d.c(a)};j.prototype.Da=function(){return this.d.V.Gb===m};j.prototype.uc=function(a){"$set"in a?this.d.persistence.q("$set",a):"$set_once"in a?this.d.persistence.q("$set_once",a):"$unset"in
a?this.d.persistence.q("$unset",a):"$add"in a?this.d.persistence.q("$add",a):"$append"in a?this.d.persistence.q("$append",a):"$remove"in a?this.d.persistence.q("$remove",a):"$union"in a?this.d.persistence.q("$union",a):n.error("Invalid call to _enqueue():",a)};j.prototype.W=function(a,b,d,f){var e=this,g=c.extend({},this.d.persistence.aa(a)),j=g;!c.g(g)&&c.e(g)&&!c.ra(g)&&(e.d.persistence.v(a,g),e.d.persistence.save(),f&&(j=f(g)),b.call(e,j,function(b,f){0===b&&e.d.persistence.q(a,g);c.g(d)||d(b,
f)}))};j.prototype.vc=function(a,b,d,f,e,g,j){var i=this;this.W("$set",this.set,a);this.W("$set_once",this.O,f);this.W("$unset",this.wa,g,function(a){return c.keys(a)});this.W("$add",this.Ib,b);this.W("$union",this.ga,e);a=this.d.persistence.aa("$append");if(!c.g(a)&&c.isArray(a)&&a.length)for(var k,b=function(a,b){0===a&&i.d.persistence.q("$append",k);c.g(d)||d(a,b)},f=a.length-1;0<=f;f--)a=this.d.persistence.aa("$append"),k=a.pop(),i.d.persistence.save(),c.ra(k)||i.append(k,b);a=this.d.persistence.aa("$remove");
if(!c.g(a)&&c.isArray(a)&&a.length)for(var p,b=function(a,b){0===a&&i.d.persistence.q("$remove",p);c.g(j)||j(a,b)},f=a.length-1;0<=f;f--)a=this.d.persistence.aa("$remove"),p=a.pop(),i.d.persistence.save(),c.ra(p)||i.remove(p,b)};j.prototype.A=function(a){return"$distinct_id"===a||"$token"===a||"$device_id"===a||"$user_id"===a||"$had_persisted_distinct_id"===a};j.prototype.set=j.prototype.set;j.prototype.set_once=j.prototype.O;j.prototype.unset=j.prototype.wa;j.prototype.increment=j.prototype.Ib;j.prototype.append=
j.prototype.append;j.prototype.remove=j.prototype.remove;j.prototype.union=j.prototype.ga;j.prototype.track_charge=j.prototype.ud;j.prototype.clear_charges=j.prototype.tb;j.prototype.delete_user=j.prototype.Bb;j.prototype.toString=j.prototype.toString;var Sa="__mps,__mpso,__mpus,__mpa,__mpap,__mpr,__mpu,$people_distinct_id,__alias,__timers".split(",");q.prototype.ba=function(){var a={};this.load();c.a(this.props,function(b,d){c.Ua(Sa,d)||(a[d]=b)});return a};q.prototype.load=function(){if(!this.disabled){var a=
this.j.parse(this.name);a&&(this.props=c.extend({},a))}};q.prototype.zd=function(){var a;this.j===c.localStorage?(a=c.cookie.parse(this.name),c.cookie.remove(this.name),c.cookie.remove(this.name,m),a&&this.w(a)):this.j===c.cookie&&(a=c.localStorage.parse(this.name),c.localStorage.remove(this.name),a&&this.w(a))};q.prototype.save=function(){this.disabled||this.j.set(this.name,c.ha(this.props),this.Pa,this.Ka,this.ac,this.zb,this.na)};q.prototype.ta=function(a){this.load();return this.props[a]};q.prototype.remove=
function(){this.j.remove(this.name,D,this.na);this.j.remove(this.name,m,this.na)};q.prototype.clear=function(){this.remove();this.props={}};q.prototype.w=function(a,b,d){return c.e(a)?("undefined"===typeof b&&(b="None"),this.Pa="undefined"===typeof d?this.Ab:d,this.load(),c.a(a,function(a,c){if(!this.props.hasOwnProperty(c)||this.props[c]===b)this.props[c]=a},this),this.save(),m):D};q.prototype.m=function(a,b){return c.e(a)?(this.Pa="undefined"===typeof b?this.Ab:b,this.load(),c.extend(this.props,
a),this.save(),m):D};q.prototype.S=function(a){this.load();a in this.props&&(delete this.props[a],this.save())};q.prototype.oc=function(a){this.m(c.info.$c(a))};q.prototype.hb=function(a){this.w({$initial_referrer:a||"$direct",$initial_referring_domain:c.info.Ub(a)||"$direct"},"")};q.prototype.Lc=function(){return c.fa({$initial_referrer:this.props.$initial_referrer,$initial_referring_domain:this.props.$initial_referring_domain})};q.prototype.nc=function(a){this.Ab=this.Pa=a.cookie_expiration;this.dc(a.disable_persistence);
this.ed(a.cookie_domain);this.fd(a.cross_site_cookie);this.gd(a.cross_subdomain_cookie);this.kd(a.secure_cookie)};q.prototype.dc=function(a){(this.disabled=a)?this.remove():this.save()};q.prototype.ed=function(a){if(a!==this.na)this.remove(),this.na=a,this.save()};q.prototype.fd=function(a){if(a!==this.zb)this.zb=a,this.remove(),this.save()};q.prototype.gd=function(a){if(a!==this.Ka)this.Ka=a,this.remove(),this.save()};q.prototype.Jc=function(){return this.Ka};q.prototype.kd=function(a){if(a!==this.ac)this.ac=
a?m:D,this.remove(),this.save()};q.prototype.q=function(a,b){var d=this.ja(a),f=b[a],e=this.F("$set"),g=this.F("$set_once"),j=this.F("$unset"),i=this.F("$add"),k=this.F("$union"),p=this.F("$remove",[]),o=this.F("$append",[]);"__mps"===d?(c.extend(e,f),this.v("$add",f),this.v("$union",f),this.v("$unset",f)):"__mpso"===d?(c.a(f,function(a,b){b in g||(g[b]=a)}),this.v("$unset",f)):"__mpus"===d?c.a(f,function(a){c.a([e,g,i,k],function(b){a in b&&delete b[a]});c.a(o,function(b){a in b&&delete b[a]});j[a]=
m}):"__mpa"===d?(c.a(f,function(a,b){b in e?e[b]+=a:(b in i||(i[b]=0),i[b]+=a)},this),this.v("$unset",f)):"__mpu"===d?(c.a(f,function(a,b){c.isArray(a)&&(b in k||(k[b]=[]),k[b]=k[b].concat(a))}),this.v("$unset",f)):"__mpr"===d?(p.push(f),this.v("$append",f)):"__mpap"===d&&(o.push(f),this.v("$unset",f));n.log("MIXPANEL PEOPLE REQUEST (QUEUED, PENDING IDENTIFY):");n.log(b);this.save()};q.prototype.v=function(a,b){var d=this.props[this.ja(a)];c.g(d)||c.a(b,function(b,e){"$append"===a||"$remove"===a?
c.a(d,function(a){a[e]===b&&delete a[e]}):delete d[e]},this)};q.prototype.aa=function(a){return this.ta(this.ja(a))};q.prototype.ja=function(a){if("$set"===a)return"__mps";if("$set_once"===a)return"__mpso";if("$unset"===a)return"__mpus";if("$add"===a)return"__mpa";if("$append"===a)return"__mpap";if("$remove"===a)return"__mpr";if("$union"===a)return"__mpu";n.error("Invalid queue:",a)};q.prototype.F=function(a,b){var d=this.ja(a),b=c.g(b)?{}:b;return this.props[d]||(this.props[d]=b)};q.prototype.hd=
function(a){var b=(new Date).getTime(),c=this.ta("__timers")||{};c[a]=b;this.props.__timers=c;this.save()};q.prototype.Xc=function(a){var b=(this.ta("__timers")||{})[a];c.g(b)||(delete this.props.__timers[a],this.save());return b};var ca,x,O=o.XMLHttpRequest&&"withCredentials"in new XMLHttpRequest,ma=!O&&-1===z.indexOf("MSIE")&&-1===z.indexOf("Mozilla"),ba=r;I.sendBeacon&&(ba=function(){return I.sendBeacon.apply(I,arguments)});var A={track:"track/",engage:"engage/",groups:"groups/",record:"record/"},
...
else return a=S(a,b,d),x[d]=a,a.ka(),a};e.prototype.Y=function(a,b,d){b=b||{};this.__loaded=m;this.config={};var f={};"api_payload_format"in b||(b.api_host||Aa.api_host).match(/\.mixpanel\.com/)&&(f.api_payload_format="json");this.cc(c.extend({},Aa,f,b,{name:d,token:a,callback_fn:("mixpanel"===d?d:"mixpanel."+d)+"._jsc"}));this._jsc=P;this.ya=[];this.za=[];this.xa=[];this.V={disable_all_events:D,identify_called:D};this.u={};if(this.U=this.c("batch_requests"))if(!c.localStorage.sa(m)||!O)this.U=D,
n.log("Turning off Mixpanel request-queueing; needs XHR and localStorage support"),c.a(this.Eb(),function(a){n.log("Clearing batch queue "+a.da);c.localStorage.remove(a.da)});else if(this.Nc(),ba&&o.addEventListener){var e=c.bind(function(){this.u.L.va||this.u.L.flush({lc:m})},this);o.addEventListener("pagehide",function(a){a.persisted&&e()});o.addEventListener("visibilitychange",function(){"hidden"===v.visibilityState&&e()})}this.persistence=this.cookie=new q(this.config);this.R={};this.wc();a=c.jb();
...
Fa).apply(this,L.call(arguments,1));"undefined"===typeof b&&(this.l(a+" hook did not return a value"),b=r);return b};e.prototype.s=function(a){return this.persistence.ta([a])};e.prototype.toString=function(){var a=this.c("name");"mixpanel"!==a&&(a="mixpanel."+a);return a};e.prototype.nb=function(a){return c.Kb(z)||this.V.Ec||c.Ua(this.xa,a)};e.prototype.wc=function(){"localStorage"===this.c("opt_out_tracking_persistence_type")&&c.localStorage.sa()&&(!this.qa()&&this.qa({persistence_type:"cookie"})&&
this.Ob({enable_persistence:D}),!this.$()&&this.$({persistence_type:"cookie"})&&this.Za({clear_persistence:D}),this.ub({persistence_type:"cookie",enable_persistence:D}));if(this.$())this.ia({clear_persistence:m});else if(!this.qa()&&(this.c("opt_out_tracking_by_default")||c.cookie.get("mp_optout")))c.cookie.remove("mp_optout"),this.Za({clear_persistence:this.c("opt_out_persistence_by_default")})};e.prototype.ia=function(a){if(a&&a.clear_persistence)a=m;else if(a&&a.enable_persistence)a=D;else return;
...
ignore_dnt:this.c("ignore_dnt")},b);c.localStorage.sa()||(b.persistence_type="cookie");return a(this.c("token"),{o:b.track,sd:b.track_event_name,td:b.track_properties,Sb:b.persistence_type,Rb:b.cookie_prefix,wb:b.cookie_domain,xb:b.cookie_expiration,Dc:b.cross_site_cookie,yb:b.cross_subdomain_cookie,ad:b.secure_cookie,Hb:b.ignore_dnt})};e.prototype.Ob=function(a){a=c.extend({enable_persistence:m},a);this.X(Ia,a);this.ia(a)};e.prototype.Za=function(a){a=c.extend({clear_persistence:m,delete_user:m},
a);a.delete_user&&this.people&&this.people.Da()&&(this.people.Bb(),this.people.tb());this.X(Ja,a);this.ia(a)};e.prototype.qa=function(a){return this.X(Ka,a)};e.prototype.$=function(a){return this.X(ua,a)};e.prototype.ub=function(a){a=c.extend({enable_persistence:m},a);this.X(Ma,a);this.ia(a)};e.prototype.l=function(a,b){n.error.apply(n.error,arguments);try{!b&&!(a instanceof Error)&&(a=Error(a)),this.c("error_reporter")(a,b)}catch(c){n.error(c)}};e.prototype.init=e.prototype.Va;e.prototype.reset=
...
e.prototype.get_config=e.prototype.c;e.prototype.get_property=e.prototype.s;e.prototype.get_distinct_id=e.prototype.M;e.prototype.toString=e.prototype.toString;e.prototype.opt_out_tracking=e.prototype.Za;e.prototype.opt_in_tracking=e.prototype.Ob;e.prototype.has_opted_out_tracking=e.prototype.$;e.prototype.has_opted_in_tracking=e.prototype.qa;e.prototype.clear_opt_in_out_tracking=e.prototype.ub;e.prototype.get_group=e.prototype.Kc;e.prototype.set_group=e.prototype.jd;e.prototype.add_group=e.prototype.yc;
