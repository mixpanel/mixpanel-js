...
this.Rc=b.Rc||!1}function Wa(a,b){var c=[];d.h(a,function(e){var f=e.id;f in b?(f=b[f],null!==f&&(e.payload=f,c.push(e))):c.push(e)});return c}function Xa(a,b){var c=[];d.h(a,function(e){e.id&&!b[e.id]&&c.push(e)});return c}function O(a,b){b=b||{};this.oa=a;if(this.C=b.C)this.T=b.T||new ia,this.lock=new Ya(a,{storage:b.Jd||q.localStorage,kc:b.Kd});this.s=b.fa||d.bind(Za.error,Za);this.hb=b.hb||null;this.L=[];this.Sb=!1;this.ze=b.Fb?Ob(d.bind(this.tc,this),b.Fb):d.bind(function(c){return this.tc([c])},
this)}function ia(a){this.storage=a||q.localStorage}function Ya(a,b){b=b||{};this.oa=a;this.storage=b.storage||q.localStorage;this.wd=b.wd||100;this.kc=b.kc||2E3;this.yd=b.yd||E}function ra(){this.td="submit"}function da(){this.td="click"}function R(){}function B(a){this.fetch=q.fetch;this.Kb=a.Kb;this.Aa=a.Ee;this.Bf=a.Af;this.Tc=a.Ie;this.track=a.cg}function G(a){this.u=a;this.ja=0;this.Pb=!1;this.Ia=0}function ja(){}function $a(a){var b=Pb,c=a.split(".");c=c[c.length-1];if(4<c.length||"com"===
c||"org"===c)b=Qb;return(a=a.match(b))?a[0]:""}function Rb(){var a=d.ta().replace(/-/g,""),b=d.ta().replace(/-/g,"").substring(0,16);return"00-"+a+"-"+b+"-01"}function Ca(a){var b=Math.random().toString(36).substring(2,10)+Math.random().toString(36).substring(2,10);return a?b.substring(0,a):b}function Ob(a,b){var c=null,e=[];return function(f){var g=this;e.push(f);c||(c=new E(function(k){setTimeout(function(){var h=a.apply(g,[e]);c=null;e=[];k(h)},b)}));return c}}function sa(a,b){return null===Da||
...
b;this.M=null;this.jb=[]}function Q(a){this.Y=[];this.I=this.Ha=null;this.ia=!1;this.Wb=0;this.aa=[];this.qd=a;this.ka=!1;this.ib=null}function dc(a,b){qb(!0,a,b)}function ec(a,b){qb(!1,a,b)}function fc(a,b){return"1"===rb(a,b)}function sb(a,b){if(gc(b))return A.warn('This browser has "Do Not Track" enabled. This will prevent the Mixpanel SDK from sending any data. To ignore the "Do Not Track" browser setting, initialize the Mixpanel instance with the config "ignore_dnt: true"'),!0;(a="0"===rb(a,
...
"=";for(var b=x.cookie.split(";"),c=0;c<b.length;c++){for(var e=b[c];" "==e.charAt(0);)e=e.substring(1,e.length);if(0===e.indexOf(a))return decodeURIComponent(e.substring(a.length,e.length))}return null},parse:function(a){try{var b=d.sa(d.cookie.get(a))||{}}catch(c){}return b},mg:function(a,b,c,e,f,g,k){var h="",p="",r="";k?h="; domain="+k:e&&(h=(h=$a(x.location.hostname))?"; domain=."+h:"");c&&(p=new Date,p.setTime(p.getTime()+1E3*c),p="; expires="+p.toGMTString());g&&(f=!0,r="; SameSite=None");
...
lc="dclid fbclid gclid ko_click_id li_fat_id msclkid sccid ttclid twclid wbraid".split(" ");d.info={za:function(a){var b="",c={};d.h(kc,function(e){b=d.Mb(x.URL,e);b.length?c[e]=b:void 0!==a&&(c[e]=a)});return c},Ic:function(){var a="",b={};d.h(lc,function(c){a=d.Mb(x.URL,c);a.length&&(b[c]=a)});return b},df:function(){return d.extend(d.info.za(),d.info.Ic())},tf:function(a){return 0===a.search("https?://(.*)google.([^/?]*)")?"google":0===a.search("https?://(.*)bing.com")?"bing":0===a.search("https?://(.*)yahoo.com")?
...
this.aa.push({element:b,event:a,timestamp:Date.now()});return!0};Q.prototype.Vf=function(a,b){this.ia&&this.ge(a)&&this.dg(b)};Q.prototype.Fe=function(a){if(0===this.aa.length)return[];a=a.timeout_ms;var b=Date.now(),c=this.aa.slice();this.aa=[];for(var e=[],f=0;f<c.length;f++){var g=c[f];b-g.timestamp>=a?this.Ne(g.timestamp)||e.push(g):this.aa.push(g)}return e};Q.prototype.Ne=function(a){return this.Wb>=a-100};Q.prototype.la=function(){this.Wb=Date.now()};Q.prototype.dg=function(a){this.ka||(this.ka=
!0,this.xd(a))};Q.prototype.xd=function(a){if(this.ia&&this.qd){var b=this;this.ib=setTimeout(function(){if(b.ka){for(var c=b.Fe(a),e=0;e<c.length;e++)b.qd(c[e].event);0<b.aa.length?b.xd(a):b.ka=!1}},a.timeout_ms)}else this.ka=!1};Q.prototype.Jf=function(){if(!this.ia){this.ia=!0;var a=this;mc.forEach(function(c){function e(){a.la()}document.addEventListener(c,e,{capture:!0,passive:!0});a.Y.push({target:document,event:c,$a:e,options:{capture:!0,passive:!0}})});oc.forEach(function(c){function e(){a.la()}
window.addEventListener(c,e);a.Y.push({target:window,event:c,$a:e})});nc.forEach(function(c){function e(){a.la()}window.addEventListener(c,e,{passive:!0});a.Y.push({target:window,event:c,$a:e,options:{passive:!0}})});var b=function(){a.la()};document.addEventListener("selectionchange",b);a.Y.push({target:document,event:"selectionchange",$a:b});if(window.MutationObserver)try{this.Ha=new window.MutationObserver(function(){a.la()}),this.Ha.observe(document.body||document.documentElement,Db)}catch(c){C.l("Error while setting up mutation observer",
c)}if(window.customElements)try{this.I=new Z(function(){a.la()},Db),this.I.start()}catch(c){C.l("Error while setting up shadow DOM observer",c),this.I=null}}};Q.prototype.Of=function(){if(this.ia){this.ia=!1;this.aa=[];this.Wb=0;this.ka=!1;this.ib&&(clearTimeout(this.ib),this.ib=null);for(var a=0;a<this.Y.length;a++){var b=this.Y[a];try{b.target.removeEventListener(b.event,b.$a,b.options)}catch(c){C.l("Error while removing event listener",c)}}this.Y=[];if(this.Ha){try{this.Ha.disconnect()}catch(c){C.l("Error while disconnecting mutation observer",
...
G.prototype.ca=function(a){return(a=this.o(a))?!0===a?{}:"object"===typeof a?a:{}:null};G.prototype.Dc=function(a,b,c){if(!this.Pb){this.Pb=!0;var e=Math.max(x.documentElement.clientHeight,q.innerHeight||0),f=Math.round(Math.max(this.ja-e,0)/(c-e)*100),g=Math.round(e/c*100);c<=e&&(g=f=100);a=d.extend({$max_scroll_view_depth:this.ja,$max_scroll_percentage:f,$fold_line_percentage:g,$scroll_height:c,$event_type:a.type,$current_url:b||d.info.W(),$viewportHeight:e,$viewportWidth:Math.max(x.documentElement.clientWidth,
q.innerWidth||0)},oa);this.u.Ca()&&!this.o("page_leave")&&(a.$captured_for_heatmap=!0);this.u.track("$mp_page_leave",a,{kb:"sendBeacon"})}};G.prototype.ce=function(){q.removeEventListener("scroll",this.Yb);q.removeEventListener("scrollend",this.Yb);if(this.u.g("record_heatmap_data")){C.log("Initializing scroll depth tracking");this.ja=Math.max(x.documentElement.clientHeight,q.innerHeight||0);var a=function(){if(!this.R()){var b=Math.max(x.documentElement.clientHeight,q.innerHeight||0)+q.scrollY;b>
this.ja&&(this.ja=b);this.Ia=x.body.scrollHeight}}.bind(this);a=nb(a);this.Yb=a.listener;q.addEventListener(a.Qc,this.Yb)}};G.prototype.Pe=function(){q.removeEventListener("click",this.fd);if(this.o("click")||this.u.g("record_heatmap_data"))C.log("Initializing click tracking"),this.fd=function(a){(this.o("click")||this.u.Ca())&&this.Na(a,"$mp_click")}.bind(this),q.addEventListener("click",this.fd)};G.prototype.Qe=function(){this.ca("dead_click")||this.u.g("record_heatmap_data")?(C.log("Initializing dead click tracking"),
this.ba||(this.ba=new Q(function(a){this.Na(a,"$mp_dead_click")}.bind(this)),this.ba.Jf()),this.Ea||(this.Ea=function(a){var b=this.ca("dead_click");!b&&!this.u.Ca()||this.R()||(b=b||{},b.timeout_ms||(b.timeout_ms=500),this.ba.Vf(a,b))}.bind(this),q.addEventListener("click",this.Ea))):this.Nf()};G.prototype.Re=function(){q.removeEventListener("change",this.ed);this.o("input")&&(C.log("Initializing input tracking"),this.ed=function(a){this.o("input")&&this.Na(a,"$mp_input_change")}.bind(this),q.addEventListener("change",
...
Y)})}function p(L){(new Date).getTime()-n>w?(pc.error("Timeout waiting for mutex on "+m+"; clearing lock. ["+r+"]"),u.removeItem(N),u.removeItem(v),g()):setTimeout(function(){try{L()}catch(Y){e(Y)}},t*(Math.random()+.1))}var r=b||(new Date).getTime()+"|"+Math.random(),n=(new Date).getTime(),m=this.oa,t=this.wd,w=this.kc,u=this.storage,I=m+":X",v=m+":Y",N=m+":Z";try{if(sa(u,!0))g();else throw Error("localStorage support check failed");}catch(L){e(L)}},this))};ia.prototype.B=function(){return E.resolve()};
...
}return!0},this)).catch(d.bind(function(e){this.s("Error removing items",e,a);return!1},this))},this);return this.lock.nc(c,this.hb).catch(d.bind(function(e){this.s("Error acquiring storage lock",e);return sa(this.lock.storage,!0)?!1:c().then(d.bind(function(f){return f?f:this.T.removeItem(this.oa).then(function(){return f})},this)).catch(d.bind(function(f){this.s("Error clearing queue",f);return!1},this))},this))}return E.resolve(!0)};O.prototype.fg=function(a){this.L=Wa(this.L,a);return this.C?
this.lock.nc(d.bind(function(){return this.X().then(d.bind(function(){return this.Ma()},this)).then(d.bind(function(b){b=Wa(b,a);return this.dc(b)},this)).catch(d.bind(function(b){this.s("Error updating items",a,b);return!1},this))},this),this.hb).catch(d.bind(function(b){this.s("Error acquiring storage lock",b);return!1},this)):E.resolve(!0)};O.prototype.Ma=function(){return this.X().then(d.bind(function(){return this.T.getItem(this.oa)},this)).then(d.bind(function(a){a&&!d.isArray(a)&&(this.s("Invalid storage entry:",
a),a=null);return a||[]},this)).catch(d.bind(function(a){this.s("Error retrieving queue",a);return[]},this))};O.prototype.dc=function(a){return this.X().then(d.bind(function(){return this.T.setItem(this.oa,a)},this)).then(function(){return!0}).catch(d.bind(function(b){this.s("Error saving queue",b);return!1},this))};O.prototype.clear=function(){this.L=[];return this.C?this.X().then(d.bind(function(){return this.T.removeItem(this.oa)},this)):E.resolve()};var pa=la("batch");M.prototype.enqueue=function(a){return this.Ka.enqueue(a,
this.Za)};M.prototype.start=function(){this.stopped=!1;this.Cb=0;return this.flush()};M.prototype.stop=function(){this.stopped=!0;this.jc&&(clearTimeout(this.jc),this.jc=null)};M.prototype.clear=function(){return this.Ka.clear()};M.prototype.Cd=function(){this.V=this.S.batch_size};M.prototype.ma=function(){this.Ed(this.S.batch_flush_interval_ms)};M.prototype.Ed=function(a){this.Za=a;this.stopped||(this.jc=setTimeout(d.bind(function(){this.stopped||this.flush()},this),this.Za))};M.prototype.yf=function(a,
b){return new E(d.bind(function(c){this.wf(a,b,c)},this))};M.prototype.flush=function(a){if(this.cc)return pa.log("Flush: Request already in progress"),E.resolve();this.cc=!0;a=a||{};var b=this.S.batch_request_timeout_ms,c=(new Date).getTime(),e=this.V;return this.Ka.Be(e).then(d.bind(function(f){var g=f.length===e,k=[],h={};d.h(f,function(m){var t=m.payload;this.Ua&&!m.lf&&(t=this.Ua(t));if(t){t.event&&t.properties&&(t.properties=d.extend({},t.properties,{mp_sent_by_lib_version:"2.71.0"}));var w=
!0,u=m.id;u?5<(this.$[u]||0)&&(this.s("[dupe] item ID sent too many times, not sending",{item:m,V:f.length,Uf:this.$[u]}),w=!1):this.s("[dupe] found item with no ID",{item:m});w&&k.push(t)}h[m.id]=t},this);if(1>k.length)return this.cc=!1,this.ma(),E.resolve();var p=d.bind(function(){return this.Ka.pf(d.map(f,function(m){return m.id})).then(d.bind(function(m){d.h(f,d.bind(function(t){var w=t.id;w?(this.$[w]=this.$[w]||0,this.$[w]++,5<this.$[w]&&this.s("[dupe] item ID sent too many times",{item:t,V:f.length,
Uf:this.$[w]})):this.s("[dupe] found item with no ID while removing",{item:t})},this));if(m)return this.Cb=0,this.Rc&&!g?(this.ma(),E.resolve()):this.flush();5<++this.Cb?(this.s("Too many queue failures; disabling batching system."),this.Lf()):this.ma();return E.resolve()},this))},this),r=d.bind(function(m){this.cc=!1;try{if(a.Qd)return this.Ka.fg(h);if(d.j(m)&&"timeout"===m.error&&(new Date).getTime()-c>=b)return this.s("Network timeout; retrying"),this.flush();var t;if(t=d.j(m)){var w;if(!(w=500<=
m.bb||429===m.bb)){var u;if(u=0>=m.bb){var I=q.navigator.onLine;u=!(d.m(I)||I)}w=u}t=w||"timeout"===m.error}if(t){var v=2*this.Za;m.Dd&&(v=1E3*parseInt(m.Dd,10)||v);v=Math.min(6E5,v);this.s("Error; retry in "+v+" ms");this.Ed(v);return E.resolve()}if(d.j(m)&&413===m.bb){if(1<f.length)return this.V=Math.min(this.V,Math.max(1,Math.floor(e/2)),f.length-1),this.s("413 response; reducing batch size to "+this.V),this.ma(),E.resolve();this.s("Single-event request too large; dropping",f);this.Cd()}return p()}catch(N){this.s("Error handling API response",
N),this.ma()}},this),n={method:"POST",Ud:!0,Oe:!0,Md:b};a.Qd&&(n.kb="sendBeacon");pa.log("MIXPANEL REQUEST:",k);return this.yf(k,n).then(r)},this)).catch(d.bind(function(f){this.s("Error flushing request queue",f);this.ma()},this))};M.prototype.s=function(a,b){pa.error.apply(pa.error,arguments);if(this.fa)try{b instanceof Error||(b=Error(a)),this.fa(a,b)}catch(c){pa.error(c)}};var Gb={Gd:function(a,b){var c={},e={};d.j(a)?d.h(a,function(f,g){this.O(g)||(e[g]=f)},this):e[a]=b;c.$set=e;return c},Rd:function(a){var b=
...
{};d.j(a)?d.h(a,function(f,g){this.O(g)||(e[g]=f)},this):e[a]=b;c.$remove=e;return c},jg:function(){return{$delete:""}}};d.extend(D.prototype,Gb);D.prototype.ya=function(a,b,c){this.i=a;this.ub=b;this.tb=c};D.prototype.set=ea(function(a,b,c){var e=this.Gd(a,b);d.j(a)&&(c=b);return this.v(e,c)});D.prototype.na=ea(function(a,b,c){var e=this.Id(a,b);d.j(a)&&(c=b);return this.v(e,c)});D.prototype.lb=ea(function(a,b){a=this.Rd(a);return this.v(a,b)});D.prototype.Pa=ea(function(a,b,c){d.j(a)&&(c=b);a=this.Pd(a,
...
D.prototype.toString=function(){return this.i.toString()+".group."+this.ub+"."+this.tb};D.prototype.remove=D.prototype.remove;D.prototype.set=D.prototype.set;D.prototype.set_once=D.prototype.na;D.prototype.union=D.prototype.Pa;D.prototype.unset=D.prototype.lb;D.prototype.toString=D.prototype.toString;d.extend(y.prototype,Gb);y.prototype.ya=function(a){this.i=a};y.prototype.set=W(function(a,b,c){var e=this.Gd(a,b);d.j(a)&&(c=b);this.J("save_referrer")&&this.i.persistence.mc(document.referrer);e.$set=
d.extend({},d.info.nf(),e.$set);return this.v(e,c)});y.prototype.na=W(function(a,b,c){var e=this.Id(a,b);d.j(a)&&(c=b);return this.v(e,c)});y.prototype.lb=W(function(a,b){a=this.Rd(a);return this.v(a,b)});y.prototype.ad=W(function(a,b,c){var e={},f={};d.j(a)?(d.h(a,function(g,k){this.O(k)||(isNaN(parseFloat(g))?A.error("Invalid increment value passed to mixpanel.people.increment - must be a number"):f[k]=g)},this),c=b):(d.m(b)&&(b=1),f[a]=b);e.$add=f;return this.v(e,c)});y.prototype.append=W(function(a,
...
error:null}):b(-1)),d.truncate(c,255))};y.prototype.J=function(a){return this.i.g(a)};y.prototype.vb=function(){return!0===this.i.va.Zc};y.prototype.Zd=function(a){"$set"in a?this.i.persistence.G("$set",a):"$set_once"in a?this.i.persistence.G("$set_once",a):"$unset"in a?this.i.persistence.G("$unset",a):"$add"in a?this.i.persistence.G("$add",a):"$append"in a?this.i.persistence.G("$append",a):"$remove"in a?this.i.persistence.G("$remove",a):"$union"in a?this.i.persistence.G("$union",a):A.error("Invalid call to _enqueue():",
a)};y.prototype.wa=function(a,b,c,e){var f=this,g=d.extend({},this.i.persistence.Fa(a)),k=g;d.m(g)||!d.j(g)||d.cb(g)||(f.i.persistence.K(a,g),f.i.persistence.save(),e&&(k=e(g)),b.call(f,k,function(h,p){0===h&&f.i.persistence.G(a,g);d.m(c)||c(h,p)}))};y.prototype.ae=function(a,b,c,e,f,g,k){var h=this;this.wa("$set",this.set,a);this.wa("$set_once",this.na,e);this.wa("$unset",this.lb,g,function(n){return d.keys(n)});this.wa("$add",this.ad,b);this.wa("$union",this.Pa,f);a=this.i.persistence.Fa("$append");
...
function(a){return"$distinct_id"===a||"$token"===a||"$device_id"===a||"$user_id"===a||"$had_persisted_distinct_id"===a};y.prototype.set=y.prototype.set;y.prototype.set_once=y.prototype.na;y.prototype.unset=y.prototype.lb;y.prototype.increment=y.prototype.ad;y.prototype.append=y.prototype.append;y.prototype.remove=y.prototype.remove;y.prototype.union=y.prototype.Pa;y.prototype.track_charge=y.prototype.Zf;y.prototype.clear_charges=y.prototype.Gc;y.prototype.delete_user=y.prototype.Oc;y.prototype.toString=
...
z.prototype.mc=function(a){this.N({$initial_referrer:a||"$direct",$initial_referring_domain:d.info.zd(a)||"$direct"},"")};z.prototype.Le=function(){return d.pa({$initial_referrer:this.props.$initial_referrer,$initial_referring_domain:this.props.$initial_referring_domain})};z.prototype.Sd=function(a){this.Nc=this.Hb=a.cookie_expiration;this.Hd(a.disable_persistence);this.Cf(a.cookie_domain);this.Df(a.cross_site_cookie);this.Ef(a.cross_subdomain_cookie);this.Hf(a.secure_cookie)};z.prototype.Hd=function(a){(this.disabled=
...
Promise.resolve()};l.prototype.Ca=function(){return this.sb()&&this.g("record_heatmap_data")};l.prototype.Xc=function(){var a={},b=this.sb();b&&(a.$mp_replay_id=b);return a};l.prototype.Me=function(){var a=null,b=this.sb();b&&(a="https://mixpanel.com/projects/replay-redirect?"+d.oc({replay_id:b,distinct_id:this.Z(),token:this.g("token")}));return a};l.prototype.sb=function(){var a=null;this.D&&(a=this.D.replayId);return a||null};l.prototype.Vd=function(){return this.D};l.prototype.Sa=function(){this.g("loaded")(this);
this.Cc();this.people.na(this.persistence.Le());if(this.g("store_google")&&this.g("stop_utm_persistence")){var a=d.info.za(null);d.h(a,function(b,c){this.unregister(c)}.bind(this))}};l.prototype.Cc=function(){this.persistence.Td(x.referrer);this.g("store_google")&&!this.g("stop_utm_persistence")&&this.register(d.info.za());this.g("save_referrer")&&this.persistence.mc(x.referrer)};l.prototype.Yd=function(){d.h(this.nb,function(a){this.wb.apply(this,a)},this);this.Ba()||d.h(this.ob,function(a){this.v.apply(this,
...
!0;n.onreadystatechange=function(){if(4===n.readyState)if(200===n.status){if(e)if(p){try{var w=d.sa(n.responseText)}catch(u){if(r.A(u),c.Oe)w=n.responseText;else return}e(w)}else e(Number(n.responseText))}else w=n.timeout&&!n.status&&(new Date).getTime()-t>=n.timeout?"timeout":"Bad HTTP status: "+n.status+" "+n.statusText,r.A(w),e&&(p?e({status:0,bb:n.status,error:w,Dd:(n.responseHeaders||{})["Retry-After"]}):e(0))};n.send(k)}catch(w){r.A(w),f=!1}else k=x.createElement("script"),k.type="text/javascript",
...
this.sc(e),f,this.yc(g,e))},this),Ua:d.bind(function(e){return this.Bc("before_send_"+c.type,e)},this),Mf:d.bind(this.hc,this),C:!0})},this),b=this.Wc();this.H={ga:a(b.ga),bc:a(b.bc),groups:a(b.groups)}}this.g("batch_autostart")&&this.fc()};l.prototype.fc=function(){this.Wd=!0;this.Fc()&&(this.ua=!0,d.h(this.H,function(a){a.start()}))};l.prototype.hc=function(){this.ua=!1;d.h(this.H,function(a){a.stop();a.clear()})};l.prototype.push=function(a){this.qb([a])};l.prototype.disable=function(a){"undefined"===
typeof a?this.va.we=!0:this.mb=this.mb.concat(a)};l.prototype.sc=function(a){a=fa(a);"base64"===this.g("api_payload_format")&&(a=d.me(a));return{data:a}};l.prototype.xb=function(a,b){var c=d.truncate(a.data,255),e=a.endpoint,f=a.Ab,g=a.If,k=a.zf||{};b=b||ja;var h=!0,p=d.bind(function(){k.Ld||(c=this.Bc("before_send_"+a.type,c));return c?(A.log("MIXPANEL REQUEST:"),A.log(c),this.v(e,this.sc(c),k,this.yc(b,c))):null},this);this.ua&&!g?f.enqueue(c).then(function(r){r?b(1,c):p()}):h=p();return h&&c};
...
JSON.stringify(b)};l.prototype.Ke=function(a,b){var c=this.Xd(a,b),e=this.rc[c];if(void 0===e||e.ub!==a||e.tb!==b)e=new D,e.ya(this,a,b),this.rc[c]=e;return e};l.prototype.lc=aa(function(a,b){"object"!==typeof a&&(a={});b=b||{};b=b.event_name||"$mp_web_page_view";var c=d.extend(d.info.ff(),d.info.za(),d.info.Ic());a=d.extend({},c,a);return this.track(b,a)});l.prototype.ag=function(){return this.wb.call(this,da,arguments)};l.prototype.$f=function(){return this.wb.call(this,ra,arguments)};l.prototype.Tf=
function(a){d.m(a)?this.A("No event name provided to mixpanel.time_event"):this.uc(a)||this.persistence.Ff(a)};var Mb={persistent:!0};l.prototype.register=function(a,b){b=Ba(b);b.persistent?this.persistence.register(a,b.days):d.extend(this.ra,a)};l.prototype.N=function(a,b,c){c=Ba(c);c.persistent?this.persistence.N(a,b,c.days):("undefined"===typeof b&&(b="None"),d.h(a,function(e,f){this.ra.hasOwnProperty(f)&&this.ra[f]!==b||(this.ra[f]=e)},this))};l.prototype.unregister=function(a,b){b=Ba(b);b.persistent?
this.persistence.unregister(a):delete this.ra[a]};l.prototype.Ac=function(a,b){var c={};c[a]=b;this.register(c)};l.prototype.Qb=function(a,b,c,e,f,g,k,h){var p=this.Z();if(a&&p!==a){if("string"===typeof a&&0===a.indexOf("$device:"))return this.A("distinct_id cannot have $device: prefix"),-1;this.register({$user_id:a})}this.F("$device_id")||this.N({$had_persisted_distinct_id:!0,$device_id:p},"");a!==p&&a!==this.F("__alias")&&(this.unregister("__alias"),this.register({distinct_id:a}));this.va.Zc=!0;
this.people.ae(b,c,e,f,g,k,h);a!==p&&this.track("$identify",{distinct_id:a,$anon_distinct_id:p},{Ld:!0});a!==p&&this.flags.Ib()};l.prototype.reset=function(){this.ic();this.persistence.clear();this.va.Zc=!1;var a=d.ta();this.N({distinct_id:"$device:"+a,$device_id:a},"");this.pb()};l.prototype.Z=function(){return this.F("distinct_id")};l.prototype.ie=function(a,b){if(a===this.F("$people_distinct_id"))return this.A("Attempting to create alias for existing People user - aborting."),-2;var c=this;d.m(b)&&
...
this.g("api_host")};l.prototype.toString=function(){var a=this.g("name");"mixpanel"!==a&&(a="mixpanel."+a);return a};l.prototype.uc=function(a){return d.cd(J)||this.va.we||d.Rb(this.mb,a)};l.prototype.be=function(){"localStorage"===this.g("opt_out_tracking_persistence_type")&&d.localStorage.Da()&&(!this.ab()&&this.ab({persistence_type:"cookie"})&&this.rd({enable_persistence:!1}),!this.Ba()&&this.Ba({persistence_type:"cookie"})&&this.$b({clear_persistence:!1}),this.Hc({persistence_type:"cookie",enable_persistence:!1}));
this.Ba()?this.Qa({clear_persistence:!0}):this.ab()||!this.g("opt_out_tracking_by_default")&&!d.cookie.get("mp_optout")||(d.cookie.remove("mp_optout"),this.$b({clear_persistence:this.g("opt_out_persistence_by_default")}))};l.prototype.Qa=function(a){if(a&&a.clear_persistence)a=!0;else if(a&&a.enable_persistence)a=!1;else return;this.g("disable_persistence")||this.persistence.disabled===a||this.persistence.Hd(a);a?(this.hc(),this.ic()):this.Wd&&this.fc()};l.prototype.xa=function(a,b){b=d.extend({track:d.bind(this.track,
...
vd:b.persistence_type,ud:b.cookie_prefix,Jc:b.cookie_domain,Kc:b.cookie_expiration,ve:b.cross_site_cookie,Lc:b.cross_subdomain_cookie,vf:b.secure_cookie,$c:b.ignore_dnt})};l.prototype.rd=function(a){a=d.extend({enable_persistence:!0},a);this.xa(dc,a);this.Qa(a)};l.prototype.$b=function(a){a=d.extend({clear_persistence:!0,delete_user:!0},a);a.delete_user&&this.people&&this.people.vb()&&(this.people.Oc(),this.people.Gc());this.xa(ec,a);this.Qa(a)};l.prototype.ab=function(a){return this.xa(fc,a)};l.prototype.Ba=
function(a){return this.xa(sb,a)};l.prototype.Hc=function(a){a=d.extend({enable_persistence:!0},a);this.xa(hc,a);this.Qa(a)};l.prototype.A=function(a,b){A.error.apply(A.error,arguments);try{b||a instanceof Error||(a=Error(a)),this.g("error_reporter")(a,b)}catch(c){A.error(c)}};l.prototype.init=l.prototype.B;l.prototype.reset=l.prototype.reset;l.prototype.disable=l.prototype.disable;l.prototype.time_event=l.prototype.Tf;l.prototype.track=l.prototype.track;l.prototype.track_links=l.prototype.ag;l.prototype.track_forms=
...
l.prototype.toString;l.prototype.opt_out_tracking=l.prototype.$b;l.prototype.opt_in_tracking=l.prototype.rd;l.prototype.has_opted_out_tracking=l.prototype.Ba;l.prototype.has_opted_in_tracking=l.prototype.ab;l.prototype.clear_opt_in_out_tracking=l.prototype.Hc;l.prototype.get_group=l.prototype.Ke;l.prototype.set_group=l.prototype.Gf;l.prototype.add_group=l.prototype.he;l.prototype.remove_group=l.prototype.rf;l.prototype.track_with_groups=l.prototype.bg;l.prototype.start_batch_senders=l.prototype.fc;
