...
e)&&c.call(d,a[e],e,a)===f)break};c.u=function(a){a&&c.Xa(a)&&(a=a.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"));return a};c.extend=function(a){j(C.call(arguments,1),function(b){for(var c in b)void 0!==b[c]&&(a[c]=b[c])});return a};c.isArray=e||function(a){return"[object Array]"===E.call(a)};c.Eb=function(a){try{return/^\s*\bfunction\b/.test(a)}catch(b){return s}};c.Fc=function(a){return!(!a||!H.call(a,"callee"))};c.ha=function(a){return!a?
[]:a.ha?a.ha():c.isArray(a)||c.Fc(a)?C.call(a):c.ed(a)};c.ed=function(a){var b=[];if(a==r)return b;j(a,function(a){b[b.length]=a});return b};c.jd=function(a){return a};c.Ab=function(a,b){var c=s;if(a==r)return c;if(d&&a.indexOf===d)return-1!=a.indexOf(b);j(a,function(a){if(c||(c=a===b))return f});return c};c.j=function(a,b){return-1!==a.indexOf(b)}})();c.Cb=function(a,b){a.prototype=new b;a.Xc=b.prototype};c.k=function(a){return a===Object(a)&&!c.isArray(a)};c.S=function(a){if(c.k(a)){for(var b in a)if(H.call(a,
b))return s;return m}return s};c.d=function(a){return void 0===a};c.Xa=function(a){return"[object String]"==E.call(a)};c.Gc=function(a){return"[object Date]"==E.call(a)};c.Ic=function(a){return"[object Number]"==E.call(a)};c.Hc=function(a){return!!(a&&1===a.nodeType)};c.wb=function(a){c.a(a,function(b,d){c.Gc(b)?a[d]=c.Cc(b):c.k(b)&&(a[d]=c.wb(b))});return a};c.Cc=function(a){function b(a){return 10>a?"0"+a:a}return a.getUTCFullYear()+"-"+b(a.getUTCMonth()+1)+"-"+b(a.getUTCDate())+"T"+b(a.getUTCHours())+
":"+b(a.getUTCMinutes())+":"+b(a.getUTCSeconds())};c.o=function(a){return function(){try{a.apply(this,arguments)}catch(b){n.ba("Implementation error. Please contact support@mixpanel.com.")}}};c.Oc=function(a){for(var b=["identify","_check_and_handle_notifications","_show_notification"],d=0;d<b.length;d++)a.prototype[b[d]]=c.o(a.prototype[b[d]])};c.va=function(a){var b={};c.a(a,function(a,e){c.Xa(a)&&0<a.length&&(b[e]=a)});return b};c.truncate=function(a,b){var d;"string"===typeof a?d=a.slice(0,b):
...
i){f("[");b();if("]"===i){f("]");g=k;break a}for(;i;){k.push(p());b();if("]"===i){f("]");g=k;break a}f(",");b()}}j("Bad array")}return g;case '"':return c();case "-":return e();default:return"0"<=i&&"9">=i?e():a()}};return function(a){h=a;k=0;i=" ";a=p();b();i&&j("Syntax error");return a}}();c.pb=function(a){var b,d,e,f,j=0,k=0,i="",i=[];if(!a)return a;a=c.dd(a);do b=a.charCodeAt(j++),d=a.charCodeAt(j++),e=a.charCodeAt(j++),f=b<<16|d<<8|e,b=f>>18&63,d=f>>12&63,e=f>>6&63,f&=63,i[k++]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(b)+
...
"",b={};c.a("utm_source utm_medium utm_campaign utm_content utm_term".split(" "),function(d){a=c.xb(l.URL,d);a.length&&(b[d]=a)});return b},Pc:function(a){return 0===a.search("https?://(.*)google.([^/?]*)")?"google":0===a.search("https?://(.*)bing.com")?"bing":0===a.search("https?://(.*)yahoo.com")?"yahoo":0===a.search("https?://(.*)duckduckgo.com")?"duckduckgo":r},Qc:function(a){var b=c.info.Pc(a),d={};if(b!==r)d.$search_engine=b,a=c.xb(a,"yahoo"!=b?"q":"p"),a.length&&(d.mp_keyword=a);return d},
...
c.j(a,"Trident/")?"Internet Explorer":c.j(a,"Gecko")?"Mozilla":""},rb:function(a,b,d){b={"Internet Explorer Mobile":/rv:(\d+(\.\d+)?)/,"Microsoft Edge":/Edge\/(\d+(\.\d+)?)/,Chrome:/Chrome\/(\d+(\.\d+)?)/,"Chrome iOS":/CriOS\/(\d+(\.\d+)?)/,Safari:/Version\/(\d+(\.\d+)?)/,"Mobile Safari":/Version\/(\d+(\.\d+)?)/,Opera:/(Opera|OPR)\/(\d+(\.\d+)?)/,Firefox:/Firefox\/(\d+(\.\d+)?)/,"Firefox iOS":/FxiOS\/(\d+(\.\d+)?)/,Konqueror:/Konqueror:(\d+(\.\d+)?)/,BlackBerry:/BlackBerry (\d+(\.\d+)?)/,"Android Mobile":/android\s(\d+(\.\d+)?)/,
"Internet Explorer":/(rv:|MSIE )(\d+(\.\d+)?)/,Mozilla:/rv:(\d+(\.\d+)?)/}[c.info.aa(a,b,d)];if(void 0==b)return r;a=a.match(b);return!a?r:parseFloat(a[a.length-2])},$a:function(){return/Windows/i.test(u)?/Phone/.test(u)||/WPDesktop/.test(u)?"Windows Phone":"Windows":/(iPhone|iPad|iPod)/.test(u)?"iOS":/Android/.test(u)?"Android":/(BlackBerry|PlayBook|BB10)/i.test(u)?"BlackBerry":/Mac/i.test(u)?"Mac OS X":/Linux/.test(u)?"Linux":""},vb:function(a){return/Windows Phone/i.test(a)||/WPDesktop/.test(a)?
"Windows Phone":/iPad/.test(a)?"iPad":/iPod/.test(a)?"iPod Touch":/iPhone/.test(a)?"iPhone":/(BlackBerry|PlayBook|BB10)/i.test(a)?"BlackBerry":/Android/.test(a)?"Android":""},Kb:function(a){a=a.split("/");return 3<=a.length?a[2]:""},fa:function(){return c.extend(c.va({$os:c.info.$a(),$browser:c.info.aa(u,z.vendor,window.opera),$referrer:l.referrer,$referring_domain:c.info.Kb(l.referrer),$device:c.info.vb(u)}),{$current_url:window.location.href,$browser_version:c.info.rb(u,z.vendor,window.opera),$screen_height:screen.height,
$screen_width:screen.width,mp_lib:"web",$lib_version:"2.8.0"})},Mc:function(){return c.extend(c.va({$os:c.info.$a(),$browser:c.info.aa(u,z.vendor,window.opera)}),{$browser_version:c.info.rb(u,z.vendor,window.opera)})},Lc:function(a){return c.va({mp_page:a,mp_referrer:l.referrer,mp_browser:c.info.aa(u,z.vendor,window.opera),mp_platform:c.info.$a()})}};var n={log:function(){if(y&&!c.d(v)&&v)try{v.log.apply(v,arguments)}catch(a){c.a(arguments,function(a){v.log(a)})}},error:function(){if(y&&!c.d(v)&&
v){var a=["Mixpanel error:"].concat(c.ha(arguments));try{v.error.apply(v,a)}catch(b){c.a(a,function(a){v.error(a)})}}},ba:function(){if(!c.d(v)&&v){var a=["Mixpanel error:"].concat(c.ha(arguments));try{v.error.apply(v,a)}catch(b){c.a(a,function(a){v.error(a)})}}}};w.prototype.sa=D();w.prototype.Ra=D();w.prototype.Na=D();w.prototype.Wa=function(a){this.Hb=a;return this};w.prototype.U=function(a,b,d,e){var f=this,j=c.Ac(a);if(0==j.length)n.error("The DOM query ("+a+") returned 0 elements");else return c.a(j,
function(a){c.D(a,this.Jb,function(a){var c={},j=f.sa(d,this),g=f.Hb.e("track_links_timeout");f.Ra(a,this,c);window.setTimeout(f.Qb(e,j,c,m),g);f.Hb.U(b,j,f.Qb(e,j,c))})},this),m};w.prototype.Qb=function(a,b,c,e){var e=e||s,f=this;return function(){if(!c.sc)c.sc=m,a&&a(e,b)===s||f.Na(b,c,e)}};w.prototype.sa=function(a,b){return"function"===typeof a?a(b):c.extend({},a)};c.Cb(B,w);B.prototype.sa=function(a,b){var c=B.Xc.sa.apply(this,arguments);if(b.href)c.url=b.href;return c};B.prototype.Ra=function(a,
...
function(){this.disabled||(this.fc(),this.w.set(this.name,c.la(this.props),this.Sa,this.Pa,this.Lb))};o.prototype.remove=function(){this.w.remove(this.name,s);this.w.remove(this.name,m)};o.prototype.clear=function(){this.remove();this.props={}};o.prototype.G=function(a,b,d){return c.k(a)?("undefined"===typeof b&&(b="None"),this.Sa="undefined"===typeof d?this.ub:d,c.a(a,function(a,c){if(!this.props[c]||this.props[c]===b)this.props[c]=a},this),this.save(),m):s};o.prototype.ga=function(a,b){return c.k(a)?
(this.Sa="undefined"===typeof b?this.ub:b,c.extend(this.props,a),this.save(),m):s};o.prototype.ya=function(a){a in this.props&&(delete this.props[a],this.save())};o.prototype.fc=c.o(function(){var a=this.props.__cmpns,b=y?6E4:36E5;if(a){for(var d in a)1*new Date-a[d]>b&&delete a[d];c.S(a)&&delete this.props.__cmpns}});o.prototype.bd=function(){if(!this.sb)this.G(c.info.tc()),this.sb=m};o.prototype.Ub=function(a){this.ga(c.info.Qc(a))};o.prototype.cb=function(a){this.G({$initial_referrer:a||"$direct",
$initial_referring_domain:c.info.Kb(a)||"$direct"},"")};o.prototype.Ec=function(){return c.va({$initial_referrer:this.props.$initial_referrer,$initial_referring_domain:this.props.$initial_referring_domain})};o.prototype.Tb=function(a){this.ub=this.Sa=a.cookie_expiration;this.Sc(a.disable_persistence);this.Rc(a.cross_subdomain_cookie);this.Uc(a.secure_cookie)};o.prototype.Sc=function(a){(this.disabled=a)&&this.remove()};o.prototype.Rc=function(a){if(a!==this.Pa)this.Pa=a,this.remove(),this.save()};
o.prototype.Dc=function(){return this.Pa};o.prototype.Uc=function(a){if(a!==this.Lb)this.Lb=a?m:s,this.remove(),this.save()};o.prototype.B=function(a,b){var d=this.Ha(a),e=b[a],f=this.Y("$set"),j=this.Y("$set_once"),g=this.Y("$add"),i=this.Y("$union"),h=this.Y("$append",[]);"__mps"===d?(c.extend(f,e),this.Q("$add",e),this.Q("$union",e)):"__mpso"===d?c.a(e,function(a,b){b in j||(j[b]=a)}):"__mpa"===d?c.a(e,function(a,b){b in f?f[b]+=a:(b in g||(g[b]=0),g[b]+=a)},this):"__mpu"===d?c.a(e,function(a,
b){c.isArray(a)&&(b in i||(i[b]=[]),i[b]=i[b].concat(a))}):"__mpap"===d&&h.push(e);n.log("MIXPANEL PEOPLE REQUEST (QUEUED, PENDING IDENTIFY):");n.log(b);this.save()};o.prototype.Q=function(a,b){var d=this.P(a);c.d(d)||(c.a(b,function(a,b){delete d[b]},this),this.save())};o.prototype.Ha=function(a){if("$set"===a)return"__mps";if("$set_once"===a)return"__mpso";if("$add"===a)return"__mpa";if("$append"===a)return"__mpap";if("$union"===a)return"__mpu";n.error("Invalid queue:",a)};o.prototype.P=function(a){return this.props[this.Ha(a)]};
...
else return a=F(a,b,d),t[d]=a,a.pa(),a};h.prototype.Ia=function(a,b,d){this.__loaded=m;this.config={};this.Mb(c.extend({},V,b,{name:d,token:a,callback_fn:("mixpanel"===d?d:"mixpanel."+d)+"._jsc"}));this._jsc=D();this.Ea=[];this.Fa=[];this.Da=[];this.X={disable_all_events:s,identify_called:s};this.persistence=this.cookie=new o(this.config);this.G({distinct_id:c.eb()},"")};h.prototype.pa=function(){this.e("loaded")(this);this.e("track_pageview")&&this.Rb()};h.prototype.dc=function(){c.a(this.Ea,function(a){this.La.apply(this,
a)},this);c.a(this.Fa,function(a){this.s.apply(this,a)},this);delete this.Ea;delete this.Fa};h.prototype.La=function(a,b){if(this.e("img"))return n.error("You can't use DOM tracking functions with img = true."),s;if(!L)return this.Ea.push([a,b]),s;var c=(new a).Wa(this);return c.U.apply(c,b)};h.prototype.Ja=function(a,b){if(c.d(a))return r;if(I)return function(c){a(c,b)};var d=this._jsc,e=""+Math.floor(1E8*Math.random()),f=this.e("callback_fn")+'["'+e+'"]';d[e]=function(c){delete d[e];a(c,b)};return f};
...
d)};q.prototype.Sb=function(a,b,d){var e={},f={};c.k(a)?(c.a(a,function(a,b){this.Z(b)||(f[b]=c.isArray(a)?a:[a])},this),d=b):f[a]=c.isArray(b)?b:[b];e.$union=f;return this.s(e,d)};q.prototype.Zc=function(a,b,d){if(!c.Ic(a)&&(a=parseFloat(a),isNaN(a))){n.error("Invalid value passed to mixpanel.people.track_charge - must be a number");return}return this.append("$transactions",c.extend({$amount:a},b),d)};q.prototype.uc=function(a){return this.set("$transactions",[],a)};q.prototype.wc=function(){if(this.ib())return this.s({$delete:this.c.R()});
n.error("mixpanel.people.delete_user() requires you to call identify() first")};q.prototype.toString=function(){return this.c.toString()+".people"};q.prototype.s=function(a,b){a.$token=this.oa("token");a.$distinct_id=this.c.R();var d=c.wb(a),e=c.truncate(d,255),d=c.la(d),d=c.pb(d);if(!this.ib())return this.ec(a),c.d(b)||(this.oa("verbose")?b({status:-1,error:r}):b(-1)),e;n.log("MIXPANEL PEOPLE REQUEST:");n.log(e);this.c.s(this.oa("api_host")+"/engage/",{data:d},this.c.Ja(b,e));return e};q.prototype.oa=
function(a){return this.c.e(a)};q.prototype.ib=function(){return this.c.X.yb===m};q.prototype.ec=function(a){"$set"in a?this.c.persistence.B("$set",a):"$set_once"in a?this.c.persistence.B("$set_once",a):"$add"in a?this.c.persistence.B("$add",a):"$append"in a?this.c.persistence.B("$append",a):"$union"in a?this.c.persistence.B("$union",a):n.error("Invalid call to _enqueue():",a)};q.prototype.gc=function(a,b,d,e,f){var j=this,g=c.extend({},this.c.persistence.P("$set")),i=c.extend({},this.c.persistence.P("$set_once")),
h=c.extend({},this.c.persistence.P("$add")),l=this.c.persistence.P("$append"),p=c.extend({},this.c.persistence.P("$union"));!c.d(g)&&c.k(g)&&!c.S(g)&&(j.c.persistence.Q("$set",g),this.set(g,function(b,d){0==b&&j.c.persistence.B("$set",g);c.d(a)||a(b,d)}));!c.d(i)&&c.k(i)&&!c.S(i)&&(j.c.persistence.Q("$set_once",i),this.Nb(i,function(a,b){0==a&&j.c.persistence.B("$set_once",i);c.d(e)||e(a,b)}));!c.d(h)&&c.k(h)&&!c.S(h)&&(j.c.persistence.Q("$add",h),this.Bb(h,function(a,d){0==a&&j.c.persistence.B("$add",
h);c.d(b)||b(a,d)}));!c.d(p)&&c.k(p)&&!c.S(p)&&(j.c.persistence.Q("$union",p),this.Sb(p,function(a,b){0==a&&j.c.persistence.B("$union",p);c.d(f)||f(a,b)}));if(!c.d(l)&&c.isArray(l)&&l.length){for(var n=l.length-1;0<=n;n--){var o=l.pop();j.append(o,function(a,b){0==a&&j.c.persistence.B("$append",o);c.d(d)||d(a,b)})}j.c.persistence.save()}};q.prototype.Z=function(a){return"$distinct_id"===a||"$token"===a};h.bc=function(a,b){c.qc(this);this.Za=b;this.ab=this.Za.persistence;this.F=c.u(a.id);this.Gb=c.u(a.message_id);
this.body=(c.u(a.body)||"").replace(/\n/g,"<br/>");this.vc=c.u(a.cta)||"Close";this.ca=c.u(a.cta_url)||r;this.Va=c.u(a.image_url)||r;this.da=c.u(a.type)||"takeover";this.style=c.u(a.style)||"light";this.K=c.u(a.thumb_image_url)||r;this.title=c.u(a.title)||"";this.za=c.u(a.video_url)||r;this.ia=g.ac;this.V=g.$b;this.ra=m;if(!this.ca)this.ca="#dismiss",this.ra=s;this.v="mini"===this.da;if(!this.v)this.da="takeover";this.Kc=!this.v?g.W:g.Aa;this.mb();this.ua=this.hc();this.kc()};var g=h.bc;g.L=200;g.z=
"mixpanel-notification";g.ja=0.6;g.I=25;g.ma=200;g.W=388;g.Aa=420;g.A=85;g.Ba=5;g.J=60;g.Ca=Math.round(g.J/2);g.ac=595;g.$b=334;g.prototype.show=function(){var a=this;this.mb();this.p?(this.jc(),this.ic(),this.lc(this.cc)):setTimeout(function(){a.show()},300)};g.prototype.Qa=c.o(function(){this.Fb||this.kb({invisible:m});var a=this.Vc?this.i("video"):this.O();if(this.Vb)this.mc("bg","visible"),this.M(a,"exiting"),setTimeout(this.lb,g.L);else{var b,c,e;this.v?(b="right",c=20,e=-100):(b="top",c=g.I,
e=g.ma+g.I);this.na([{q:this.i("bg"),m:"opacity",start:g.ja,l:0},{q:a,m:"opacity",start:1,l:0},{q:a,m:b,start:c,l:e}],g.L,this.lb)}});g.prototype.M=c.o(function(a,b){b=g.z+"-"+b;"string"===typeof a&&(a=this.i(a));a.className?~(" "+a.className+" ").indexOf(" "+b+" ")||(a.className+=" "+b):a.className=b});g.prototype.mc=c.o(function(a,b){b=g.z+"-"+b;"string"===typeof a&&(a=this.i(a));if(a.className)a.className=(" "+a.className+" ").replace(" "+b+" ","").replace(/^[\s\xA0]+/,"").replace(/[\s\xA0]+$/,
...
if(!this.Wc&&!this.hb()[this.F])this.Wc=m,this.p.appendChild(this.ea),setTimeout(function(){var b=a.O();if(a.Vb)a.v||a.M("bg","visible"),a.M(b,"visible"),a.jb();else{var c,e,f;a.v?(c="right",e=-100,f=20):(c="top",e=g.ma+g.I,f=g.I);a.na([{q:a.i("bg"),m:"opacity",start:0,l:g.ja},{q:b,m:"opacity",start:0,l:1},{q:b,m:c,start:e,l:f}],g.L,a.jb)}},100),c.D(a.i("cancel"),"click",function(b){b.preventDefault();a.Qa()}),c.D(a.i("button")||a.i("mini-content"),"click",function(b){b.preventDefault();a.T?(a.Ma("$campaign_open",
{$resource_type:"video"}),a.nc()):(a.Qa(),a.ra&&a.Ma("$campaign_open",{$resource_type:"link"},function(){window.location.href=a.ca}))})});g.prototype.i=function(a){return l.getElementById(g.z+"-"+a)};g.prototype.O=function(){return this.i(this.da)};g.prototype.hb=function(){return this.ab.props.__cmpns||(this.ab.props.__cmpns={})};g.prototype.N=function(a,b){return this.C[a]&&this.C[a]<=b};g.prototype.hc=function(){var a=[];this.v?(this.K=this.K||"//cdn.mxpnl.com/site_media/images/icons/notifications/mini-news-dark.png",
a.push(this.K)):(this.Va?(a.push(this.Va),this.zb='<img id="img" src="'+this.Va+'"/>'):this.zb="",this.K?(a.push(this.K),this.Pb='<div id="thumbborder-wrapper"><div id="thumbborder"></div></div><img id="thumbnail" src="'+this.K+'" width="'+g.J+'" height="'+g.J+'"/><div id="thumbspacer"></div>'):this.Pb="");return a};g.prototype.ic=function(){var a="",b="",c="";this.ea=l.createElement("div");this.ea.id=g.z+"-wrapper";if(this.v)a='<div id="mini"><div id="mainbox"><div id="cancel"><div id="cancel-icon"></div></div><div id="mini-content"><div id="mini-icon"><div id="mini-icon-img"></div></div><div id="body"><div id="body-text"><div>'+
...
this.Wb&&(b="//player.vimeo.com/video/"+this.Wb+"?autoplay=1&title=0&byline=0&portrait=0");if(this.T)this.fd='<iframe id="'+g.z+'-video-frame" width="'+this.ia+'" height="'+this.V+'"  src="'+b+'" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen="1" scrolling="no"></iframe>',c='<div id="video-'+(this.Ta?"":"no")+'flip"><div id="video"><div id="video-holder"></div>'+c+"</div></div>";b=c+a;this.Ta&&(b=(this.v?a:"")+'<div id="flipcontainer"><div id="flipper">'+(this.v?c:b)+"</div></div>");
this.ea.innerHTML=('<div id="overlay" class="'+this.da+'"><div id="campaignid-'+this.F+'"><div id="bgwrapper"><div id="bg"></div>'+b+"</div></div></div>").replace(/class=\"/g,'class="'+g.z+"-").replace(/id=\"/g,'id="'+g.z+"-")};g.prototype.jc=function(){this.h="dark"===this.style?{Oa:"#1d1f25",$:"#282b32",qa:"#3a4147",qb:"#4a5157",rc:"#32353c",tb:"0.4",Ya:"#2a3137",xa:"#fff",bb:"#9498a3",Ob:"#464851",wa:"#ddd"}:{Oa:"#fff",$:"#e7eaee",qa:"#eceff3",qb:"#f5f5f5",rc:"#e4ecf2",tb:"1.0",Ya:"#fafafa",xa:"#5c6578",
bb:"#8b949b",Ob:"#ced9e6",wa:"#7c8598"};var a="0px 0px 35px 0px rgba(45, 49, 56, 0.7)",b=a,d=a,e=g.J+2*g.Ba,f=g.L/1E3+"s";this.v&&(a="none");var h={};h["@media only screen and (max-width: "+(g.Aa+20-1)+"px)"]={"#overlay":{display:"none"}};a={".flipped":{transform:"rotateY(180deg)"},"#overlay":{position:"fixed",top:"0",left:"0",width:"100%",height:"100%",overflow:"auto","text-align":"center","z-index":"10000","font-family":'"Helvetica", "Arial", sans-serif',"-webkit-font-smoothing":"antialiased","-moz-osx-font-smoothing":"grayscale"},
...
a.ca=a.za;var b=a.za.match(/(?:youtube(?:-nocookie)?\.com\/(?:[^\/]+\/.+\/|(?:v|e(?:mbed)?)\/|.*[?&]v=)|youtu\.be\/)([^"&?\/ ]{11})/i),c=a.za.match(/vimeo\.com\/.*?(\d+)/i);if(b){if(a.T=m,a.Xb=b[1],a.Yb)window.onYouTubeIframeAPIReady=function(){a.i("video-frame")&&a.ob()},b=l.createElement("script"),b.src="//www.youtube.com/iframe_api",c=l.getElementsByTagName("script")[0],c.parentNode.insertBefore(b,c)}else if(c)a.T=m,a.Wb=c[1];if(a.N("ie",7)||a.N("firefox",3))a.T=s,a.ra=m}});g.prototype.jb=c.o(function(){function a(a,
b){var c={};if(l.defaultView&&l.defaultView.getComputedStyle)c=l.defaultView.getComputedStyle(a,r);else if(a.currentStyle)c=a.currentStyle;return c[b]}var b=this;c.D(b.i("bg"),"click",function(){b.Qa()});if(this.F){var d=this.i("overlay");d&&"hidden"!==a(d,"visibility")&&"none"!==a(d,"display")&&this.kb()}});g.prototype.kb=c.o(function(a){if(!this.Fb)this.Fb=m,this.F&&(this.hb()[this.F]=1*new Date,this.ab.save()),this.Ma("$campaign_delivery",a),this.Za.people.append({$campaigns:this.F,$notifications:{campaign_id:this.F,
message_id:this.Gb,type:"web",time:new Date}})});g.prototype.lc=function(a){var b=this;if(0===this.ua.length)a();else{for(var c=0,e=[],f=0;f<this.ua.length;f++){var g=new Image,h=function(){c++;c===b.ua.length&&a&&(a(),a=r)};g.onload=h;g.src=this.ua[f];g.complete&&h();e.push(g)}this.N("ie",7)&&setTimeout(function(){var b=m;for(f=0;f<e.length;f++)e[f].complete||(b=s);b&&a&&(a(),a=r)},500)}};g.prototype.lb=c.o(function(){window.clearInterval(this.oc);this.ea.style.visibility="hidden";this.p.removeChild(this.ea)});
g.prototype.mb=function(){function a(a){if(a in e)return m;if(!c)for(var a=a[0].toUpperCase()+a.slice(1),a=["O"+a,"Webkit"+a,"Moz"+a],b=0;b<a.length;b++)if(a[b]in e)return m;return s}function b(a){return(a=z.userAgent.match(a))&&a[1]}this.C={};this.C.chrome=b(/Chrome\/(\d+)/);this.C.firefox=b(/Firefox\/(\d+)/);this.C.ie=b(/MSIE (\d+).+/);!this.C.ie&&!window.ActiveXObject&&"ActiveXObject"in window&&(this.C.ie=11);if(this.p=l.body||l.getElementsByTagName("body")[0])this.zc=Math.max(this.p.scrollWidth,
...
g.prototype.nc=c.o(function(){function a(){window.YT&&window.YT.loaded&&b.ob();b.Vc=m;b.O().style.visibility="hidden"}var b=this,c=[{q:b.O(),m:"opacity",start:1,l:0},{q:b.O(),m:"top",start:g.I,l:-500},{q:b.i("video-noflip"),m:"opacity",start:0,l:1},{q:b.i("video-noflip"),m:"top",start:2*-b.V,l:0}];if(b.v){var e=b.i("bg"),f=b.i("overlay");e.style.width="100%";e.style.height="100%";f.style.width="100%";b.M(b.O(),"exiting");b.M(e,"visible");c.push({q:b.i("bg"),m:"opacity",start:0,l:g.ja})}b.i("video-holder").innerHTML=
b.fd;b.Ta?(b.M("flipper","flipped"),setTimeout(a,g.L)):b.na(c,g.L,a)});g.prototype.Ma=function(a,b,d){this.F?(b=b||{},b=c.extend(b,{campaign_id:this.F,message_id:this.Gb,message_type:"web_inapp",message_subtype:this.da}),this.Za.track(a,b,d)):d&&d.call()};g.prototype.ob=c.o(function(){var a=this;if(!a.gd){a.gd=m;var b=a.i("video-elapsed"),d=a.i("video-time"),e=a.i("video-progress");new window.YT.Player(g.z+"-video-frame",{events:{onReady:function(f){function g(a){var a=Math.round(i-a),b=Math.floor(a/
60),c=Math.floor(b/60),a=a-60*b;d.innerHTML="-"+(c?c+":":"")+("00"+(b-60*c)).slice(-2)+":"+("00"+a).slice(-2)}var h=f.target,i=h.getDuration();g(0);a.oc=window.setInterval(function(){var a=h.getCurrentTime();b.style.width=100*(a/i)+"%";g(a)},250);c.D(e,"click",function(a){a=Math.max(0,a.pageX-e.getBoundingClientRect().left);h.seekTo(i*a/e.clientWidth,m)})}}})}});c.toArray=c.ha;c.isObject=c.k;c.JSONEncode=c.la;c.JSONDecode=c.ka;c.isBlockedUA=c.Db;c.isEmptyObject=c.S;c.info=c.info;c.info.device=c.info.vb;
c.info.browser=c.info.aa;c.info.properties=c.info.fa;h.prototype.init=h.prototype.Wa;h.prototype.reset=h.prototype.reset;h.prototype.disable=h.prototype.disable;h.prototype.time_event=h.prototype.Yc;h.prototype.track=h.prototype.U;h.prototype.track_links=h.prototype.ad;h.prototype.track_forms=h.prototype.$c;h.prototype.track_pageview=h.prototype.Rb;h.prototype.register=h.prototype.ga;h.prototype.register_once=h.prototype.G;h.prototype.unregister=h.prototype.ya;h.prototype.identify=h.prototype.Ua;
h.prototype.alias=h.prototype.pc;h.prototype.name_tag=h.prototype.Jc;h.prototype.set_config=h.prototype.Mb;h.prototype.get_config=h.prototype.e;h.prototype.get_property=h.prototype.ta;h.prototype.get_distinct_id=h.prototype.R;h.prototype.toString=h.prototype.toString;h.prototype._check_and_handle_notifications=h.prototype.fb;h.prototype._show_notification=h.prototype.nb;o.prototype.properties=o.prototype.fa;o.prototype.update_search_keyword=o.prototype.Ub;o.prototype.update_referrer_info=o.prototype.cb;
