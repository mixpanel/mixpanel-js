...
(function(){function N(a){function b(){a.C.$__c=(a.C.$__c||0)+1;c.cookie.set("mp_"+e+"__c",a.C.$__c,1,n)}var d=["click","change"],e=a.e("name");a.C=a.C||{};a.C.$__c=parseInt(c.cookie.get("mp_"+e+"__c"))||0;b();for(var f=0;f<d.length;f++)c.J(m,d[f],function(){try{a.C=a.C||{},b()}catch(d){p.error(d)}})}function O(){function a(){if(!a.Bc)K=a.Bc=n,L=s,c.a(x,function(a){a.dc()})}function b(){try{m.documentElement.doScroll("left")}catch(d){setTimeout(b,1);return}a()}if(m.addEventListener)"complete"==m.readyState?
...
b+'"; falling back to "cookie"'),b=a.persistence="cookie";if(b="localStorage"===b){b=n;try{c.localStorage.set("__mplssupport__","xyz"),"xyz"!==c.localStorage.get("__mplssupport__")&&(b=s),c.localStorage.remove("__mplssupport__")}catch(d){b=s}b||p.error("localStorage unsupported; falling back to cookie store")}this.v=b?c.localStorage:c.cookie;this.load();this.Sb(a);this.bd(a);this.save()}function F(){this.Ib="submit"}function A(){this.Ib="click"}function w(){}var I,t,J=Array.prototype,R=Function.prototype,
...
function(a,b){setTimeout(function(){b.element.submit()},0)};l.prototype.fa=function(){var a={};c.a(this.props,function(b,d){c.zb(S,d)||(a[d]=b)});return a};l.prototype.load=function(){if(!this.disabled){var a=this.v.parse(this.name);a&&(this.props=c.extend({},a))}};l.prototype.bd=function(a){var b=a.upgrade,d;if(b)d="mp_super_properties","string"===typeof b&&(d=b),b=this.v.parse(d),this.v.remove(d),this.v.remove(d,n),b&&(this.props=c.extend(this.props,b.all,b.events));if(!a.cookie_name&&"mixpanel"!==
a.name&&(d="mp_"+a.token+"_"+a.name,b=this.v.parse(d)))this.v.remove(d),this.v.remove(d,n),this.H(b);this.v===c.localStorage&&(b=c.cookie.parse(this.name),c.cookie.remove(this.name),c.cookie.remove(this.name,n),b&&this.H(b))};l.prototype.save=function(){this.disabled||(this.fc(),this.v.set(this.name,c.la(this.props),this.Sa,this.Pa,this.Kb))};l.prototype.remove=function(){this.v.remove(this.name,s);this.v.remove(this.name,n)};l.prototype.clear=function(){this.remove();this.props={}};l.prototype.H=
...
a.cookie_expiration;this.Rc(a.disable_persistence);this.Qc(a.cross_subdomain_cookie);this.Tc(a.secure_cookie)};l.prototype.Rc=function(a){(this.disabled=a)&&this.remove()};l.prototype.Qc=function(a){if(a!==this.Pa)this.Pa=a,this.remove(),this.save()};l.prototype.Dc=function(){return this.Pa};l.prototype.Tc=function(a){if(a!==this.Kb)this.Kb=a?n:s,this.remove(),this.save()};l.prototype.A=function(a,b){var d=this.Ha(a),e=b[a],f=this.Y("$set"),k=this.Y("$set_once"),j=this.Y("$add"),i=this.Y("$union"),
...
"/engage/",{data:d},this.c.Ja(b,e));return e};o.prototype.oa=function(a){return this.c.e(a)};o.prototype.hb=function(){return this.c.X.xb===n};o.prototype.ec=function(a){"$set"in a?this.c.persistence.A("$set",a):"$set_once"in a?this.c.persistence.A("$set_once",a):"$add"in a?this.c.persistence.A("$add",a):"$append"in a?this.c.persistence.A("$append",a):"$union"in a?this.c.persistence.A("$union",a):p.error("Invalid call to _enqueue():",a)};o.prototype.gc=function(a,b,d,e,f){var g=this,j=c.extend({},
this.c.persistence.P("$set")),i=c.extend({},this.c.persistence.P("$set_once")),h=c.extend({},this.c.persistence.P("$add")),l=this.c.persistence.P("$append"),m=c.extend({},this.c.persistence.P("$union"));!c.d(j)&&c.k(j)&&!c.S(j)&&(g.c.persistence.Q("$set",j),this.set(j,function(b,d){0==b&&g.c.persistence.A("$set",j);c.d(a)||a(b,d)}));!c.d(i)&&c.k(i)&&!c.S(i)&&(g.c.persistence.Q("$set_once",i),this.Mb(i,function(a,b){0==a&&g.c.persistence.A("$set_once",i);c.d(e)||e(a,b)}));!c.d(h)&&c.k(h)&&!c.S(h)&&
(g.c.persistence.Q("$add",h),this.Ab(h,function(a,d){0==a&&g.c.persistence.A("$add",h);c.d(b)||b(a,d)}));!c.d(m)&&c.k(m)&&!c.S(m)&&(g.c.persistence.Q("$union",m),this.Rb(m,function(a,b){0==a&&g.c.persistence.A("$union",m);c.d(f)||f(a,b)}));if(!c.d(l)&&c.isArray(l)&&l.length){for(var o=l.length-1;0<=o;o--){var p=l.pop();g.append(p,function(a,b){0==a&&g.c.persistence.A("$append",p);c.d(d)||d(a,b)})}g.c.persistence.save()}};o.prototype.Z=function(a){return"$distinct_id"===a||"$token"===a};h.bc=function(a,
...
"takeover";this.Jc=!this.u?g.W:g.Aa;this.lb();this.ua=this.hc();this.kc()};var g=h.bc;g.L=200;g.w="mixpanel-notification";g.ja=0.6;g.G=25;g.ma=200;g.W=388;g.Aa=420;g.z=85;g.Ba=5;g.I=60;g.Ca=Math.round(g.I/2);g.ac=595;g.$b=334;g.prototype.show=function(){var a=this;this.lb();this.o?(this.jc(),this.ic(),this.lc(this.cc)):setTimeout(function(){a.show()},300)};g.prototype.Qa=c.m(function(){this.Eb||this.jb({invisible:n});var a=this.Uc?this.h("video"):this.O();if(this.Ub)this.mc("bg","visible"),this.M(a,
"exiting"),setTimeout(this.kb,g.L);else{var b,c,e;this.u?(b="right",c=20,e=-100):(b="top",c=g.G,e=g.ma+g.G);this.na([{p:this.h("bg"),l:"opacity",start:g.ja,i:0},{p:a,l:"opacity",start:1,i:0},{p:a,l:b,start:c,i:e}],g.L,this.kb)}});g.prototype.M=c.m(function(a,b){b=g.w+"-"+b;"string"===typeof a&&(a=this.h(a));a.className?~(" "+a.className+" ").indexOf(" "+b+" ")||(a.className+=" "+b):a.className=b});g.prototype.mc=c.m(function(a,b){b=g.w+"-"+b;"string"===typeof a&&(a=this.h(a));if(a.className)a.className=
...
"click",function(b){b.preventDefault();a.T?(a.Ma("$campaign_open",{$resource_type:"video"}),a.nc()):(a.Qa(),a.ra&&a.Ma("$campaign_open",{$resource_type:"link"},function(){window.location.href=a.ca}))})});g.prototype.h=function(a){return m.getElementById(g.w+"-"+a)};g.prototype.O=function(){return this.h(this.da)};g.prototype.gb=function(){return this.ab.props.__cmpns||(this.ab.props.__cmpns={})};g.prototype.N=function(a,b){return this.B[a]&&this.B[a]<=b};g.prototype.hc=function(){var a=[];this.u?
(this.K=this.K||"//cdn.mxpnl.com/site_media/images/icons/notifications/mini-news-dark.png",a.push(this.K)):(this.Va?(a.push(this.Va),this.yb='<img id="img" src="'+this.Va+'"/>'):this.yb="",this.K?(a.push(this.K),this.Ob='<div id="thumbborder-wrapper"><div id="thumbborder"></div></div><img id="thumbnail" src="'+this.K+'" width="'+g.I+'" height="'+g.I+'"/><div id="thumbspacer"></div>'):this.Ob="");return a};g.prototype.ic=function(){var a="",b="",c="";this.ea=m.createElement("div");this.ea.id=g.w+"-wrapper";
...
this.Vb&&(b="//player.vimeo.com/video/"+this.Vb+"?autoplay=1&title=0&byline=0&portrait=0");if(this.T)this.ed='<iframe id="'+g.w+'-video-frame" width="'+this.ia+'" height="'+this.V+'"  src="'+b+'" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen="1" scrolling="no"></iframe>',c='<div id="video-'+(this.Ta?"":"no")+'flip"><div id="video"><div id="video-holder"></div>'+c+"</div></div>";b=c+a;this.Ta&&(b=(this.u?a:"")+'<div id="flipcontainer"><div id="flipper">'+(this.u?c:b)+"</div></div>");
this.ea.innerHTML=('<div id="overlay" class="'+this.da+'"><div id="campaignid-'+this.D+'"><div id="bgwrapper"><div id="bg"></div>'+b+"</div></div></div>").replace(/class=\"/g,'class="'+g.w+"-").replace(/id=\"/g,'id="'+g.w+"-")};g.prototype.jc=function(){this.g="dark"===this.style?{Oa:"#1d1f25",$:"#282b32",qa:"#3a4147",pb:"#4a5157",rc:"#32353c",sb:"0.4",Ya:"#2a3137",xa:"#fff",bb:"#9498a3",Nb:"#464851",wa:"#ddd"}:{Oa:"#fff",$:"#e7eaee",qa:"#eceff3",pb:"#f5f5f5",rc:"#e4ecf2",sb:"1.0",Ya:"#fafafa",xa:"#5c6578",
...
"#mini":{position:"absolute",right:"20px",top:g.G+"px",width:this.Jc+"px",height:2*g.z+"px","margin-top":20-g.z+"px","backface-visibility":"hidden",opacity:"0.0",transform:"rotateX(90deg)",transition:"opacity 0.3s, transform 0.3s, right 0.3s"},"#mini.visible":{opacity:"1.0",transform:"rotateX(0deg)"},"#mini.exiting":{opacity:"0.0",right:"-150px"},"#mainbox":{"border-radius":"4px","box-shadow":a,"text-align":"center","background-color":this.g.Oa,"font-size":"14px",color:this.g.bb},"#mini #mainbox":{height:g.z+
"px","margin-top":g.z+"px","border-radius":"3px",transition:"background-color "+f},"#mini-border":{height:g.z+6+"px",width:g.Aa+6+"px",position:"absolute",top:"-3px",left:"-3px","margin-top":g.z+"px","border-radius":"6px",opacity:"0.25","background-color":"#fff","z-index":"-1","box-shadow":d},"#mini-icon":{position:"relative",display:"inline-block",width:"75px",height:g.z+"px","border-radius":"3px 0 0 3px","background-color":this.g.$,background:"linear-gradient(135deg, "+this.g.pb+" 0%, "+this.g.$+
" 100%)",transition:"background-color "+f},"#mini:hover #mini-icon":{"background-color":this.g.Ya},"#mini:hover #mainbox":{"background-color":this.g.Ya},"#mini-icon-img":{position:"absolute","background-image":"url("+this.K+")",width:"48px",height:"48px",top:"20px",left:"12px"},"#content":{padding:"30px 20px 0px 20px"},"#mini-content":{"text-align":"left",height:g.z+"px",cursor:"pointer"},"#img":{width:"328px","margin-top":"30px","border-radius":"5px"},"#title":{"max-height":"600px",overflow:"hidden",
...
b.ed;b.Ta?(b.M("flipper","flipped"),setTimeout(a,g.L)):b.na(c,g.L,a)});g.prototype.Ma=function(a,b,d){this.D?(b=b||{},b=c.extend(b,{campaign_id:this.D,message_id:this.Fb,message_type:"web_inapp",message_subtype:this.da}),this.Za.track(a,b,d)):d&&d.call()};g.prototype.nb=c.m(function(){var a=this;if(!a.fd){a.fd=n;var b=a.h("video-elapsed"),d=a.h("video-time"),e=a.h("video-progress");new window.YT.Player(g.w+"-video-frame",{events:{onReady:function(f){function g(a){var a=Math.round(i-a),b=Math.floor(a/
