...
P.Fd()?P.aa(e):(e.__autotrack_enabled=D,s.log("Disabling Automatic Event Collection because this browser is not supported")):(e.__autotrack_enabled=D,s.log("Not in active bucket: disabling Automatic Event Collection."));!c.e(g)&&c.isArray(g)&&(e.Wa.call(e.people,g.people),e.Wa(g));return e}function n(){}function f(){}function q(a){this.props={};this.Rb=D;this.name=a.persistence_name?"mp_"+a.persistence_name:"mp_"+a.token+"_mixpanel";var b=a.persistence;if("cookie"!==b&&"localStorage"!==b)s.Z("Unknown persistence type "+
b+"; falling back to cookie"),b=a.persistence="cookie";this.w="localStorage"===b&&c.localStorage.sb()?c.localStorage:c.cookie;this.load();this.Cc(a);this.ge(a);this.save()}function U(){this.mc="submit"}function K(){this.mc="click"}function E(){}function u(){}function ea(a){if(a===w)return w;switch(typeof a){case "object":if(c.O(a)&&0<=a.getTime())return a.getTime();break;case "boolean":return Number(a);case "number":return a;case "string":return a=Number(a),!isNaN(a)?a:0}return w}function Q(a){if(a===
...
function(a){return this.c(a)})}function H(a){return fa(a,function(a){return this.M(a)})}function M(a){return fa(a,function(a){return this.M(a)})}function Fa(a,b){b=b||{};Y(b).remove(Z(a,b),!!b.Wb)}function Y(a){a=a||{};return"localStorage"===a.oc?c.localStorage:c.cookie}function Z(a,b){b=b||{};return(b.nc||Ga)+a}function Ea(a){var a=a&&a.window||t,b=a.navigator||{},d=D;c.a([b.doNotTrack,b.msDoNotTrack,a.doNotTrack],function(a){c.h([p,1,"1","yes"],a)&&(d=p)});return d}function la(a,b,d){!c.oa(b)||
...
c.Ed=function(a){return!(!a||!$.call(a,"callee"))};c.sa=function(a){return!a?[]:a.sa?a.sa():c.isArray(a)||c.Ed(a)?N.call(a):c.je(a)};c.keys=function(a){var b=[];if(a===w)return b;c.a(a,function(a,c){b[b.length]=c});return b};c.je=function(a){var b=[];if(a===w)return b;c.a(a,function(a){b[b.length]=a});return b};c.re=function(a){return a};c.cc=function(a,b){var d=D;if(a===w)return d;if(pa&&a.indexOf===pa)return-1!=a.indexOf(b);c.a(a,function(a){if(d||(d=a===b))return ha});return d};c.h=function(a,
b){return-1!==a.indexOf(b)};c.ec=function(a,b){a.prototype=new b;a.Yd=b.prototype};c.g=function(a){return a===Object(a)&&!c.isArray(a)};c.T=function(a){if(c.g(a)){for(var b in a)if($.call(a,b))return D;return p}return D};c.e=function(a){return a===l};c.oa=function(a){return"[object String]"==R.call(a)};c.O=function(a){return"[object Date]"==R.call(a)};c.gc=function(a){return"[object Number]"==R.call(a)};c.Gd=function(a){return!!(a&&1===a.nodeType)};c.kb=function(a){c.a(a,function(b,d){c.O(b)?a[d]=
...
c.Nd=function(a){for(var b=["identify","_check_and_handle_notifications","_show_notification"],d=0;d<b.length;d++)a.prototype[b[d]]=c.m(a.prototype[b[d]])};c.Od=function(a){for(var b in a)"function"===typeof a[b]&&(a[b]=c.m(a[b]))};c.La=function(a){var b={};c.a(a,function(a,e){c.oa(a)&&0<a.length&&(b[e]=a)});return b};c.truncate=function(a,b){var d;"string"===typeof a?d=a.slice(0,b):c.isArray(a)?(d=[],c.a(a,function(a){d.push(c.truncate(a,b))})):c.g(a)?(d={},c.a(a,function(a,g){d[g]=c.truncate(a,
...
"")+"-"+a()+"-"+d+"-"+b()}}();c.fc=function(a){return/(google web preview|baiduspider|yandexbot|bingbot|googlebot|yahoo! slurp)/i.test(a)?p:D};c.Ic=function(a){var b,d,e,g=[];c.e(b)&&(b="&");c.a(a,function(a,b){d=encodeURIComponent(a.toString());e=encodeURIComponent(b);g[g.length]=e+"="+d});return g.join(b)};c.ac=function(a,b){var b=b.replace(/[\[]/,"\\[").replace(/[\]]/,"\\]"),d=RegExp("[\\?&]"+b+"=([^&#]*)").exec(a);return d===w||d&&"string"!==typeof d[1]&&d[1].length?"":decodeURIComponent(d[1]).replace(/\+/g,
...
{sb:function(){if(ia!==w)return ia;var a=p;try{c.localStorage.set("__mplssupport__","xyz"),"xyz"!==c.localStorage.get("__mplssupport__")&&(a=D),c.localStorage.remove("__mplssupport__")}catch(b){a=D}a||s.error("localStorage unsupported; falling back to cookie store");return ia=a},error:function(a){s.error("localStorage error: "+a)},get:function(a){try{return window.localStorage.getItem(a)}catch(b){c.localStorage.error(b)}return w},parse:function(a){try{return c.xa(c.localStorage.get(a))||{}}catch(b){}return w},
...
""},Qb:function(a,b,d){b={"Internet Explorer Mobile":/rv:(\d+(\.\d+)?)/,"Microsoft Edge":/Edge\/(\d+(\.\d+)?)/,Chrome:/Chrome\/(\d+(\.\d+)?)/,"Chrome iOS":/CriOS\/(\d+(\.\d+)?)/,"UC Browser":/(UCBrowser|UCWEB)\/(\d+(\.\d+)?)/,Safari:/Version\/(\d+(\.\d+)?)/,"Mobile Safari":/Version\/(\d+(\.\d+)?)/,Opera:/(Opera|OPR)\/(\d+(\.\d+)?)/,Firefox:/Firefox\/(\d+(\.\d+)?)/,"Firefox iOS":/FxiOS\/(\d+(\.\d+)?)/,Konqueror:/Konqueror:(\d+(\.\d+)?)/,BlackBerry:/BlackBerry (\d+(\.\d+)?)/,"Android Mobile":/android\s(\d+(\.\d+)?)/,
"Internet Explorer":/(rv:|MSIE )(\d+(\.\d+)?)/,Mozilla:/rv:(\d+(\.\d+)?)/}[c.info.la(a,b,d)];if(b===l)return w;a=a.match(b);return!a?w:parseFloat(a[a.length-2])},vb:function(){return/Windows/i.test(z)?/Phone/.test(z)||/WPDesktop/.test(z)?"Windows Phone":"Windows":/(iPhone|iPad|iPod)/.test(z)?"iOS":/Android/.test(z)?"Android":/(BlackBerry|PlayBook|BB10)/i.test(z)?"BlackBerry":/Mac/i.test(z)?"Mac OS X":/Linux/.test(z)?"Linux":/CrOS/.test(z)?"Chrome OS":""},Zb:function(a){return/Windows Phone/i.test(a)||
/WPDesktop/.test(a)?"Windows Phone":/iPad/.test(a)?"iPad":/iPod/.test(a)?"iPod Touch":/iPhone/.test(a)?"iPhone":/(BlackBerry|PlayBook|BB10)/i.test(a)?"BlackBerry":/Android/.test(a)?"Android":""},pc:function(a){a=a.split("/");return 3<=a.length?a[2]:""},ra:function(){return c.extend(c.La({$os:c.info.vb(),$browser:c.info.la(z,O.vendor,S),$referrer:o.referrer,$referring_domain:c.info.pc(o.referrer),$device:c.info.Zb(z)}),{$current_url:t.location.href,$browser_version:c.info.Qb(z,O.vendor,S),$screen_height:aa.height,
$screen_width:aa.width,mp_lib:"web",$lib_version:"2.27.1",time:c.timestamp()/1E3})},Kd:function(){return c.extend(c.La({$os:c.info.vb(),$browser:c.info.la(z,O.vendor,S)}),{$browser_version:c.info.Qb(z,O.vendor,S)})},Jd:function(a){return c.La({mp_page:a,mp_referrer:o.referrer,mp_browser:c.info.la(z,O.vendor,S),mp_platform:c.info.vb()})}};c.toArray=c.sa;c.isObject=c.g;c.JSONEncode=c.ea;c.JSONDecode=c.xa;c.isBlockedUA=c.fc;c.isEmptyObject=c.T;c.info=c.info;c.info.device=c.info.Zb;c.info.browser=c.info.la;
c.info.properties=c.info.ra;var P={Hb:[],hd:function(a){if(a.previousElementSibling)return a.previousElementSibling;do a=a.previousSibling;while(a&&!(a&&1===a.nodeType));return a},dd:function(a,b){var d=document.createElement("script");d.type="text/javascript";d.src=a;d.onload=b;var c=document.getElementsByTagName("script");0<c.length?c[0].parentNode.insertBefore(d,c[0]):document.body.appendChild(d)},Yc:function(a){var b={classes:V(a).split(" "),tag_name:a.tagName.toLowerCase()};W(a)&&c.a(a.attributes,
function(a){if(X(a.value))b["attr__"+a.name]=a.value});for(var d=1,e=1,g=a;g=this.hd(g);)d++,g.tagName===a.tagName&&e++;b.nth_child=d;b.nth_of_type=e;return b},Fb:function(a){return{$event_type:a,$ce_version:1,$host:window.location.host,$pathname:window.location.pathname}},Tc:function(a){var b=[];c.a(document.querySelectorAll(a.css_selector),function(a){var c;-1<["input","select"].indexOf(a.tagName.toLowerCase())?c=a.value:a.textContent&&(c=a.textContent);X(c)&&b.push(c)});return b.join(", ")},Wc:function(a){var b=
...
f=b&&X(f)&&f);b=V(a).split(" ");c.h(b,"mp-no-track")&&(i=p);j.push(this.Yc(a))},this);if(i)return D;var h;(d=za(d))&&d.length&&(h=d);e=c.extend(this.Fb(a.type),{$elements:j,$el_attr__href:f,$el_text:h},this.Wc(e));b.p("$web_event",e);return p}},me:function(a){window.location.href=a},Mc:function(a){var b=c.bind(function(b){b=b||window.event;this.ld(b,a)},this);c.J(document,"submit",b,D,p);c.J(document,"change",b,D,p);c.J(document,"click",b,D,p)},Cb:{},aa:function(a){if(!document||!document.body){console.log("document not ready yet, trying again in 500 milliseconds...");
var b=this;setTimeout(function(){b.aa(a)},500)}else{var d=a.c("token");if(-1<this.Hb.indexOf(d))console.log('autotrack already initialized for token "'+d+'"');else if(this.Hb.push(d),!this.fd(a)){var e=c.bind(function(b){if(b&&b.config&&b.config.enable_collect_everything===p){if(b.custom_properties)this.Cb=b.custom_properties;a.p("$web_event",c.extend({$title:document.title},this.Fb("pageview")));this.Mc(a)}else a.__autotrack_enabled=D},this);a.i(a.c("api_host")+"/decide/",{verbose:p,version:"1",
...
var d=c.kb(a),e=c.truncate(d,255),d=c.ea(d),d=c.gb(d);console.log(a);this.d.i(this.d.c("api_host")+"/groups/",{data:d},this.d.ja(b,e));return e};u.prototype.N=function(a){return"$group_key"===a||"$group_id"===a};u.prototype.M=function(a){return this.d.c(a)};u.prototype.toString=function(){return this.d.toString()+".group."+this.Za+"."+this.Ya};u.prototype.remove=u.prototype.remove;u.prototype.set=u.prototype.set;u.prototype.set_once=u.prototype.Ka;u.prototype.union=u.prototype.ta;u.prototype.unset=
...
save_referrer:p,test:D,verbose:D,img:D,track_pageview:p,debug:D,track_links_timeout:300,cookie_expiration:365,upgrade:D,disable_persistence:D,disable_cookie:D,secure_cookie:D,ip:p,opt_out_tracking_by_default:D,opt_out_persistence_by_default:D,opt_out_tracking_persistence_type:"localStorage",opt_out_tracking_cookie_prefix:w,property_blacklist:[],xhr_headers:{},inapp_protocol:"//",inapp_link_new_window:D},ja=D;E.prototype.Ga=J();E.prototype.lb=J();E.prototype.fb=J();E.prototype.aa=function(a){this.jc=
a;return this};E.prototype.p=function(a,b,d,e){var g=this,j=c.xd(a);if(0===j.length)s.error("The DOM query ("+a+") returned 0 elements");else return c.a(j,function(a){c.J(a,this.mc,function(a){var c={},j=g.Ga(d,this),f=g.jc.c("track_links_timeout");g.lb(a,this,c);t.setTimeout(g.yc(e,j,c,p),f);g.jc.p(b,j,g.yc(e,j,c))})},this),p};E.prototype.yc=function(a,b,d,c){var c=c||D,g=this;return function(){if(!d.rd)d.rd=p,a&&a(c,b)===D||g.fb(b,d,c)}};E.prototype.Ga=function(a,b){return"function"===typeof a?
a(b):c.extend({},a)};c.ec(K,E);K.prototype.Ga=function(a,b){var d=K.Yd.Ga.apply(this,arguments);if(b.href)d.url=b.href;return d};K.prototype.lb=function(a,b,d){d.kc=2===a.which||a.metaKey||a.ctrlKey||"_blank"===b.target;d.href=b.href;d.kc||a.preventDefault()};K.prototype.fb=function(a,b){b.kc||setTimeout(function(){t.location=b.href},0)};c.ec(U,E);U.prototype.lb=function(a,b,d){d.element=b;a.preventDefault()};U.prototype.fb=function(a,b){setTimeout(function(){b.element.submit()},0)};q.prototype.ra=
function(){var a={};c.a(this.props,function(b,d){c.cc(Ia,d)||(a[d]=b)});return a};q.prototype.load=function(){if(!this.disabled){var a=this.w.parse(this.name);a&&(this.props=c.extend({},a))}};q.prototype.ge=function(a){var b=a.upgrade,d;if(b)d="mp_super_properties","string"===typeof b&&(d=b),b=this.w.parse(d),this.w.remove(d),this.w.remove(d,p),b&&(this.props=c.extend(this.props,b.all,b.events));if(!a.cookie_name&&"mixpanel"!==a.name&&(d="mp_"+a.token+"_"+a.name,b=this.w.parse(d)))this.w.remove(d),
this.w.remove(d,p),this.G(b);this.w===c.localStorage&&(b=c.cookie.parse(this.name),c.cookie.remove(this.name),c.cookie.remove(this.name,p),b&&this.G(b))};q.prototype.save=function(){this.disabled||(this.Sc(),this.w.set(this.name,c.ea(this.props),this.mb,this.ib,this.rc))};q.prototype.remove=function(){this.w.remove(this.name,D);this.w.remove(this.name,p)};q.prototype.clear=function(){this.remove();this.props={}};q.prototype.G=function(a,b,d){return c.g(a)?("undefined"===typeof b&&(b="None"),this.mb=
"undefined"===typeof d?this.Xb:d,c.a(a,function(a,d){if(!this.props.hasOwnProperty(d)||this.props[d]===b)this.props[d]=a},this),this.save(),p):D};q.prototype.v=function(a,b){return c.g(a)?(this.mb="undefined"===typeof b?this.Xb:b,c.extend(this.props,a),this.save(),p):D};q.prototype.ua=function(a){a in this.props&&(delete this.props[a],this.save())};q.prototype.Sc=c.m(function(){var a=this.props.__cmpns,b=G?6E4:36E5;if(a){for(var d in a)1*new Date-a[d]>b&&delete a[d];c.T(a)&&delete this.props.__cmpns}});
q.prototype.fe=function(){if(!this.Rb)this.G(c.info.sd()),this.Rb=p};q.prototype.Dc=function(a){this.v(c.info.Qd(a))};q.prototype.yb=function(a){this.G({$initial_referrer:a||"$direct",$initial_referring_domain:c.info.pc(a)||"$direct"},"")};q.prototype.Dd=function(){return c.La({$initial_referrer:this.props.$initial_referrer,$initial_referring_domain:this.props.$initial_referring_domain})};q.prototype.Cc=function(a){this.Xb=this.mb=a.cookie_expiration;this.uc(a.disable_persistence);this.Sd(a.cross_subdomain_cookie);
this.Vd(a.secure_cookie)};q.prototype.uc=function(a){(this.disabled=a)?this.remove():this.save()};q.prototype.Sd=function(a){if(a!==this.ib)this.ib=a,this.remove(),this.save()};q.prototype.Bd=function(){return this.ib};q.prototype.Vd=function(a){if(a!==this.rc)this.rc=a?p:D,this.remove(),this.save()};q.prototype.C=function(a,b){var d=this.Xa(a),e=b[a],g=this.Q("$set"),j=this.Q("$set_once"),f=this.Q("$unset"),i=this.Q("$add"),h=this.Q("$union"),n=this.Q("$remove",[]),r=this.Q("$append",[]);"__mps"===
...
255),g=c.ea(e),g=c.gb(g);s.log("MIXPANEL REQUEST:");s.log(e);this.i(this.c("api_host")+"/track/",{data:g},this.ja(d,e));this.Oc(a);return e}});f.prototype.Ud=I(function(a,b,d){c.isArray(b)||(b=[b]);var e={};e[a]=b;this.v(e);return this.people.set(a,b,d)});f.prototype.nd=I(function(a,b,d){var c=this.F(a);if(c===l){var g={};g[a]=[b];this.v(g)}else-1===c.indexOf(b)&&(c.push(b),this.v(g));return this.people.ta(a,b,d)});f.prototype.Md=I(function(a,b,d){var c=this.F(a);if(c!==l){var g=c.indexOf(b);-1<g&&
(c.splice(g,1),this.v({qe:c}));0===c.length&&this.ua(a)}return this.people.remove(a,b,d)});f.prototype.ee=I(function(a,b,d,e){var g=c.extend({},b||{});c.a(d,function(a,b){a!==w&&a!==l&&(g[b]=a)});return this.p(a,g,e)});f.prototype.Pc=function(a,b){return a+"_"+JSON.stringify(b)};f.prototype.Cd=function(a,b){var d=this.Pc(a,b),c=this.Ab[d];if(c===l||c.Za!==a||c.Ya!==b)c=new u,c.ia(this,a,b),this.Ab[d]=c;return c};f.prototype.zc=function(a){if(c.e(a))a=o.location.href;this.p("mp_page_view",c.info.Jd(a))};
f.prototype.de=function(){return this.bb.call(this,K,arguments)};f.prototype.ce=function(){return this.bb.call(this,U,arguments)};f.prototype.Zd=function(a){c.e(a)?s.error("No event name provided to mixpanel.time_event"):this.Eb(a)||this.persistence.Td(a)};f.prototype.v=function(a,b){this.persistence.v(a,b)};f.prototype.G=function(a,b,d){this.persistence.G(a,b,d)};f.prototype.ua=function(a){this.persistence.ua(a)};f.prototype.Kb=function(a,b){var d={};d[a]=b;this.v(d)};f.prototype.ob=function(a,b,
d,c,g,f,h,i){var n=this.S();this.v({$user_id:a});this.F("$device_id")||this.G({$had_persisted_distinct_id:p,$device_id:n},"");a!==n&&a!==this.F("__alias")&&(this.ua("__alias"),this.v({distinct_id:a}));this.Bb(this.S());this.X.pb=p;this.people.Uc(b,d,c,g,f,h,i)};f.prototype.reset=function(){this.persistence.clear();this.X.pb=D;var a=c.zb();this.G({distinct_id:a,$device_id:a},"")};f.prototype.S=function(){return this.F("distinct_id")};f.prototype.od=function(a,b){if(a===this.F("$people_distinct_id"))return s.Z("Attempting to create alias for existing People user - aborting."),
-2;var d=this;c.e(b)&&(b=this.S());if(a!==b)return this.Kb("__alias",a),this.p("$create_alias",{alias:a,distinct_id:b},function(){d.ob(a)});s.error("alias matches current distinct_id - skipping api call.");this.ob(a);return-1};f.prototype.Hd=function(a){this.Kb("mp_name_tag",a)};f.prototype.tc=function(a){if(c.g(a))c.extend(this.config,a),this.c("persistence_name")||(this.config.persistence_name=this.config.cookie_name),this.c("disable_persistence")||(this.config.disable_persistence=this.config.disable_cookie),
this.persistence&&this.persistence.Cc(this.config),G=G||this.c("debug")};f.prototype.c=function(a){return this.config[a]};f.prototype.F=function(a){return this.persistence.props[a]};f.prototype.toString=function(){var a=this.c("name");"mixpanel"!==a&&(a="mixpanel."+a);return a};f.prototype.Eb=function(a){return c.fc(z)||this.X.ud||c.cc(this.Ta,a)};f.prototype.Oc=I(function(a){for(var b=this.eb,d=0;d<b.length;d++)if((new h(b[d],this)).ed(a)){this.ab(b[d]);break}});f.prototype.Bb=I(function(a){a&&!this.X.pb&&
!this.c("disable_notifications")&&(s.log("MIXPANEL NOTIFICATION CHECK"),this.i(this.c("api_host")+"/decide/",{verbose:p,version:"3",lib:"web",token:this.c("token"),distinct_id:a},this.ja(c.bind(function(a){if(a.notifications&&0<a.notifications.length){this.eb=[];var d=[];c.a(a.notifications,function(a){(a.display_triggers&&0<a.display_triggers.length?this.eb:d).push(a)},this);0<d.length&&this.ab.call(this,d[0])}},this))))});f.prototype.ab=function(a){(new h(a,this)).show()};f.prototype.Vc=function(){"localStorage"===
this.c("opt_out_tracking_persistence_type")&&c.localStorage.sb()&&(!this.Ha()&&this.Ha({persistence_type:"cookie"})&&this.lc({enable_persistence:D}),!this.na()&&this.na({persistence_type:"cookie"})&&this.ub({clear_persistence:D}),this.Ub({persistence_type:"cookie",enable_persistence:D}));if(this.na())this.Aa({clear_persistence:p});else if(!this.Ha()&&(this.c("opt_out_tracking_by_default")||c.cookie.get("mp_optout")))c.cookie.remove("mp_optout"),this.ub({clear_persistence:this.c("opt_out_persistence_by_default")})};
f.prototype.Aa=function(a){if(a&&a.clear_persistence)a=p;else if(a&&a.enable_persistence)a=D;else return;!this.c("disable_persistence")&&this.persistence.disabled!==a&&this.persistence.uc(a)};f.prototype.ha=function(a,b){b=c.extend({track:c.bind(this.p,this),persistence_type:this.c("opt_out_tracking_persistence_type"),cookie_prefix:this.c("opt_out_tracking_cookie_prefix"),cookie_expiration:this.c("cookie_expiration"),cross_subdomain_cookie:this.c("cross_subdomain_cookie"),secure_cookie:this.c("secure_cookie")},
b);c.localStorage.sb()||(b.persistence_type="cookie");return a(this.c("token"),{p:b.track,$d:b.track_event_name,ae:b.track_properties,oc:b.persistence_type,nc:b.cookie_prefix,Vb:b.cookie_expiration,Wb:b.cross_subdomain_cookie,Rd:b.secure_cookie})};f.prototype.lc=function(a){a=c.extend({enable_persistence:p},a);this.ha(Ba,a);this.Aa(a)};f.prototype.ub=function(a){a=c.extend({clear_persistence:p,delete_user:p},a);a.delete_user&&this.people&&this.people.$a()&&(this.people.Yb(),this.people.Tb());this.ha(Ca,
a);this.Aa(a)};f.prototype.Ha=function(a){return this.ha(Da,a)};f.prototype.na=function(a){return this.ha(ma,a)};f.prototype.Ub=function(a){a=c.extend({enable_persistence:p},a);this.ha(Fa,a);this.Aa(a)};n.prototype.ia=function(a){this.d=a};n.prototype.set=H(function(a,b,d){var e=this.sc(a,b);c.g(a)&&(d=b);this.M("save_referrer")&&this.d.persistence.yb(o.referrer);e.$set=c.extend({},c.info.Kd(),this.d.persistence.Dd(),e.$set);return this.i(e,d)});n.prototype.Ka=H(function(a,b,d){var e=this.vc(a,b);
c.g(a)&&(d=b);return this.i(e,d)});n.prototype.Oa=H(function(a,b){return this.i(this.Bc(a),b)});n.prototype.dc=H(function(a,b,d){var e={},g={};c.g(a)?(c.a(a,function(a,b){this.N(b)||(isNaN(parseFloat(a))?s.error("Invalid increment value passed to mixpanel.people.increment - must be a number"):g[b]=a)},this),d=b):(c.e(b)&&(b=1),g[a]=b);e.$add=g;return this.i(e,d)});n.prototype.append=H(function(a,b,d){c.g(a)&&(d=b);return this.i(this.pd(a,b),d)});n.prototype.remove=H(function(a,b,d){c.g(a)&&(d=b);
return this.i(this.qc(a,b),d)});n.prototype.ta=H(function(a,b,d){c.g(a)&&(d=b);return this.i(this.Ac(a,b),d)});n.prototype.be=H(function(a,b,d){if(!c.gc(a)&&(a=parseFloat(a),isNaN(a))){s.error("Invalid value passed to mixpanel.people.track_charge - must be a number");return}return this.append("$transactions",c.extend({$amount:a},b),d)});n.prototype.Tb=function(a){return this.set("$transactions",[],a)};n.prototype.Yb=function(){if(this.$a())return this.i({$delete:this.d.S()});s.error("mixpanel.people.delete_user() requires you to call identify() first")};
n.prototype.toString=function(){return this.d.toString()+".people"};n.prototype.i=function(a,b){a.$token=this.M("token");a.$distinct_id=this.d.S();var d=this.d.F("$device_id"),e=this.d.F("$user_id"),g=this.d.F("$had_persisted_distinct_id");d&&(a.$device_id=d);e&&(a.$user_id=e);g&&(a.$had_persisted_distinct_id=g);e=c.kb(a);d=c.truncate(e,255);e=c.ea(e);e=c.gb(e);if(!this.$a())return this.Rc(a),c.e(b)||(this.M("verbose")?b({status:-1,error:w}):b(-1)),d;s.log("MIXPANEL PEOPLE REQUEST:");s.log(d);this.d.i(this.M("api_host")+
"/engage/",{data:e},this.d.ja(b,d));return d};n.prototype.M=function(a){return this.d.c(a)};n.prototype.$a=function(){return this.d.X.pb===p};n.prototype.Rc=function(a){"$set"in a?this.d.persistence.C("$set",a):"$set_once"in a?this.d.persistence.C("$set_once",a):"$unset"in a?this.d.persistence.C("$unset",a):"$add"in a?this.d.persistence.C("$add",a):"$append"in a?this.d.persistence.C("$append",a):"$remove"in a?this.d.persistence.C("$remove",a):"$union"in a?this.d.persistence.C("$union",a):s.error("Invalid call to _enqueue():",
a)};n.prototype.ga=function(a,b,d,e){var g=this,f=c.extend({},this.d.persistence.Ba(a)),h=f;!c.e(f)&&c.g(f)&&!c.T(f)&&(g.d.persistence.H(a,f),e&&(h=e(f)),b.call(g,h,function(b,e){0===b&&g.d.persistence.C(a,f);c.e(d)||d(b,e)}))};n.prototype.Uc=function(a,b,d,e,g,f,h){var i=this,n=this.d.persistence.Ba("$append"),o=this.d.persistence.Ba("$remove");this.ga("$set",this.set,a);this.ga("$set_once",this.Ka,e);this.ga("$unset",this.Oa,f,function(a){return c.keys(a)});this.ga("$add",this.dc,b);this.ga("$union",
...
a};f.Lc=function(a,b){c.Pb(this);this.ba=b;this.wb=this.ba.persistence;this.Ja=this.ba.c("inapp_protocol");this.Ea=this.ba.c("cdn");this.I=c.R(a.id);this.ic=c.R(a.message_id);this.body=(c.R(a.body)||"").replace(/\n/g,"<br/>");this.td=c.R(a.cta)||"Close";this.pa=c.R(a.type)||"takeover";this.style=c.R(a.style)||"light";this.title=c.R(a.title)||"";this.va=h.Kc;this.da=h.Jc;this.$b=a.display_triggers||[];this.$=a.cta_url||w;this.qb=a.image_url||w;this.z=a.thumb_image_url||w;this.Pa=a.video_url||w;if(this.z&&
0===this.z.indexOf("//"))this.z=this.z.replace("//",this.Ja);this.Fa=p;if(!this.$)this.$="#dismiss",this.Fa=D;this.u="mini"===this.pa;if(!this.u)this.pa="takeover";this.Id=!this.u?h.fa:h.Qa;this.Mb();this.Ia=this.Zc();this.bd()};h=f.Lc;h.U=200;h.A="mixpanel-notification";h.wa=0.6;h.L=25;h.ya=200;h.fa=388;h.Qa=420;h.B=85;h.Ra=5;h.P=60;h.Sa=Math.round(h.P/2);h.Kc=595;h.Jc=334;h.prototype.show=function(){var a=this;this.Mb();this.q?(this.ad(),this.$c(),this.gd(this.Nc)):setTimeout(function(){a.show()},
300)};h.prototype.jb=c.m(function(){this.hc||this.Jb({invisible:p});var a=this.Wd?this.k("video"):this.Y();if(this.Ec)this.jd("bg","visible"),this.V(a,"exiting"),setTimeout(this.Lb,h.U);else{var b,d,c;this.u?(b="right",d=20,c=-100):(b="top",d=h.L,c=h.ya+h.L);this.za([{s:this.k("bg"),o:"opacity",start:h.wa,l:0},{s:a,o:"opacity",start:1,l:0},{s:a,o:b,start:d,l:c}],h.U,this.Lb)}});h.prototype.V=c.m(function(a,b){b=h.A+"-"+b;"string"===typeof a&&(a=this.k(a));a.className?~(" "+a.className+" ").indexOf(" "+
b+" ")||(a.className+=" "+b):a.className=b});h.prototype.jd=c.m(function(a,b){b=h.A+"-"+b;"string"===typeof a&&(a=this.k(a));if(a.className)a.className=(" "+a.className+" ").replace(" "+b+" ","").replace(/^[\s\xA0]+/,"").replace(/[\s\xA0]+$/,"")});h.prototype.za=c.m(function(a,b,d,c){var g=this,f=D,h,i;h=1*new Date;var n,c=c||h;n=h-c;for(h=0;h<a.length;h++){i=a[h];if("undefined"===typeof i.K)i.K=i.start;if(i.K!==i.l){var f=p,o=i.l>=i.start?1:-1;i.K=i.start+(i.l-i.start)*n/b;if("opacity"!==i.o)i.K=
Math.round(i.K);if(0<o&&i.K>=i.l||0>o&&i.K<=i.l)i.K=i.l}}if(f){for(h=0;h<a.length;h++)i=a[h],i.s&&(i.s.style[i.o]=""+i.K+("opacity"===i.o?"":"px"));setTimeout(function(){g.za(a,b,d,c)},10)}else d&&d()});h.prototype.Nc=c.m(function(){var a=this;if(!this.Xd&&!this.Gb()[this.I])this.Xd=p,this.q.appendChild(this.qa),setTimeout(function(){var b=a.Y();if(a.Ec)a.u||a.V("bg","visible"),a.V(b,"visible"),a.Ib();else{var d,c,g;a.u?(d="right",c=-100,g=20):(d="top",c=h.ya+h.L,g=h.L);a.za([{s:a.k("bg"),o:"opacity",
start:0,l:h.wa},{s:b,o:"opacity",start:0,l:1},{s:b,o:d,start:c,l:g}],h.U,a.Ib)}},100),c.J(a.k("cancel"),"click",function(b){b.preventDefault();a.jb()}),c.J(a.k("button")||a.k("mini-content"),"click",function(b){b.preventDefault();a.ca?(a.cb("$campaign_open",{$resource_type:"video"}),a.kd()):(a.jb(),a.Fa&&(b=w,a.ba.c("inapp_link_new_window")?t.open(a.$):b=function(){t.location.href=a.$},a.cb("$campaign_open",{$resource_type:"link"},b)))})});h.prototype.k=function(a){return o.getElementById(h.A+"-"+
a)};h.prototype.Y=function(){return this.k(this.pa)};h.prototype.Gb=function(){return this.wb.props.__cmpns||(this.wb.props.__cmpns={})};h.prototype.ed=c.m(function(a){for(var b=a.event||"",d=0;d<this.$b.length;d++){var e=this.$b[d];if("$any_event"===(e.event||"")||b===e.event)if(e.selector&&!c.T(e.selector)){if(x(e.selector,a.properties))return p}else return p}return D});h.prototype.W=function(a,b){return this.D[a]&&this.D[a]<=b};h.prototype.Zc=function(){var a=[];this.u?(this.z=this.z||this.Ea+
"/site_media/images/icons/notifications/mini-news-dark.png",a.push(this.z)):(this.qb?(a.push(this.qb),this.bc='<img id="img" src="'+this.qb+'"/>'):this.bc="",this.z?(a.push(this.z),this.xc='<div id="thumbborder-wrapper"><div id="thumbborder"></div></div><img id="thumbnail" src="'+this.z+'" width="'+h.P+'" height="'+h.P+'"/><div id="thumbspacer"></div>'):this.xc="");return a};h.prototype.$c=function(){var a="",b="",d="";this.qa=o.createElement("div");this.qa.id=h.A+"-wrapper";if(this.u)a='<div id="mini"><div id="mainbox"><div id="cancel"><div id="cancel-icon"></div></div><div id="mini-content"><div id="mini-icon"><div id="mini-icon-img"></div></div><div id="body"><div id="body-text"><div>'+
this.body+'</div></div></div></div></div><div id="mini-border"></div></div>';else{var a=this.Fa||this.ca?"":'<div id="button-close"></div>',c=this.ca?'<div id="button-play"></div>':"";this.W("ie",7)&&(c=a="");a='<div id="takeover">'+this.xc+'<div id="mainbox"><div id="cancel"><div id="cancel-icon"></div></div><div id="content">'+this.bc+'<div id="title">'+this.title+'</div><div id="body">'+this.body+'</div><div id="tagline"><a href="http://mixpanel.com?from=inapp" target="_blank">POWERED BY MIXPANEL</a></div></div><div id="button">'+
a+'<a id="button-link" href="'+this.$+'">'+this.td+"</a>"+c+"</div></div></div>"}this.Gc?(b=this.Ja+"www.youtube.com/embed/"+this.Gc+"?wmode=transparent&showinfo=0&modestbranding=0&rel=0&autoplay=1&loop=0&vq=hd1080",this.Hc&&(b+="&enablejsapi=1&html5=1&controls=0",d='<div id="video-controls"><div id="video-progress" class="video-progress-el"><div id="video-progress-total" class="video-progress-el"></div><div id="video-elapsed" class="video-progress-el"></div></div><div id="video-time" class="video-progress-el"></div></div>')):
this.Fc&&(b=this.Ja+"player.vimeo.com/video/"+this.Fc+"?autoplay=1&title=0&byline=0&portrait=0");if(this.ca)this.ke='<iframe id="'+h.A+'-video-frame" width="'+this.va+'" height="'+this.da+'"  src="'+b+'" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen="1" scrolling="no"></iframe>',d='<div id="video-'+(this.nb?"":"no")+'flip"><div id="video"><div id="video-holder"></div>'+d+"</div></div>";b=d+a;this.nb&&(b=(this.u?a:"")+'<div id="flipcontainer"><div id="flipper">'+(this.u?
d:b)+"</div></div>");this.qa.innerHTML=('<div id="overlay" class="'+this.pa+'"><div id="campaignid-'+this.I+'"><div id="bgwrapper"><div id="bg"></div>'+b+"</div></div></div>").replace(/class=\"/g,'class="'+h.A+"-").replace(/id=\"/g,'id="'+h.A+"-")};h.prototype.ad=function(){this.j="dark"===this.style?{hb:"#1d1f25",ka:"#282b32",Da:"#3a4147",Ob:"#4a5157",qd:"#32353c",Sb:"0.4",tb:"#2a3137",Na:"#fff",xb:"#9498a3",wc:"#464851",Ma:"#ddd"}:{hb:"#fff",ka:"#e7eaee",Da:"#eceff3",Ob:"#f5f5f5",qd:"#e4ecf2",Sb:"1.0",
tb:"#fafafa",Na:"#5c6578",xb:"#8b949b",wc:"#ced9e6",Ma:"#7c8598"};var a="0px 0px 35px 0px rgba(45, 49, 56, 0.7)",b=a,d=a,e=h.P+2*h.Ra,g=h.U/1E3+"s";this.u&&(a="none");var f={};f["@media only screen and (max-width: "+(h.Qa+20-1)+"px)"]={"#overlay":{display:"none"}};a={".flipped":{transform:"rotateY(180deg)"},"#overlay":{position:"fixed",top:"0",left:"0",width:"100%",height:"100%",overflow:"auto","text-align":"center","z-index":"10000","font-family":'"Helvetica", "Arial", sans-serif',"-webkit-font-smoothing":"antialiased",
...
"vertical-align":"middle"},"#tagline":{"margin-bottom":"15px","font-size":"10px","font-weight":"600","letter-spacing":"0.8px",color:"#ccd7e0","text-align":"left"},"#tagline a":{color:this.j.wc,transition:"color "+g},"#tagline a:hover":{color:this.j.Ma},"#cancel":{position:"absolute",right:"0",width:"8px",height:"8px",padding:"10px","border-radius":"20px",margin:"12px 12px 0 0","box-sizing":"content-box",cursor:"pointer",transition:"background-color "+g},"#mini #cancel":{margin:"7px 7px 0 0"},"#cancel-icon":{width:"8px",
...
c.replace(/#/g,"#"+h.A+"-").replace(/\./g,"."+h.A+"-"),b=b+("\n"+e+" {"),e=a[c],g;for(g in e)b+=g+":"+e[g]+";";b+="}"}return b}var c=d(a)+function(a){var b="",c;for(c in a)b+="\n"+c+" {"+d(a[c])+"\n}";return b}(b),e=o.head||o.getElementsByTagName("head")[0]||o.documentElement,g=o.createElement("style");e.appendChild(g);g.setAttribute("type","text/css");g.styleSheet?g.styleSheet.cssText=c:g.textContent=c})(a,f)};h.prototype.bd=c.m(function(){if(this.Pa){var a=this;a.Hc="postMessage"in t;a.$=a.Pa;var b=
a.Pa.match(/(?:youtube(?:-nocookie)?\.com\/(?:[^\/]+\/.+\/|(?:v|e(?:mbed)?)\/|.*[?&]v=)|youtu\.be\/)([^"&?\/ ]{11})/i),c=a.Pa.match(/vimeo\.com\/.*?(\d+)/i);if(b){if(a.ca=p,a.Gc=b[1],a.Hc)t.onYouTubeIframeAPIReady=function(){a.k("video-frame")&&a.Nb()},b=o.createElement("script"),b.src=a.Ja+"www.youtube.com/iframe_api",c=o.getElementsByTagName("script")[0],c.parentNode.insertBefore(b,c)}else if(c)a.ca=p,a.Fc=c[1];if(a.W("ie",7)||a.W("firefox",3))a.ca=D,a.Fa=p}});h.prototype.Ib=c.m(function(){function a(a,
b){var c={};if(o.defaultView&&o.defaultView.getComputedStyle)c=o.defaultView.getComputedStyle(a,w);else if(a.currentStyle)c=a.currentStyle;return c[b]}var b=this;c.J(b.k("bg"),"click",function(){b.jb()});if(this.I){var d=this.k("overlay");d&&"hidden"!==a(d,"visibility")&&"none"!==a(d,"display")&&this.Jb()}});h.prototype.Jb=c.m(function(a){if(!this.hc)this.hc=p,this.I&&(this.Gb()[this.I]=1*new Date,this.wb.save()),this.cb("$campaign_delivery",a),this.ba.people.append({$campaigns:this.I,$notifications:{campaign_id:this.I,
message_id:this.ic,type:"web",time:new Date}})});h.prototype.gd=function(a){var b=this;if(0===this.Ia.length)a();else{for(var c=0,e=[],g=function(){c++;c===b.Ia.length&&a&&(a(),a=w)},f=0;f<this.Ia.length;f++){var h=new Image;h.onload=g;h.src=this.Ia[f];h.complete&&g();e.push(h)}this.W("ie",7)&&setTimeout(function(){var b=p;for(f=0;f<e.length;f++)e[f].complete||(b=D);b&&a&&(a(),a=w)},500)}};h.prototype.Lb=c.m(function(){t.clearInterval(this.md);this.qa.style.visibility="hidden";this.q.removeChild(this.qa)});
h.prototype.Mb=function(){function a(a){if(a in e)return p;if(!c)for(var a=a[0].toUpperCase()+a.slice(1),a=["O"+a,"Webkit"+a,"Moz"+a],b=0;b<a.length;b++)if(a[b]in e)return p;return D}function b(a){return(a=navigator.userAgent.match(a))&&a[1]}this.D={};this.D.chrome=b(/Chrome\/(\d+)/);this.D.firefox=b(/Firefox\/(\d+)/);this.D.ie=b(/MSIE (\d+).+/);!this.D.ie&&!t.ActiveXObject&&"ActiveXObject"in t&&(this.D.ie=11);if(this.q=o.body||o.getElementsByTagName("body")[0])this.wd=Math.max(this.q.scrollWidth,
o.documentElement.scrollWidth,this.q.offsetWidth,o.documentElement.offsetWidth,this.q.clientWidth,o.documentElement.clientWidth),this.vd=Math.max(this.q.scrollHeight,o.documentElement.scrollHeight,this.q.offsetHeight,o.documentElement.offsetHeight,this.q.clientHeight,o.documentElement.clientHeight);var c=this.D.ie,e=o.createElement("div").style;this.Ec=this.q&&a("transition")&&a("transform");this.nb=(33<=this.D.chrome||15<=this.D.firefox)&&this.q&&a("backfaceVisibility")&&a("perspective")&&a("transform")};
h.prototype.kd=c.m(function(){function a(){t.YT&&t.YT.loaded&&b.Nb();b.Wd=p;b.Y().style.visibility="hidden"}var b=this,c=[{s:b.Y(),o:"opacity",start:1,l:0},{s:b.Y(),o:"top",start:h.L,l:-500},{s:b.k("video-noflip"),o:"opacity",start:0,l:1},{s:b.k("video-noflip"),o:"top",start:2*-b.da,l:0}];if(b.u){var e=b.k("bg"),g=b.k("overlay");e.style.width="100%";e.style.height="100%";g.style.width="100%";b.V(b.Y(),"exiting");b.V(e,"visible");c.push({s:b.k("bg"),o:"opacity",start:0,l:h.wa})}b.k("video-holder").innerHTML=
b.ke;b.nb?(b.V("flipper","flipped"),setTimeout(a,h.U)):b.za(c,h.U,a)});h.prototype.cb=function(a,b,d){this.I?(b=b||{},b=c.extend(b,{campaign_id:this.I,message_id:this.ic,message_type:"web_inapp",message_subtype:this.pa}),this.ba.track(a,b,d)):d&&d.call()};h.prototype.Nb=c.m(function(){var a=this;if(!a.le){a.le=p;var b=a.k("video-elapsed"),d=a.k("video-time"),e=a.k("video-progress");new t.YT.Player(h.A+"-video-frame",{events:{onReady:function(g){function f(a){var a=Math.round(i-a),b=Math.floor(a/60),
c=Math.floor(b/60),a=a-60*b;d.innerHTML="-"+(c?c+":":"")+("00"+(b-60*c)).slice(-2)+":"+("00"+a).slice(-2)}var h=g.target,i=h.getDuration();f(0);a.md=t.setInterval(function(){var a=h.getCurrentTime();b.style.width=100*(a/i)+"%";f(a)},250);c.J(e,"click",function(a){a=Math.max(0,a.pageX-e.getBoundingClientRect().left);h.seekTo(i*a/e.clientWidth,p)})}}})}});f.prototype.init=f.prototype.aa;f.prototype.reset=f.prototype.reset;f.prototype.disable=f.prototype.disable;f.prototype.time_event=f.prototype.Zd;
f.prototype.track=f.prototype.p;f.prototype.track_links=f.prototype.de;f.prototype.track_forms=f.prototype.ce;f.prototype.track_pageview=f.prototype.zc;f.prototype.register=f.prototype.v;f.prototype.register_once=f.prototype.G;f.prototype.unregister=f.prototype.ua;f.prototype.identify=f.prototype.ob;f.prototype.alias=f.prototype.od;f.prototype.name_tag=f.prototype.Hd;f.prototype.set_config=f.prototype.tc;f.prototype.get_config=f.prototype.c;f.prototype.get_property=f.prototype.F;f.prototype.get_distinct_id=
f.prototype.S;f.prototype.toString=f.prototype.toString;f.prototype._check_and_handle_notifications=f.prototype.Bb;f.prototype._show_notification=f.prototype.ab;f.prototype.opt_out_tracking=f.prototype.ub;f.prototype.opt_in_tracking=f.prototype.lc;f.prototype.has_opted_out_tracking=f.prototype.na;f.prototype.has_opted_in_tracking=f.prototype.Ha;f.prototype.clear_opt_in_out_tracking=f.prototype.Ub;f.prototype.get_group=f.prototype.Cd;f.prototype.set_group=f.prototype.Ud;f.prototype.add_group=f.prototype.nd;
f.prototype.remove_group=f.prototype.Md;f.prototype.track_with_groups=f.prototype.ee;q.prototype.properties=q.prototype.ra;q.prototype.update_search_keyword=q.prototype.Dc;q.prototype.update_referrer_info=q.prototype.yb;q.prototype.get_cross_subdomain=q.prototype.Bd;q.prototype.clear=q.prototype.clear;n.prototype.set=n.prototype.set;n.prototype.set_once=n.prototype.Ka;n.prototype.unset=n.prototype.Oa;n.prototype.increment=n.prototype.dc;n.prototype.append=n.prototype.append;n.prototype.remove=n.prototype.remove;
n.prototype.union=n.prototype.ta;n.prototype.track_charge=n.prototype.be;n.prototype.clear_charges=n.prototype.Tb;n.prototype.delete_user=n.prototype.Yb;n.prototype.toString=n.prototype.toString;c.Nd(f);var F={};(function(){da=1;y=t.mixpanel;c.e(y)?s.Z('"mixpanel" object not initialized. Ensure you are using the latest version of the Mixpanel JS Library along with the snippet we provide.'):y.__loaded||y.config&&y.persistence?s.error("Mixpanel library has already been downloaded at least once."):1.1>
