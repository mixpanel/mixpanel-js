...
(function(){function V(a){function b(){try{a.D=a.D||{},a.D.$__c=(a.D.$__c||0)+1,c.cookie.set("mp_"+d+"__c",a.D.$__c,1,m)}catch(b){k.error(b)}}var d=a.c("name");a.D=a.D||{};a.D.$__c=parseInt(c.cookie.get("mp_"+d+"__c"))||0;c.o(document,"submit",b);c.o(document,"change",b);var e=n;c.o(document,"mousedown",function(a){e=a.target});c.o(document,"mouseup",function(a){a.target===e&&b()})}function W(){function a(){if(!a.Yc)Q=a.Yc=m,R=r,c.a(y,function(a){a.oc()})}function b(){try{document.documentElement.doScroll("left")}catch(d){setTimeout(b,
...
b="mpeditor"===d.action;var e=!!window.sessionStorage.getItem("_mpcehash"),f;b?f=this.nb(a,window.location.hash):e?(f=this.nb(a,window.sessionStorage.getItem("_mpcehash")),window.sessionStorage.removeItem("_mpcehash")):f=JSON.parse(window.sessionStorage.getItem("editorParams")||"{}");return f.projectToken&&a.c("token")===f.projectToken?(this.Dc(a,f),m):r}catch(j){return r}},Dc:function(a,b){if(!window._mpEditorLoaded){window._mpEditorLoaded=m;var c="?_ts="+(new Date).getTime(),e=a.c("app_host")+"/site_media";
this.Ec(z?e+"/compiled/reports/collect-everything/editor.js"+c:e+"/bundle-webpack/reports/collect-everything/editor.min.js"+c,function(){window.mp_load_editor(b)});return m}return r},Zc:function(a,b,d){for(var b=!c.d(b)?b:10,d=!c.d(d)?d:10,e=0,f=0;f<a.length;f++)e+=a.charCodeAt(f);return e%b<d},dd:function(){return c.bb(document.querySelectorAll)}};c.Cb(F);c.od(F);var L,s,Z="__mps,__mpso,__mpa,__mpap,__mpu,$people_distinct_id,__alias,__cmpns,__timers".split(",");w="https:"===document.location.protocol?
"https://":"http://";var K=window.XMLHttpRequest&&"withCredentials"in new XMLHttpRequest,R=!K&&-1===t.indexOf("MSIE")&&-1===t.indexOf("Mozilla"),P={api_host:w+"api.mixpanel.com",app_host:w+"mixpanel.com",autotrack:m,cdn:w+"cdn.mxpnl.com",cross_subdomain_cookie:m,persistence:"cookie",persistence_name:"",cookie_name:"",loaded:B(),store_google:m,save_referrer:m,test:r,verbose:r,img:r,track_pageview:m,debug:r,track_links_timeout:300,cookie_expiration:365,upgrade:r,disable_persistence:r,disable_cookie:r,
secure_cookie:r,ip:m,property_blacklist:[]};P.decide_host=P.api_host;var Q=r;x.prototype.wa=B();x.prototype.Wa=B();x.prototype.Sa=B();x.prototype.U=function(a){this.Rb=a;return this};x.prototype.I=function(a,b,d,e){var f=this,j=c.Xc(a);if(0===j.length)k.error("The DOM query ("+a+") returned 0 elements");else return c.a(j,function(a){c.o(a,this.Tb,function(a){var c={},j=f.wa(d,this),g=f.Rb.c("track_links_timeout");f.Wa(a,this,c);window.setTimeout(f.$b(e,j,c,m),g);f.Rb.I(b,j,f.$b(e,j,c))})},this),m};
...
b.href},0)};c.Nb(I,x);I.prototype.Wa=function(a,b,c){c.element=b;a.preventDefault()};I.prototype.Sa=function(a,b){setTimeout(function(){b.element.submit()},0)};o.prototype.ha=function(){var a={};c.a(this.props,function(b,d){c.Lb(Z,d)||(a[d]=b)});return a};o.prototype.load=function(){if(!this.disabled){var a=this.v.parse(this.name);a&&(this.props=c.extend({},a))}};o.prototype.Dd=function(a){var b=a.upgrade,d;if(b)d="mp_super_properties","string"===typeof b&&(d=b),b=this.v.parse(d),this.v.remove(d),
