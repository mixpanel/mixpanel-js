...
(e.__autotrack_enabled=r,q.log("Disabling Automatic Event Collection because this browser is not supported")):(e.__autotrack_enabled=r,q.log("Not in active bucket: disabling Automatic Event Collection."));!c.d(f)&&c.isArray(f)&&(e.La.call(e.people,f.people),e.La(f));return e}function n(){}function h(){}function p(a){this.props={};this.Hb=r;this.name=a.persistence_name?"mp_"+a.persistence_name:"mp_"+a.token+"_mixpanel";var b=a.persistence;if("cookie"!==b&&"localStorage"!==b)q.T("Unknown persistence type "+
b+"; falling back to cookie"),b=a.persistence="cookie";this.v="localStorage"===b&&c.localStorage.hb()?c.localStorage:c.cookie;this.load();this.pc(a);this.Md(a);this.save()}function M(){this.bc="submit"}function D(){this.bc="click"}function y(){}function N(a){switch(typeof a.className){case "string":return a.className;case "object":return a.className.Td||a.getAttribute("class")||"";default:return""}}function ka(a){var b="";O(a)&&a.childNodes&&a.childNodes.length&&c.a(a.childNodes,function(a){a&&3===
...
"")}},q={log:function(){if(A&&!c.d(x)&&x)try{x.log.apply(x,arguments)}catch(a){c.a(arguments,function(a){x.log(a)})}},error:function(){if(A&&!c.d(x)&&x){var a=["Mixpanel error:"].concat(c.ka(arguments));try{x.error.apply(x,a)}catch(b){c.a(a,function(a){x.error(a)})}}},T:function(){if(!c.d(x)&&x){var a=["Mixpanel error:"].concat(c.ka(arguments));try{x.error.apply(x,a)}catch(b){c.a(a,function(a){x.error(a)})}}}};c.bind=function(a,b){var d,e;if(W&&a.bind===W)return W.apply(a,G.call(arguments,1));if(!c.gb(a))throw new TypeError;
d=G.call(arguments,2);return e=function(){if(!(this instanceof e))return a.apply(b,d.concat(G.call(arguments)));var c={};c.prototype=a.prototype;var j=new c;c.prototype=m;c=a.apply(j,d.concat(G.call(arguments)));return Object(c)===c?c:j}};c.Fb=function(a){for(var b in a)"function"===typeof a[b]&&(a[b]=c.bind(a[b],a))};c.a=function(a,b,d){if(!(a===m||void 0===a))if(fa&&a.forEach===fa)a.forEach(b,d);else if(a.length===+a.length)for(var c=0,f=a.length;c<f&&!(c in a&&b.call(d,a[c],c,a)===X);c++);else for(c in a)if(S.call(a,
c)&&b.call(d,a[c],c,a)===X)break};c.K=function(a){a&&c.za(a)&&(a=a.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"));return a};c.extend=function(a){c.a(G.call(arguments,1),function(b){for(var d in b)void 0!==b[d]&&(a[d]=b[d])});return a};c.isArray=B||function(a){return"[object Array]"===J.call(a)};c.gb=function(a){try{return/^\s*\bfunction\b/.test(a)}catch(b){return r}};c.ld=function(a){return!(!a||!S.call(a,"callee"))};c.ka=function(a){return!a?
...
return function(a){g=a;k=0;i=" ";a=s();b();i&&j("Syntax error");return a}}();c.Db=function(a){var b,d,e,f,j=0,k=0,i="",i=[];if(!a)return a;a=c.Nd(a);do b=a.charCodeAt(j++),d=a.charCodeAt(j++),e=a.charCodeAt(j++),f=b<<16|d<<8|e,b=f>>18&63,d=f>>12&63,e=f>>6&63,f&=63,i[k++]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(b)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(d)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(e)+
...
"Konqueror":c.e(a,"Firefox")?"Firefox":c.e(a,"MSIE")||c.e(a,"Trident/")?"Internet Explorer":c.e(a,"Gecko")?"Mozilla":""},Gb:function(a,b,d){b={"Internet Explorer Mobile":/rv:(\d+(\.\d+)?)/,"Microsoft Edge":/Edge\/(\d+(\.\d+)?)/,Chrome:/Chrome\/(\d+(\.\d+)?)/,"Chrome iOS":/CriOS\/(\d+(\.\d+)?)/,"UC Browser":/(UCBrowser|UCWEB)\/(\d+(\.\d+)?)/,Safari:/Version\/(\d+(\.\d+)?)/,"Mobile Safari":/Version\/(\d+(\.\d+)?)/,Opera:/(Opera|OPR)\/(\d+(\.\d+)?)/,Firefox:/Firefox\/(\d+(\.\d+)?)/,"Firefox iOS":/FxiOS\/(\d+(\.\d+)?)/,
Konqueror:/Konqueror:(\d+(\.\d+)?)/,BlackBerry:/BlackBerry (\d+(\.\d+)?)/,"Android Mobile":/android\s(\d+(\.\d+)?)/,"Internet Explorer":/(rv:|MSIE )(\d+(\.\d+)?)/,Mozilla:/rv:(\d+(\.\d+)?)/}[c.info.ca(a,b,d)];if(void 0===b)return m;a=a.match(b);return!a?m:parseFloat(a[a.length-2])},lb:function(){return/Windows/i.test(w)?/Phone/.test(w)||/WPDesktop/.test(w)?"Windows Phone":"Windows":/(iPhone|iPad|iPod)/.test(w)?"iOS":/Android/.test(w)?"Android":/(BlackBerry|PlayBook|BB10)/i.test(w)?"BlackBerry":/Mac/i.test(w)?
"Mac OS X":/Linux/.test(w)?"Linux":/CrOS/.test(w)?"Chrome OS":""},Ob:function(a){return/Windows Phone/i.test(a)||/WPDesktop/.test(a)?"Windows Phone":/iPad/.test(a)?"iPad":/iPod/.test(a)?"iPod Touch":/iPhone/.test(a)?"iPhone":/(BlackBerry|PlayBook|BB10)/i.test(a)?"BlackBerry":/Android/.test(a)?"Android":""},ec:function(a){a=a.split("/");return 3<=a.length?a[2]:""},ia:function(){return c.extend(c.Aa({$os:c.info.lb(),$browser:c.info.ca(w,H.vendor,K),$referrer:o.referrer,$referring_domain:c.info.ec(o.referrer),
$device:c.info.Ob(w)}),{$current_url:t.location.href,$browser_version:c.info.Gb(w,H.vendor,K),$screen_height:T.height,$screen_width:T.width,mp_lib:"web",$lib_version:"2.22.3"})},sd:function(){return c.extend(c.Aa({$os:c.info.lb(),$browser:c.info.ca(w,H.vendor,K)}),{$browser_version:c.info.Gb(w,H.vendor,K)})},rd:function(a){return c.Aa({mp_page:a,mp_referrer:o.referrer,mp_browser:c.info.ca(w,H.vendor,K),mp_platform:c.info.lb()})}};c.toArray=c.ka;c.isObject=c.k;c.JSONEncode=c.oa;c.JSONDecode=c.na;c.isBlockedUA=
c.Vb;c.isEmptyObject=c.fb;c.info=c.info;c.info.device=c.info.Ob;c.info.browser=c.info.ca;c.info.properties=c.info.ia;var I={wb:[],Sc:function(a){if(a.previousElementSibling)return a.previousElementSibling;do a=a.previousSibling;while(a&&!(a&&1===a.nodeType));return a},Pc:function(a,b){var c=document.createElement("script");c.type="text/javascript";c.src=a;c.onload=b;var e=document.getElementsByTagName("script");0<e.length?e[0].parentNode.insertBefore(c,e[0]):document.body.appendChild(c)},Ic:function(a){var b=
{classes:N(a).split(" "),tag_name:a.tagName.toLowerCase()};O(a)&&c.a(a.attributes,function(a){if(P(a.value))b["attr__"+a.name]=a.value});for(var d=1,e=1,f=a;f=this.Sc(f);)d++,f.tagName===a.tagName&&e++;b.nth_child=d;b.nth_of_type=e;return b},ub:function(a){return{$event_type:a,$ce_version:1,$host:window.location.host,$pathname:window.location.pathname}},Ec:function(a){var b=[];c.a(document.querySelectorAll(a.css_selector),function(a){var c;-1<["input","select"].indexOf(a.tagName.toLowerCase())?c=
a.value:a.textContent&&(c=a.textContent);P(c)&&b.push(c)});return b.join(", ")},Gc:function(a){var b={};c.a(this.rb,function(d){c.a(d.event_selectors,function(e){e=document.querySelectorAll(e);c.a(e,function(f){c.e(a,f)&&O(f)&&(b[d.name]=this.Ec(d))},this)},this)},this);return b},Hc:function(a){return"undefined"===typeof a.target?a.srcElement:a.target},Vc:function(a,b){var d=this.Hc(a);if(d&&3===d.nodeType)d=d.parentNode;if(la(d,a)){for(var e=[d],f=d;f.parentNode&&!E(f,"body");)e.push(f.parentNode),
f=f.parentNode;var j=[],g,i=r;c.a(e,function(a){var b=O(a);"a"===a.tagName.toLowerCase()&&(g=a.getAttribute("href"),g=b&&P(g)&&g);b=N(a).split(" ");c.e(b,"mp-no-track")&&(i=l);j.push(this.Ic(a))},this);if(i)return r;var h;(d=ka(d))&&d.length&&(h=d);e=c.extend(this.ub(a.type),{$elements:j,$el_attr__href:g,$el_text:h},this.Gc(e));b.s("$web_event",e);return l}},Rd:function(a){window.location.href=a},zc:function(a){var b=c.bind(function(b){b=b||window.event;this.Vc(b,a)},this);c.C(document,"submit",b,
r,l);c.C(document,"change",b,r,l);c.C(document,"click",b,r,l)},rb:{},V:function(a){if(!document||!document.body){console.log("document not ready yet, trying again in 500 milliseconds...");var b=this;setTimeout(function(){b.V(a)},500)}else{var d=a.c("token");if(-1<this.wb.indexOf(d))console.log('autotrack already initialized for token "'+d+'"');else if(this.wb.push(d),!this.Qc(a)){var e=c.bind(function(b){if(b&&b.config&&b.config.enable_collect_everything===l){if(b.custom_properties)this.rb=b.custom_properties;
a.s("$web_event",c.extend({$title:document.title},this.ub("pageview")));this.zc(a)}else a.__autotrack_enabled=r},this);a.m(a.c("api_host")+"/decide/",{verbose:l,version:"1",lib:"web",token:d},a.sa(e))}}},sb:function(a,b){var d;try{var e=c.ea(b,"state"),e=JSON.parse(decodeURIComponent(e)),f=c.ea(b,"expires_in");d={accessToken:c.ea(b,"access_token"),accessTokenExpiresAt:(new Date).getTime()+1E3*Number(f),bookmarkletMode:!!e.bookmarkletMode,projectId:e.projectId,projectOwnerId:e.projectOwnerId,projectToken:e.token,
...
b="mpeditor"===d.action;var e=!!window.sessionStorage.getItem("_mpcehash"),f;b?f=this.sb(a,window.location.hash):e?(f=this.sb(a,window.sessionStorage.getItem("_mpcehash")),window.sessionStorage.removeItem("_mpcehash")):f=JSON.parse(window.sessionStorage.getItem("editorParams")||"{}");return f.projectToken&&a.c("token")===f.projectToken?(this.Oc(a,f),l):r}catch(j){return r}},Oc:function(a,b){return!window._mpEditorLoaded?(window._mpEditorLoaded=l,this.Pc(a.c("app_host")+"/js-bundle/reports/collect-everything/editor.js?_ts="+
(new Date).getTime(),function(){window.mp_load_editor(b)}),l):r},gd:function(a,b,d){for(var b=!c.d(b)?b:10,d=!c.d(d)?d:10,e=0,f=0;f<a.length;f++)e+=a.charCodeAt(f);return e%b<d},md:function(){return c.gb(document.querySelectorAll)}};c.Fb(I);c.vd(I);var qa="__mp_opt_in_out_",V,v,ra="__mps,__mpso,__mpus,__mpa,__mpap,__mpu,$people_distinct_id,__alias,__cmpns,__timers".split(","),U=t.XMLHttpRequest&&"withCredentials"in new XMLHttpRequest,$=!U&&-1===w.indexOf("MSIE")&&-1===w.indexOf("Mozilla"),sa={api_host:"https://api.mixpanel.com",
...
Z=r;y.prototype.wa=C();y.prototype.Ya=C();y.prototype.Ta=C();y.prototype.V=function(a){this.Zb=a;return this};y.prototype.s=function(a,b,d,e){var f=this,j=c.ed(a);if(0===j.length)q.error("The DOM query ("+a+") returned 0 elements");else return c.a(j,function(a){c.C(a,this.bc,function(a){var c={},j=f.wa(d,this),g=f.Zb.c("track_links_timeout");f.Ya(a,this,c);t.setTimeout(f.lc(e,j,c,l),g);f.Zb.s(b,j,f.lc(e,j,c))})},this),l};y.prototype.lc=function(a,b,c,e){var e=e||r,f=this;return function(){if(!c.Zc)c.Zc=
l,a&&a(e,b)===r||f.Ta(b,c,e)}};y.prototype.wa=function(a,b){return"function"===typeof a?a(b):c.extend({},a)};c.Ub(D,y);D.prototype.wa=function(a,b){var c=D.Ed.wa.apply(this,arguments);if(b.href)c.url=b.href;return c};D.prototype.Ya=function(a,b,c){c.$b=2===a.which||a.metaKey||a.ctrlKey||"_blank"===b.target;c.href=b.href;c.$b||a.preventDefault()};D.prototype.Ta=function(a,b){b.$b||setTimeout(function(){t.location=b.href},0)};c.Ub(M,y);M.prototype.Ya=function(a,b,c){c.element=b;a.preventDefault()};
...
"mixpanel"!==a.name&&(d="mp_"+a.token+"_"+a.name,b=this.v.parse(d)))this.v.remove(d),this.v.remove(d,l),this.D(b);this.v===c.localStorage&&(b=c.cookie.parse(this.name),c.cookie.remove(this.name),c.cookie.remove(this.name,l),b&&this.D(b))};p.prototype.save=function(){this.disabled||(this.Dc(),this.v.set(this.name,c.oa(this.props),this.Za,this.Wa,this.fc))};p.prototype.remove=function(){this.v.remove(this.name,r);this.v.remove(this.name,l)};p.prototype.clear=function(){this.remove();this.props={}};
p.prototype.D=function(a,b,d){return c.k(a)?("undefined"===typeof b&&(b="None"),this.Za="undefined"===typeof d?this.Mb:d,c.a(a,function(a,c){if(!this.props.hasOwnProperty(c)||this.props[c]===b)this.props[c]=a},this),this.save(),l):r};p.prototype.ja=function(a,b){return c.k(a)?(this.Za="undefined"===typeof b?this.Mb:b,c.extend(this.props,a),this.save(),l):r};p.prototype.Da=function(a){a in this.props&&(delete this.props[a],this.save())};p.prototype.Dc=c.l(function(){var a=this.props.__cmpns,b=A?6E4:
36E5;if(a){for(var d in a)1*new Date-a[d]>b&&delete a[d];c.fb(a)&&delete this.props.__cmpns}});p.prototype.Ld=function(){if(!this.Hb)this.D(c.info.$c()),this.Hb=l};p.prototype.qc=function(a){this.ja(c.info.xd(a))};p.prototype.ob=function(a){this.D({$initial_referrer:a||"$direct",$initial_referring_domain:c.info.ec(a)||"$direct"},"")};p.prototype.kd=function(){return c.Aa({$initial_referrer:this.props.$initial_referrer,$initial_referring_domain:this.props.$initial_referring_domain})};p.prototype.pc=
function(a){this.Mb=this.Za=a.cookie_expiration;this.hc(a.disable_persistence);this.zd(a.cross_subdomain_cookie);this.Bd(a.secure_cookie)};p.prototype.hc=function(a){(this.disabled=a)?this.remove():this.save()};p.prototype.zd=function(a){if(a!==this.Wa)this.Wa=a,this.remove(),this.save()};p.prototype.jd=function(){return this.Wa};p.prototype.Bd=function(a){if(a!==this.fc)this.fc=a?l:r,this.remove(),this.save()};p.prototype.H=function(a,b){var d=this.Na(a),e=b[a],f=this.R("$set"),j=this.R("$set_once"),
...
c.isArray(a)&&-1!==d.indexOf("track")&&"function"===typeof this[d]?j.push(a):f.push(a))},this);b(e,this);b(f,this);b(j,this)};h.prototype.push=function(a){this.La([a])};h.prototype.disable=function(a){"undefined"===typeof a?this.P.bd=l:this.Ia=this.Ia.concat(a)};h.prototype.s=ca(function(a,b,d){"function"!==typeof d&&(d=C());if(c.d(a))q.error("No event name provided to mixpanel.track");else if(this.tb(a))d(0);else{b=b||{};b.token=this.c("token");var e=this.persistence.td(a);c.d(e)||(b.$duration=parseFloat((((new Date).getTime()-
e)/1E3).toFixed(3)));this.persistence.qc(o.referrer);this.c("store_google")&&this.persistence.Ld();this.c("save_referrer")&&this.persistence.ob(o.referrer);b=c.extend({},c.info.ia(),this.persistence.ia(),b);e=this.c("property_blacklist");c.isArray(e)?c.a(e,function(a){delete b[a]}):q.error("Invalid value for property_blacklist config: "+e);a=c.truncate({event:a,properties:b},255);e=c.oa(a);e=c.Db(e);q.log("MIXPANEL REQUEST:");q.log(a);this.m(this.c("api_host")+"/track/",{data:e},this.sa(d,a));return a}});
h.prototype.mc=function(a){if(c.d(a))a=o.location.href;this.s("mp_page_view",c.info.rd(a))};h.prototype.Kd=function(){return this.Ra.call(this,D,arguments)};h.prototype.Jd=function(){return this.Ra.call(this,M,arguments)};h.prototype.Fd=function(a){c.d(a)?q.error("No event name provided to mixpanel.time_event"):this.tb(a)||this.persistence.Ad(a)};h.prototype.ja=function(a,b){this.persistence.ja(a,b)};h.prototype.D=function(a,b,c){this.persistence.D(a,b,c)};h.prototype.Da=function(a){this.persistence.Da(a)};
h.prototype.Qa=function(a,b){var c={};c[a]=b;this.ja(c)};h.prototype.bb=function(a,b,c,e,f,j,g){a!==this.U()&&a!==this.xa("__alias")&&(this.Da("__alias"),this.Qa("distinct_id",a));this.qb(this.U());this.P.cb=l;this.people.Fc(b,c,e,f,j,g)};h.prototype.reset=function(){this.persistence.clear();this.P.cb=r;this.D({distinct_id:c.pb()},"")};h.prototype.U=function(){return this.xa("distinct_id")};h.prototype.Xc=function(a,b){if(a===this.xa("$people_distinct_id"))return q.T("Attempting to create alias for existing People user - aborting."),
-2;var d=this;c.d(b)&&(b=this.U());if(a!==b)return this.Qa("__alias",a),this.s("$create_alias",{alias:a,distinct_id:b},function(){d.bb(a)});q.error("alias matches current distinct_id - skipping api call.");this.bb(a);return-1};h.prototype.pd=function(a){this.Qa("mp_name_tag",a)};h.prototype.gc=function(a){if(c.k(a))c.extend(this.config,a),this.c("persistence_name")||(this.config.persistence_name=this.config.cookie_name),this.c("disable_persistence")||(this.config.disable_persistence=this.config.disable_cookie),
this.persistence&&this.persistence.pc(this.config),A=A||this.c("debug")};h.prototype.c=function(a){return this.config[a]};h.prototype.xa=function(a){return this.persistence.props[a]};h.prototype.toString=function(){var a=this.c("name");"mixpanel"!==a&&(a="mixpanel."+a);return a};h.prototype.tb=function(a){return c.Vb(w)||this.P.bd||c.Sb(this.Ia,a)};h.prototype.qb=ca(function(a){if(a&&!this.P.cb&&!this.c("disable_notifications")){q.log("MIXPANEL NOTIFICATION CHECK");var b=this;this.m(this.c("api_host")+
"/decide/",{verbose:l,version:"2",lib:"web",token:this.c("token"),distinct_id:a},this.sa(function(a){a.notifications&&0<a.notifications.length&&b.Bb.call(b,a.notifications[0])}))}});h.prototype.Bb=function(a){(new g(a,this)).show()};h.prototype.Jc=function(){"localStorage"===this.c("opt_out_tracking_persistence_type")&&c.localStorage.hb()&&(!this.ab()&&this.ab({persistence_type:"cookie"})&&(this.Va({persistence_type:"cookie"}),this.ac()),!this.fa()&&this.fa({persistence_type:"cookie"})&&(this.Va({persistence_type:"cookie"}),
this.kb()));if(this.c("opt_out_tracking_by_default")||c.cookie.get("mp_optout"))c.cookie.remove("mp_optout"),this.kb();this.ta()};h.prototype.Z=function(a,b){b=c.extend({track:c.bind(this.s,this),persistence_type:this.c("opt_out_tracking_persistence_type"),cookie_prefix:this.c("opt_out_tracking_cookie_prefix"),cookie_expiration:this.c("cookie_expiration"),cross_subdomain_cookie:this.c("cross_subdomain_cookie"),secure_cookie:this.c("secure_cookie")},b);c.localStorage.hb()||(b.persistence_type="cookie");
return a(this.c("token"),{s:b.track,Gd:b.track_event_name,Hd:b.track_properties,dc:b.persistence_type,cc:b.cookie_prefix,Kb:b.cookie_expiration,Lb:b.cross_subdomain_cookie,yd:b.secure_cookie})};h.prototype.ac=function(a){this.Z(ma,a);this.ta()};h.prototype.kb=function(a){a=c.extend({delete_user:l},a);a.delete_user&&this.people&&this.people.Oa()&&(this.people.Nb(),this.people.Jb());this.Z(na,a);this.ta()};h.prototype.ab=function(a){return this.Z(oa,a)};h.prototype.fa=function(a){return this.Z(ba,a)};
h.prototype.Va=function(a){this.Z(pa,a);this.ta()};n.prototype.Pa=function(a){this.i=a};n.prototype.set=F(function(a,b,d){var e={},f={};c.k(a)?(c.a(a,function(a,b){this.S(b)||(f[b]=a)},this),d=b):f[a]=b;this.aa("save_referrer")&&this.i.persistence.ob(o.referrer);f=c.extend({},c.info.sd(),this.i.persistence.kd(),f);e.$set=f;return this.m(e,d)});n.prototype.ic=F(function(a,b,d){var e={},f={};c.k(a)?(c.a(a,function(a,b){this.S(b)||(f[b]=a)},this),d=b):f[a]=b;e.$set_once=f;return this.m(e,d)});n.prototype.oc=
...
d=b):f[a]=b;e.$append=f;return this.m(e,d)});n.prototype.nc=F(function(a,b,d){var e={},f={};c.k(a)?(c.a(a,function(a,b){this.S(b)||(f[b]=c.isArray(a)?a:[a])},this),d=b):f[a]=c.isArray(b)?b:[b];e.$union=f;return this.m(e,d)});n.prototype.Id=F(function(a,b,d){if(!c.Wb(a)&&(a=parseFloat(a),isNaN(a))){q.error("Invalid value passed to mixpanel.people.track_charge - must be a number");return}return this.append("$transactions",c.extend({$amount:a},b),d)});n.prototype.Jb=function(a){return this.set("$transactions",
[],a)};n.prototype.Nb=function(){if(this.Oa())return this.m({$delete:this.i.U()});q.error("mixpanel.people.delete_user() requires you to call identify() first")};n.prototype.toString=function(){return this.i.toString()+".people"};n.prototype.m=function(a,b){a.$token=this.aa("token");a.$distinct_id=this.i.U();var d=c.Pb(a),e=c.truncate(d,255),d=c.oa(d),d=c.Db(d);if(!this.Oa())return this.Cc(a),c.d(b)||(this.aa("verbose")?b({status:-1,error:m}):b(-1)),e;q.log("MIXPANEL PEOPLE REQUEST:");q.log(e);this.i.m(this.aa("api_host")+
"/engage/",{data:d},this.i.sa(b,e));return e};n.prototype.aa=function(a){return this.i.c(a)};n.prototype.Oa=function(){return this.i.P.cb===l};n.prototype.Cc=function(a){"$set"in a?this.i.persistence.H("$set",a):"$set_once"in a?this.i.persistence.H("$set_once",a):"$unset"in a?this.i.persistence.H("$unset",a):"$add"in a?this.i.persistence.H("$add",a):"$append"in a?this.i.persistence.H("$append",a):"$union"in a?this.i.persistence.H("$union",a):q.error("Invalid call to _enqueue():",a)};n.prototype.$=
function(a,b,d,e){var f=this,g=c.extend({},this.i.persistence.Ma(a)),h=g;!c.d(g)&&c.k(g)&&!c.fb(g)&&(f.i.persistence.I(a,g),e&&(h=e(g)),b.call(f,h,function(b,e){0===b&&f.i.persistence.H(a,g);c.d(d)||d(b,e)}))};n.prototype.Fc=function(a,b,d,e,f,g){var h=this,i=this.i.persistence.Ma("$append");this.$("$set",this.set,a);this.$("$set_once",this.ic,e);this.$("$unset",this.oc,g,function(a){return c.keys(a)});this.$("$add",this.Tb,b);this.$("$union",this.nc,f);if(!c.d(i)&&c.isArray(i)&&i.length){for(var n,
a=function(a,b){0===a&&h.i.persistence.H("$append",n);c.d(d)||d(a,b)},b=i.length-1;0<=b;b--)n=i.pop(),h.append(n,a);h.i.persistence.save()}};n.prototype.S=function(a){return"$distinct_id"===a||"$token"===a};h.yc=function(a,b){c.Fb(this);this.jb=b;this.mb=this.jb.persistence;this.B=c.K(a.id);this.Yb=c.K(a.message_id);this.body=(c.K(a.body)||"").replace(/\n/g,"<br/>");this.ad=c.K(a.cta)||"Close";this.ga=c.K(a.type)||"takeover";this.style=c.K(a.style)||"light";this.title=c.K(a.title)||"";this.la=g.xc;
this.X=g.wc;this.da=a.cta_url||m;this.eb=a.image_url||m;this.L=a.thumb_image_url||m;this.Ea=a.video_url||m;this.va=l;if(!this.da)this.da="#dismiss",this.va=r;this.u="mini"===this.ga;if(!this.u)this.ga="takeover";this.qd=!this.u?g.Y:g.Fa;this.Ab();this.ya=this.Kc();this.Nc()};g=h.yc;g.M=200;g.w="mixpanel-notification";g.ma=0.6;g.G=25;g.pa=200;g.Y=388;g.Fa=420;g.z=85;g.Ga=5;g.J=60;g.Ha=Math.round(g.J/2);g.xc=595;g.wc=334;g.prototype.show=function(){var a=this;this.Ab();this.p?(this.Mc(),this.Lc(),this.Rc(this.Ac)):
setTimeout(function(){a.show()},300)};g.prototype.Xa=c.l(function(){this.Xb||this.yb({invisible:l});var a=this.Cd?this.h("video"):this.Q();if(this.rc)this.Tc("bg","visible"),this.N(a,"exiting"),setTimeout(this.zb,g.M);else{var b,c,e;this.u?(b="right",c=20,e=-100):(b="top",c=g.G,e=g.pa+g.G);this.qa([{q:this.h("bg"),o:"opacity",start:g.ma,j:0},{q:a,o:"opacity",start:1,j:0},{q:a,o:b,start:c,j:e}],g.M,this.zb)}});g.prototype.N=c.l(function(a,b){b=g.w+"-"+b;"string"===typeof a&&(a=this.h(a));a.className?
...
i.start)*n/b;if("opacity"!==i.o)i.F=Math.round(i.F);if(0<o&&i.F>=i.j||0>o&&i.F<=i.j)i.F=i.j}}if(g){for(h=0;h<a.length;h++)i=a[h],i.q&&(i.q.style[i.o]=""+i.F+("opacity"===i.o?"":"px"));setTimeout(function(){f.qa(a,b,c,e)},10)}else c&&c()});g.prototype.Ac=c.l(function(){var a=this;if(!this.Dd&&!this.vb()[this.B])this.Dd=l,this.p.appendChild(this.ha),setTimeout(function(){var b=a.Q();if(a.rc)a.u||a.N("bg","visible"),a.N(b,"visible"),a.xb();else{var c,e,f;a.u?(c="right",e=-100,f=20):(c="top",e=g.pa+g.G,
f=g.G);a.qa([{q:a.h("bg"),o:"opacity",start:0,j:g.ma},{q:b,o:"opacity",start:0,j:1},{q:b,o:c,start:e,j:f}],g.M,a.xb)}},100),c.C(a.h("cancel"),"click",function(b){b.preventDefault();a.Xa()}),c.C(a.h("button")||a.h("mini-content"),"click",function(b){b.preventDefault();a.W?(a.Sa("$campaign_open",{$resource_type:"video"}),a.Uc()):(a.Xa(),a.va&&a.Sa("$campaign_open",{$resource_type:"link"},function(){t.location.href=a.da}))})});g.prototype.h=function(a){return o.getElementById(g.w+"-"+a)};g.prototype.Q=
function(){return this.h(this.ga)};g.prototype.vb=function(){return this.mb.props.__cmpns||(this.mb.props.__cmpns={})};g.prototype.O=function(a,b){return this.A[a]&&this.A[a]<=b};g.prototype.Kc=function(){var a=[];this.u?(this.L=this.L||"//cdn.mxpnl.com/site_media/images/icons/notifications/mini-news-dark.png",a.push(this.L)):(this.eb?(a.push(this.eb),this.Rb='<img id="img" src="'+this.eb+'"/>'):this.Rb="",this.L?(a.push(this.L),this.kc='<div id="thumbborder-wrapper"><div id="thumbborder"></div></div><img id="thumbnail" src="'+
...
this.sc+"?autoplay=1&title=0&byline=0&portrait=0");if(this.W)this.Pd='<iframe id="'+g.w+'-video-frame" width="'+this.la+'" height="'+this.X+'"  src="'+b+'" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen="1" scrolling="no"></iframe>',c='<div id="video-'+(this.$a?"":"no")+'flip"><div id="video"><div id="video-holder"></div>'+c+"</div></div>";b=c+a;this.$a&&(b=(this.u?a:"")+'<div id="flipcontainer"><div id="flipper">'+(this.u?c:b)+"</div></div>");this.ha.innerHTML=('<div id="overlay" class="'+
this.ga+'"><div id="campaignid-'+this.B+'"><div id="bgwrapper"><div id="bg"></div>'+b+"</div></div></div>").replace(/class=\"/g,'class="'+g.w+"-").replace(/id=\"/g,'id="'+g.w+"-")};g.prototype.Mc=function(){this.g="dark"===this.style?{Ua:"#1d1f25",ba:"#282b32",ua:"#3a4147",Eb:"#4a5157",Yc:"#32353c",Ib:"0.4",ib:"#2a3137",Ca:"#fff",nb:"#9498a3",jc:"#464851",Ba:"#ddd"}:{Ua:"#fff",ba:"#e7eaee",ua:"#eceff3",Eb:"#f5f5f5",Yc:"#e4ecf2",Ib:"1.0",ib:"#fafafa",Ca:"#5c6578",nb:"#8b949b",jc:"#ced9e6",Ba:"#7c8598"};
...
"background-color":this.g.Ua,opacity:"0.7"},"#video-elapsed":{width:"0","background-color":"#6cb6f5",opacity:"0.9"},"#video #video-time":{width:"10%",right:"0","font-size":"11px","line-height":"25px",color:this.g.nb,"background-color":"#666","border-radius":"0 0 5px 0"}};this.O("ie",8)&&c.extend(a,{"* html #overlay":{position:"absolute"},"* html #bg":{position:"absolute"},"html, body":{height:"100%"}});this.O("ie",7)&&c.extend(a,{"#mini #body":{display:"inline",zoom:"1",border:"1px solid "+this.g.ua},
...
c=a.Ea.match(/vimeo\.com\/.*?(\d+)/i);if(b){if(a.W=l,a.tc=b[1],a.uc)t.onYouTubeIframeAPIReady=function(){a.h("video-frame")&&a.Cb()},b=o.createElement("script"),b.src="//www.youtube.com/iframe_api",c=o.getElementsByTagName("script")[0],c.parentNode.insertBefore(b,c)}else if(c)a.W=l,a.sc=c[1];if(a.O("ie",7)||a.O("firefox",3))a.W=r,a.va=l}});g.prototype.xb=c.l(function(){function a(a,b){var c={};if(o.defaultView&&o.defaultView.getComputedStyle)c=o.defaultView.getComputedStyle(a,m);else if(a.currentStyle)c=
a.currentStyle;return c[b]}var b=this;c.C(b.h("bg"),"click",function(){b.Xa()});if(this.B){var d=this.h("overlay");d&&"hidden"!==a(d,"visibility")&&"none"!==a(d,"display")&&this.yb()}});g.prototype.yb=c.l(function(a){if(!this.Xb)this.Xb=l,this.B&&(this.vb()[this.B]=1*new Date,this.mb.save()),this.Sa("$campaign_delivery",a),this.jb.people.append({$campaigns:this.B,$notifications:{campaign_id:this.B,message_id:this.Yb,type:"web",time:new Date}})});g.prototype.Rc=function(a){var b=this;if(0===this.ya.length)a();
else{for(var c=0,e=[],f=function(){c++;c===b.ya.length&&a&&(a(),a=m)},g=0;g<this.ya.length;g++){var h=new Image;h.onload=f;h.src=this.ya[g];h.complete&&f();e.push(h)}this.O("ie",7)&&setTimeout(function(){var b=l;for(g=0;g<e.length;g++)e[g].complete||(b=r);b&&a&&(a(),a=m)},500)}};g.prototype.zb=c.l(function(){t.clearInterval(this.Wc);this.ha.style.visibility="hidden";this.p.removeChild(this.ha)});g.prototype.Ab=function(){function a(a){if(a in e)return l;if(!c)for(var a=a[0].toUpperCase()+a.slice(1),
...
this.cd=Math.max(this.p.scrollHeight,o.documentElement.scrollHeight,this.p.offsetHeight,o.documentElement.offsetHeight,this.p.clientHeight,o.documentElement.clientHeight);var c=this.A.ie,e=o.createElement("div").style;this.rc=this.p&&a("transition")&&a("transform");this.$a=(33<=this.A.chrome||15<=this.A.firefox)&&this.p&&a("backfaceVisibility")&&a("perspective")&&a("transform")};g.prototype.Uc=c.l(function(){function a(){t.YT&&t.YT.loaded&&b.Cb();b.Cd=l;b.Q().style.visibility="hidden"}var b=this,
c=[{q:b.Q(),o:"opacity",start:1,j:0},{q:b.Q(),o:"top",start:g.G,j:-500},{q:b.h("video-noflip"),o:"opacity",start:0,j:1},{q:b.h("video-noflip"),o:"top",start:2*-b.X,j:0}];if(b.u){var e=b.h("bg"),f=b.h("overlay");e.style.width="100%";e.style.height="100%";f.style.width="100%";b.N(b.Q(),"exiting");b.N(e,"visible");c.push({q:b.h("bg"),o:"opacity",start:0,j:g.ma})}b.h("video-holder").innerHTML=b.Pd;b.$a?(b.N("flipper","flipped"),setTimeout(a,g.M)):b.qa(c,g.M,a)});g.prototype.Sa=function(a,b,d){this.B?
(b=b||{},b=c.extend(b,{campaign_id:this.B,message_id:this.Yb,message_type:"web_inapp",message_subtype:this.ga}),this.jb.track(a,b,d)):d&&d.call()};g.prototype.Cb=c.l(function(){var a=this;if(!a.Qd){a.Qd=l;var b=a.h("video-elapsed"),d=a.h("video-time"),e=a.h("video-progress");new t.YT.Player(g.w+"-video-frame",{events:{onReady:function(f){function g(a){var a=Math.round(i-a),b=Math.floor(a/60),c=Math.floor(b/60),a=a-60*b;d.innerHTML="-"+(c?c+":":"")+("00"+(b-60*c)).slice(-2)+":"+("00"+a).slice(-2)}
...
h.prototype.track_pageview=h.prototype.mc;h.prototype.register=h.prototype.ja;h.prototype.register_once=h.prototype.D;h.prototype.unregister=h.prototype.Da;h.prototype.identify=h.prototype.bb;h.prototype.alias=h.prototype.Xc;h.prototype.name_tag=h.prototype.pd;h.prototype.set_config=h.prototype.gc;h.prototype.get_config=h.prototype.c;h.prototype.get_property=h.prototype.xa;h.prototype.get_distinct_id=h.prototype.U;h.prototype.toString=h.prototype.toString;h.prototype._check_and_handle_notifications=
h.prototype.qb;h.prototype._show_notification=h.prototype.Bb;h.prototype.opt_out_tracking=h.prototype.kb;h.prototype.opt_in_tracking=h.prototype.ac;h.prototype.has_opted_out_tracking=h.prototype.fa;h.prototype.has_opted_in_tracking=h.prototype.ab;h.prototype.clear_opt_in_out_tracking=h.prototype.Va;p.prototype.properties=p.prototype.ia;p.prototype.update_search_keyword=p.prototype.qc;p.prototype.update_referrer_info=p.prototype.ob;p.prototype.get_cross_subdomain=p.prototype.jd;p.prototype.clear=p.prototype.clear;
n.prototype.set=n.prototype.set;n.prototype.set_once=n.prototype.ic;n.prototype.unset=n.prototype.oc;n.prototype.increment=n.prototype.Tb;n.prototype.append=n.prototype.append;n.prototype.union=n.prototype.nc;n.prototype.track_charge=n.prototype.Id;n.prototype.clear_charges=n.prototype.Jb;n.prototype.delete_user=n.prototype.Nb;n.prototype.toString=n.prototype.toString;c.ud(h);var z={};(function(){V=1;v=t.mixpanel;c.d(v)?q.T('"mixpanel" object not initialized. Ensure you are using the latest version of the Mixpanel JS Library along with the snippet we provide.'):
