...
""},oa:function(){return c.extend(c.Ha({$os:c.info.qb(),$browser:c.info.ha(x,M.vendor,P),$referrer:o.referrer,$referring_domain:c.info.kc(o.referrer),$device:c.info.Vb(x)}),{$current_url:t.location.href,$browser_version:c.info.Mb(x,M.vendor,P),$screen_height:Y.height,$screen_width:Y.width,mp_lib:"web",$lib_version:"2.25.0",time:c.timestamp()/1E3})},Ed:function(){return c.extend(c.Ha({$os:c.info.qb(),$browser:c.info.ha(x,M.vendor,P)}),{$browser_version:c.info.Mb(x,M.vendor,P)})},Dd:function(a){return c.Ha({mp_page:a,
