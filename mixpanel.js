...
/** @const */, RESERVED_PROPERTIES = [
    ...
    _.info = {
        ...
        browser: function (user_agent, vendor, opera) {
            ...
            } else if (_.includes(user_agent, "WPDesktop")) {
                return "Internet Explorer Mobile";
        ...
        os: function () {
            var a = userAgent;
            if (/WPDesktop/i.test(a)) {
                return 'Windows Phone';
            } else if (/Windows/i.test(a)) {
                if (/Phone/.test(a)) { return 'Windows Phone'; }
                return 'Windows';
        ...
        device: function (user_agent) {
            if (/iPad/.test(user_agent)) {
                ...
                return 'iPod Touch';
            } else if (/WPDesktop/i.test(user_agent)) {
                return 'Windows Phone';
