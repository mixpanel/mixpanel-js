    ...
    var MPNotif = MixpanelLib._Notification;
        ...
        MPNotif.prototype.dismiss = _.safewrap(function() {
            this._animate_els([
                ...
                {
                    el:   this._get_notification_display_el(),
                    attr: 'opacity',
                    val:  1.0,
                    goal: 0.0,
                    incr: -0.02
        ...
        MPNotif.prototype._animate_els = _.safewrap(function(anims, done_cb) {
            var self = this,
                in_progress = false,
                ai, anim;
            ...
            setTimeout(function() { self._animate_els(anims, done_cb) }, 1);
        });
            ...
            setTimeout(function() {
                self._animate_els([
                    ...
                    },
                    {
                        el:   self._get_notification_display_el(),
                        attr: 'top',
                        val:  MPNotif.NOTIF_START_TOP + MPNotif.NOTIF_TOP,
        ...
        MPNotif.prototype._init_notification_el = function() {
            ...
            if (this.notif_type !== 'mini') {
                ...
                notification_html =
                    '<div id="mixpanel-notification" style="opacity:0.0;top:' + MPNotif.NOTIF_START_TOP + 'px;">' +
                        this.thumb_img_html +
        ...
        MPNotif.prototype._init_styles = function() {
            ...
            var notif_styles = {
                ...
                '#mixpanel-notification-thumbnail': {
                    ...
                    'overflow': 'hidden',
                    'z-index': '100',
                    '-webkit-border-radius': MPNotif.THUMB_IMG_SIZE + 'px',
                       '-moz-border-radius': MPNotif.THUMB_IMG_SIZE + 'px',
        ...
        MPNotif.prototype._inject_styles = function(styles, media_queries) {
        ...
        MPNotif.prototype._switch_to_video = _.safewrap(function() {
            ...
            if (self.flip_animate) {
                ...
                anims = [
                    ...
                    },
                    {
                        ...
                        attr: 'top',
                        val:  MPNotif.NOTIF_TOP,
                        goal: MPNotif.NOTIF_TOP + self.video_height,
                        incr: 20
                    },
                    {
                        el:   document.getElementById('mixpanel-notification-video-noflip'),
                        attr: 'opacity',
                        val:  0.0,
                        goal: 1.0,
                        incr: 0.02
            ...
            if (anims.length > 0) {
                var self = self,
                    hide_el = (self.flip_animate && self.notif_type !== 'mini') ||
                              !self.flip_animate;
                self._animate_els(anims, function() {
                    if (hide_el) {
