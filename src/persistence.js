...
import {
  ADD_QUEUE_KEY, ALIAS_ID_KEY, APPEND_QUEUE_KEY, CAMPAIGN_IDS_KEY, EVENT_TIMERS_KEY,
  PEOPLE_DISTINCT_ID_KEY, SET_ONCE_QUEUE_KEY, SET_QUEUE_KEY, UNION_QUEUE_KEY, UNSET_QUEUE_KEY
...
export default MixpanelPersistence;
