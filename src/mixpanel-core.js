...
import MixpanelPersistence from './persistence';
import MixpanelPeople from './people';
import MPNotif from './notifications';
import { ALIAS_ID_KEY, PEOPLE_DISTINCT_ID_KEY } from './persistence-keys';
import {
    optIn,
    optOut,
    hasOptedIn,
