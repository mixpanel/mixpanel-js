...
import {_, console, document, MAX_RECORDING_MS, navigator, slice, userAgent, window} from './utils';
import {FormTracker, LinkTracker} from './dom-trackers';
import {RequestBatcher} from './request-batcher';
import {MixpanelGroup} from './mixpanel-group';
import {MixpanelPeople} from './mixpanel-people';
import {ALIAS_ID_KEY, MixpanelPersistence, PEOPLE_DISTINCT_ID_KEY} from './mixpanel-persistence';
import {addOptOutCheckMixpanelLib, clearOptInOut, hasOptedIn, hasOptedOut, optIn, optOut} from './gdpr-utils';
...
var DEFAULT_CONFIG = {
    ...
    'max_property_length': 255 // Maximum chars length to truncate property data: default=255 , -1: no limit
};
